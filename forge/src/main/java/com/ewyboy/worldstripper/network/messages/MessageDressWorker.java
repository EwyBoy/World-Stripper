        ...
        ctx.get().enqueueWork(() -> {
            ...
            if (player != null) {
                if (player.isSpectator() || player.isCreative()) {
                    ...
                    WorldWorkerManager.addWorker(new DressWorker(BlockPos.containing(player.position()), fillSizeX, fillSizeZ, player.serverLevel(), 4096, BlockUpdater.getBlockUpdateFlag()));
                } else {
