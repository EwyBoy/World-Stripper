package com.ewyboy.worldstripper.client.gui.config.widget;
...
public class OptionsListWidget extends AbstractList<OptionsListWidget.Entry> {
    ...
    private final GuiConfigOptions owner;
    private final Runnable diskWriter;

    public OptionsListWidget(GuiConfigOptions owner, Minecraft client, int x, int height, int width, int y, int entryHeight, Runnable diskWriter) {
    ...
    public OptionsListWidget(GuiConfigOptions owner, Minecraft client, int x, int height, int width, int y, int entryHeight) {
    ...
    public void save() {
        ...
        children().stream().filter(e -> e instanceof OptionsEntryValueResource).map(e -> (OptionsEntryValueResource) e).forEach(OptionsEntryValueResource :: save);
    ...
    public void add(Entry entry) {
        if(entry instanceof OptionsEntryValue) {
            ...
            if(element != null) owner.addWidget(element);
        }
