...
public class CommandProfile {
    ...
    public static ArgumentBuilder<CommandSource, ?> register() {
        ...
        return Commands.literal("profile").requires(cs -> cs.hasPermission(2)).executes(context -> {
            ...
            player.displayClientMessage(new StringTextComponent(TextFormatting.GREEN + "Profile" + TextFormatting.WHITE + " set to: " + ProfileManager.profileNameMap.get(ConfigOptions.Profiles.profile)), false);
            return 0;
