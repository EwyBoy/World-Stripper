    ...
    public static class Handler implements IMessageHandler<PacketStripWorld, IMessage> {
        ...
        private void handle(MessageContext ctx) {
            ...
            if (player.isCreative()) {
                player.addChatComponentMessage(new TextComponentString(TextFormatting.BOLD + "" + TextFormatting.RED + "WARNING! " + TextFormatting.WHITE + "World Stripping Initialized! Lag May Occur.."), false);
