...
public class RealmsUploadScreen extends RealmsScreen {
   ...
   public void func_231160_c_() {
      ...
      this.field_224710_o = this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 100, this.field_230709_l_ - 42, 200, 20, DialogTexts.field_240637_h_, (p_238087_1_) -> {
         this.func_224679_c();
      }));
      this.field_224710_o.field_230694_p_ = false;
      this.field_224711_p = this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 100, this.field_230709_l_ - 42, 200, 20, DialogTexts.field_240633_d_, (p_238084_1_) -> {
         this.func_224695_d();
      }));
   ...
   private void func_224695_d() {
      ...
      this.field_230706_i_.displayGuiScreen(this.field_224697_b);
   }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224704_i, this.field_230708_k_ / 2, 50, 16777215);
      if (this.field_224708_m) {
         this.func_238086_b_(p_230430_1_);
      }

      if (this.field_224701_f.field_224978_a != 0L && !this.field_224706_k) {
         this.func_238088_c_(p_230430_1_);
         this.func_238089_d_(p_230430_1_);
      }

      if (this.field_224703_h != null) {
         for(int i = 0; i < this.field_224703_h.length; ++i) {
            func_238472_a_(p_230430_1_, this.field_230712_o_, this.field_224703_h[i], this.field_230708_k_ / 2, 110 + 12 * i, 16711680);
         }
      }
   ...
   private void func_238086_b_(MatrixStack p_238086_1_) {
      int i = this.field_230712_o_.func_238414_a_(this.field_224704_i);
      this.field_230712_o_.func_238421_b_(p_238086_1_, field_224713_r[this.field_238079_E_ / 10 % field_224713_r.length], (float)(this.field_230708_k_ / 2 + i / 2 + 5), 50.0F, 16777215);
   }
   ...
   private void func_238088_c_(MatrixStack p_238088_1_) {
      ...
      func_238471_a_(p_238088_1_, this.field_230712_o_, this.field_224705_j + " %", this.field_230708_k_ / 2, 84, 16777215);
   }
   ...
   private void func_238083_a_(MatrixStack p_238083_1_, long p_238083_2_) {
      if (p_238083_2_ > 0L) {
         int i = this.field_230712_o_.getStringWidth(this.field_224705_j);
         String s = "(" + UploadSpeed.func_237684_b_(p_238083_2_) + "/s)";
         this.field_230712_o_.func_238421_b_(p_238083_1_, s, (float)(this.field_230708_k_ / 2 + i / 2 + 15), 84.0F, 16777215);
      }
      ...
      (new Thread(() -> {
         ...
         try {
            if (field_238081_b_.tryLock(1L, TimeUnit.SECONDS)) {
               ...
               File file2 = new File(this.field_230706_i_.gameDir.getAbsolutePath(), "saves");
               ...
               if (this.func_224692_a(file1)) {
                  ...
                  FileUpload fileupload = new FileUpload(file1, this.field_224699_d, this.field_224700_e, uploadinfo, this.field_230706_i_.getSession(), SharedConstants.getVersion().getName(), this.field_224701_f);
            ...
            if (field_238081_b_.isHeldByCurrentThread()) {
               ...
               this.field_224710_o.field_230694_p_ = true;
               this.field_224711_p.field_230694_p_ = false;
               if (file1 != null) {
