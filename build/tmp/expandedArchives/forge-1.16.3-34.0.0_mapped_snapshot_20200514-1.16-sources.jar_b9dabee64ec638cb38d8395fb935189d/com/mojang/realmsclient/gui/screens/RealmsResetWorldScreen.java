...
public class RealmsResetWorldScreen extends NotifableRealmsScreen {
   ...
   private ITextComponent field_224464_j = DialogTexts.field_240633_d_;
   ...
   public void func_231160_c_() {
      this.func_230480_a_(new Button(this.field_230708_k_ / 2 - 40, func_239562_k_(14) - 10, 80, 20, this.field_224464_j, (p_237959_1_) -> {
         this.field_230706_i_.displayGuiScreen(this.field_224457_c);
      }));
      (new Thread("Realms-reset-world-fetcher") {
         public void run() {
            ...
            try {
               ...
               RealmsResetWorldScreen.this.field_230706_i_.execute(() -> {
      ...
      this.field_224460_f = this.func_230481_d_(new RealmsLabel(this.field_224462_h, this.field_230708_k_ / 2, 7, 16777215));
      this.field_224461_g = this.func_230481_d_(new RealmsLabel(this.field_224463_i, this.field_230708_k_ / 2, 22, this.field_224465_k));
      this.func_230480_a_(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(1), func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.generate"), field_237939_A_, (p_237958_1_) -> {
         this.field_230706_i_.displayGuiScreen(new RealmsResetNormalWorldScreen(this, this.field_224462_h));
      }));
      this.func_230480_a_(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(2), func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.upload"), field_237945_x_, (p_237957_1_) -> {
      ...
      this.func_230480_a_(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(3), func_239562_k_(0) + 10, new TranslationTextComponent("mco.reset.world.template"), field_237947_z_, (p_237956_1_) -> {
      ...
      this.func_230480_a_(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(1), func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.adventure"), field_237946_y_, (p_237955_1_) -> {
      ...
      this.func_230480_a_(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(2), func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.experience"), field_237940_B_, (p_237954_1_) -> {
      ...
      this.func_230480_a_(new RealmsResetWorldScreen.TexturedButton(this.func_224434_c(3), func_239562_k_(6) + 20, new TranslationTextComponent("mco.reset.world.inspiration"), field_237941_C_, (p_237951_1_) -> {
   ...
   private int func_224434_c(int p_224434_1_) {
      return this.field_230708_k_ / 2 - 130 + (p_224434_1_ - 1) * 100;
   }

   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      this.func_230446_a_(p_230430_1_);
      this.field_224460_f.func_239560_a_(this, p_230430_1_);
      this.field_224461_g.func_239560_a_(this, p_230430_1_);
   ...
   private void func_237948_a_(MatrixStack p_237948_1_, int p_237948_2_, int p_237948_3_, ITextComponent p_237948_4_, ResourceLocation p_237948_5_, boolean p_237948_6_, boolean p_237948_7_) {
      this.field_230706_i_.getTextureManager().bindTexture(p_237948_5_);
      if (p_237948_6_) {
      ...
      AbstractGui.func_238463_a_(p_237948_1_, p_237948_2_ + 2, p_237948_3_ + 14, 0.0F, 0.0F, 56, 56, 56, 56);
      this.field_230706_i_.getTextureManager().bindTexture(field_237944_w_);
      if (p_237948_6_) {
         RenderSystem.color4f(0.56F, 0.56F, 0.56F, 1.0F);
      } else {
         RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      ...
      AbstractGui.func_238463_a_(p_237948_1_, p_237948_2_, p_237948_3_ + 12, 0.0F, 0.0F, 60, 60, 60, 60);
      int i = p_237948_6_ ? 10526880 : 16777215;
      func_238472_a_(p_237948_1_, this.field_230712_o_, p_237948_4_, p_237948_2_ + 30, p_237948_3_, i);
   }
   ...
   public void func_237952_a_(Runnable p_237952_1_) {
      this.field_230706_i_.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(this.field_224457_c, new SwitchMinigameRealmsAction(this.field_224458_d.field_230582_a_, this.field_224455_a, p_237952_1_)));
   }
   ...
   private void func_237953_a_(@Nullable String p_237953_1_, @Nullable WorldTemplate p_237953_2_, int p_237953_3_, boolean p_237953_4_) {
      this.field_230706_i_.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(this.field_224457_c, new ResetWorldRealmsAction(p_237953_1_, p_237953_2_, p_237953_3_, p_237953_4_, this.field_224458_d.field_230582_a_, this.field_224475_u, this.field_237942_L_)));
   }
   ...
   class TexturedButton extends Button {
      ...
      public void func_230431_b_(MatrixStack p_230431_1_, int p_230431_2_, int p_230431_3_, float p_230431_4_) {
         RealmsResetWorldScreen.this.func_237948_a_(p_230431_1_, this.field_230690_l_, this.field_230691_m_, this.func_230458_i_(), this.field_223824_c, this.func_230449_g_(), this.func_231047_b_((double)p_230431_2_, (double)p_230431_3_));
      }
   }
}