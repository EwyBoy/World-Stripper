...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen {
   ...
   private static final ITextComponent field_243110_t = (new TranslationTextComponent("mco.configure.current.minigame")).func_240702_b_(": ");
   ...
   public void func_231160_c_() {
      ...
      this.field_224418_f = this.field_230708_k_ / 2 - 187;
      this.field_224419_g = this.field_230708_k_ / 2 + 190;
      this.field_230706_i_.keyboardListener.enableRepeatEvents(true);
      this.field_224422_j = this.func_230480_a_(new Button(this.func_224374_a(0, 3), func_239562_k_(0), 100, 20, new TranslationTextComponent("mco.configure.world.buttons.players"), (p_237818_1_) -> {
         this.field_230706_i_.displayGuiScreen(new RealmsPlayerScreen(this, this.field_224416_d));
      }));
      this.field_224423_k = this.func_230480_a_(new Button(this.func_224374_a(1, 3), func_239562_k_(0), 100, 20, new TranslationTextComponent("mco.configure.world.buttons.settings"), (p_237817_1_) -> {
         this.field_230706_i_.displayGuiScreen(new RealmsSettingsScreen(this, this.field_224416_d.clone()));
      }));
      this.field_224424_l = this.func_230480_a_(new Button(this.func_224374_a(2, 3), func_239562_k_(0), 100, 20, new TranslationTextComponent("mco.configure.world.buttons.subscription"), (p_237816_1_) -> {
         this.field_230706_i_.displayGuiScreen(new RealmsSubscriptionInfoScreen(this, this.field_224416_d.clone(), this.field_224415_c));
      }));
      ...
      this.field_224428_p = this.func_230480_a_(new Button(this.func_224411_b(0), func_239562_k_(13) - 5, 100, 20, new TranslationTextComponent("mco.configure.world.buttons.switchminigame"), (p_237815_1_) -> {
         ...
         this.field_230706_i_.displayGuiScreen(realmsselectworldtemplatescreen);
      }));
      this.field_224425_m = this.func_230480_a_(new Button(this.func_224411_b(0), func_239562_k_(13) - 5, 90, 20, new TranslationTextComponent("mco.configure.world.buttons.options"), (p_237814_1_) -> {
         this.field_230706_i_.displayGuiScreen(new RealmsSlotOptionsScreen(this, this.field_224416_d.field_230590_i_.get(this.field_224416_d.field_230595_n_).clone(), this.field_224416_d.field_230594_m_, this.field_224416_d.field_230595_n_));
      }));
      this.field_224426_n = this.func_230480_a_(new Button(this.func_224411_b(1), func_239562_k_(13) - 5, 90, 20, new TranslationTextComponent("mco.configure.world.backup"), (p_237812_1_) -> {
         this.field_230706_i_.displayGuiScreen(new RealmsBackupScreen(this, this.field_224416_d.clone(), this.field_224416_d.field_230595_n_));
      }));
      this.field_224427_o = this.func_230480_a_(new Button(this.func_224411_b(2), func_239562_k_(13) - 5, 90, 20, new TranslationTextComponent("mco.configure.world.buttons.resetworld"), (p_237810_1_) -> {
         this.field_230706_i_.displayGuiScreen(new RealmsResetWorldScreen(this, this.field_224416_d.clone(), () -> {
            this.field_230706_i_.displayGuiScreen(this.func_224407_b());
         }, () -> {
            this.field_230706_i_.displayGuiScreen(this.func_224407_b());
         }));
      }));
      this.func_230480_a_(new Button(this.field_224419_g - 80 + 8, func_239562_k_(13) - 5, 70, 20, DialogTexts.field_240637_h_, (p_237808_1_) -> {
         this.func_224390_d();
      }));
      this.field_224426_n.field_230693_o_ = true;
      if (this.field_224416_d == null) {
         this.func_224412_j();
         this.func_224377_h();
         this.field_224422_j.field_230693_o_ = false;
         this.field_224423_k.field_230693_o_ = false;
         this.field_224424_l.field_230693_o_ = false;
      } else {
         this.func_224400_e();
   ...
   private void func_224402_a(int p_224402_1_) {
      ...
      this.func_230480_a_(realmsserverslotbutton);
   }
   ...
   private int func_224374_a(int p_224374_1_, int p_224374_2_) {
      return this.field_230708_k_ / 2 - (p_224374_2_ * 105 - 5) / 2 + p_224374_1_ * 105;
   }
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      func_238472_a_(p_230430_1_, this.field_230712_o_, field_243108_r, this.field_230708_k_ / 2, func_239562_k_(4), 16777215);
      super.func_230430_a_(p_230430_1_, p_230430_2_, p_230430_3_, p_230430_4_);
      if (this.field_224416_d == null) {
         func_238472_a_(p_230430_1_, this.field_230712_o_, field_243109_s, this.field_230708_k_ / 2, 17, 16777215);
      } else {
         ...
         int k = this.field_230712_o_.func_238414_a_(field_243109_s);
         func_238472_a_(p_230430_1_, this.field_230712_o_, field_243109_s, this.field_230708_k_ / 2, 12, 16777215);
         func_238471_a_(p_230430_1_, this.field_230712_o_, s, this.field_230708_k_ / 2, 24, j);
         int l = Math.min(this.func_224374_a(2, 3) + 80 - 11, this.field_230708_k_ / 2 + i / 2 + k / 2 + 10);
         this.func_237807_c_(p_230430_1_, l, 7, p_230430_2_, p_230430_3_);
         if (this.func_224376_g()) {
            this.field_230712_o_.func_243248_b(p_230430_1_, field_243110_t.func_230532_e_().func_240702_b_(this.field_224416_d.func_230778_c_()), (float)(this.field_224418_f + 80 + 20 + 10), (float)func_239562_k_(13), 16777215);
         }

         if (this.field_224414_b != null) {
            this.func_237796_a_(p_230430_1_, this.field_224414_b, p_230430_2_, p_230430_3_);
         }
   ...
   private void func_224390_d() {
      ...
      this.field_230706_i_.displayGuiScreen(this.field_224415_c);
   }
      ...
      (new Thread(() -> {
         ...
         try {
            ...
            this.field_230706_i_.execute(() -> {
               this.field_230706_i_.displayGuiScreen(new RealmsGenericErrorScreen(ITextComponent.func_244388_a(realmsserviceexception.getMessage()), this.field_224415_c));
            });
         }
   ...
   private void func_224400_e() {
      this.field_224422_j.field_230693_o_ = !this.field_224416_d.field_230591_j_;
      this.field_224423_k.field_230693_o_ = !this.field_224416_d.field_230591_j_;
      this.field_224424_l.field_230693_o_ = true;
      this.field_224428_p.field_230693_o_ = !this.field_224416_d.field_230591_j_;
      this.field_224425_m.field_230693_o_ = !this.field_224416_d.field_230591_j_;
      this.field_224427_o.field_230693_o_ = !this.field_224416_d.field_230591_j_;
   }
   ...
   private void func_224403_a(int p_224403_1_, RealmsServer p_224403_2_) {
      ...
      this.field_230706_i_.displayGuiScreen(new RealmsLongConfirmationScreen((p_237805_3_) -> {
         if (p_237805_3_) {
            this.field_230706_i_.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(this.field_224415_c, new SwitchMinigameRealmsAction(p_224403_2_.field_230582_a_, p_224403_1_, () -> {
               this.field_230706_i_.displayGuiScreen(this.func_224407_b());
            })));
         } else {
   ...
   private void func_224388_b(int p_224388_1_, RealmsServer p_224388_2_) {
      ITextComponent itextcomponent = new TranslationTextComponent("mco.configure.world.slot.switch.question.line1");
      ITextComponent itextcomponent1 = new TranslationTextComponent("mco.configure.world.slot.switch.question.line2");
      this.field_230706_i_.displayGuiScreen(new RealmsLongConfirmationScreen((p_237797_3_) -> {
         if (p_237797_3_) {
            RealmsResetWorldScreen realmsresetworldscreen = new RealmsResetWorldScreen(this, p_224388_2_, new TranslationTextComponent("mco.configure.world.switch.slot"), new TranslationTextComponent("mco.configure.world.switch.slot.subtitle"), 10526880, DialogTexts.field_240633_d_, () -> {
               this.field_230706_i_.displayGuiScreen(this.func_224407_b());
            }, () -> {
               this.field_230706_i_.displayGuiScreen(this.func_224407_b());
            });
   ...
   protected void func_237796_a_(MatrixStack p_237796_1_, @Nullable ITextComponent p_237796_2_, int p_237796_3_, int p_237796_4_) {
      ...
      int k = this.field_230712_o_.func_238414_a_(p_237796_2_);
      if (i + k + 3 > this.field_224419_g) {
         i = i - k - 20;
      }

      this.func_238468_a_(p_237796_1_, i - 3, j - 3, i + k + 3, j + 8 + 3, -1073741824, -1073741824);
      this.field_230712_o_.func_243246_a(p_237796_1_, p_237796_2_, (float)i, (float)j, 16777215);
   }
   ...
   private void func_237809_d_(MatrixStack p_237809_1_, int p_237809_2_, int p_237809_3_, int p_237809_4_, int p_237809_5_) {
      this.field_230706_i_.getTextureManager().bindTexture(field_237789_p_);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      AbstractGui.func_238463_a_(p_237809_1_, p_237809_2_, p_237809_3_, 0.0F, 0.0F, 10, 28, 10, 28);
   ...
   private void func_237804_b_(MatrixStack p_237804_1_, int p_237804_2_, int p_237804_3_, int p_237804_4_, int p_237804_5_, int p_237804_6_) {
      this.field_230706_i_.getTextureManager().bindTexture(field_237790_q_);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      if (this.field_224430_r % 20 < 10) {
         AbstractGui.func_238463_a_(p_237804_1_, p_237804_2_, p_237804_3_, 0.0F, 0.0F, 10, 28, 20, 28);
      } else {
         AbstractGui.func_238463_a_(p_237804_1_, p_237804_2_, p_237804_3_, 10.0F, 0.0F, 10, 28, 20, 28);
      }
   ...
   private void func_237811_e_(MatrixStack p_237811_1_, int p_237811_2_, int p_237811_3_, int p_237811_4_, int p_237811_5_) {
      this.field_230706_i_.getTextureManager().bindTexture(field_237787_b_);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      AbstractGui.func_238463_a_(p_237811_1_, p_237811_2_, p_237811_3_, 0.0F, 0.0F, 10, 28, 10, 28);
   ...
   private void func_237813_f_(MatrixStack p_237813_1_, int p_237813_2_, int p_237813_3_, int p_237813_4_, int p_237813_5_) {
      this.field_230706_i_.getTextureManager().bindTexture(field_237788_c_);
      RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      AbstractGui.func_238463_a_(p_237813_1_, p_237813_2_, p_237813_3_, 0.0F, 0.0F, 10, 28, 10, 28);
   ...
   private void func_237799_a_(Button p_237799_1_) {
      p_237799_1_.field_230694_p_ = false;
      this.field_230705_e_.remove(p_237799_1_);
      this.field_230710_m_.remove(p_237799_1_);
   }

   private void func_237806_b_(Button p_237806_1_) {
      p_237806_1_.field_230694_p_ = true;
      this.func_230480_a_(p_237806_1_);
   }
   ...
   public void func_237802_a_(boolean p_237802_1_, Screen p_237802_2_) {
      this.field_230706_i_.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(p_237802_2_, new OpeningWorldRealmsAction(this.field_224416_d, this, this.field_224415_c, p_237802_1_)));
   }

   public void func_237800_a_(Screen p_237800_1_) {
      this.field_230706_i_.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(p_237800_1_, new CloseRealmsAction(this.field_224416_d, this)));
   }
   ...
   protected void func_223627_a_(@Nullable WorldTemplate p_223627_1_) {
      if (p_223627_1_ != null) {
         if (WorldTemplate.Type.MINIGAME == p_223627_1_.field_230655_i_) {
            this.field_230706_i_.displayGuiScreen(new RealmsLongRunningMcoTaskScreen(this.field_224415_c, new StartMinigameRealmsAction(this.field_224416_d.field_230582_a_, p_223627_1_, this.func_224407_b())));
         }
