...
public class RealmsServerSlotButton extends Button implements IScreen {
   ...
   public RealmsServerSlotButton(int p_i232195_1_, int p_i232195_2_, int p_i232195_3_, int p_i232195_4_, Supplier<RealmsServer> p_i232195_5_, Consumer<ITextComponent> p_i232195_6_, int p_i232195_7_, Button.IPressable p_i232195_8_) {
      super(p_i232195_1_, p_i232195_2_, p_i232195_3_, p_i232195_4_, StringTextComponent.field_240750_d_, p_i232195_8_);
   ...
   public void func_231023_e_() {
      ...
      if (realmsserver != null) {
         ...
         this.func_238482_a_(pair.getSecond());
      }
   }
   ...
   private Pair<ITextComponent, ITextComponent> func_237719_a_(RealmsServer p_237719_1_, String p_237719_2_, boolean p_237719_3_, boolean p_237719_4_, RealmsServerSlotButton.Action p_237719_5_) {
      if (p_237719_5_ == RealmsServerSlotButton.Action.NOTHING) {
         ...
         if (p_237719_4_) {
            if (p_237719_3_) {
               itextcomponent = StringTextComponent.field_240750_d_;
            } else {
               itextcomponent = (new StringTextComponent(" ")).func_240702_b_(p_237719_2_).func_240702_b_(" ").func_240702_b_(p_237719_1_.field_230596_o_);
            }
         } else {
            itextcomponent = (new StringTextComponent(" ")).func_240702_b_(p_237719_2_);
         }
         ...
         ITextComponent itextcomponent2 = itextcomponent1.func_230532_e_().func_230529_a_(itextcomponent);
   ...
   private void func_237718_a_(MatrixStack p_237718_1_, int p_237718_2_, int p_237718_3_, int p_237718_4_, int p_237718_5_, boolean p_237718_6_, String p_237718_7_, int p_237718_8_, long p_237718_9_, @Nullable String p_237718_11_, boolean p_237718_12_, boolean p_237718_13_, RealmsServerSlotButton.Action p_237718_14_, @Nullable ITextComponent p_237718_15_) {
      boolean flag = this.func_230449_g_();
      if (this.func_231047_b_((double)p_237718_4_, (double)p_237718_5_) && p_237718_15_ != null) {
      ...
      func_238463_a_(p_237718_1_, p_237718_2_ + 3, p_237718_3_ + 3, 0.0F, 0.0F, 74, 74, 74, 74);
      ...
      func_238463_a_(p_237718_1_, p_237718_2_, p_237718_3_, 0.0F, 0.0F, 80, 80, 80, 80);
      func_238471_a_(p_237718_1_, minecraft.fontRenderer, p_237718_7_, p_237718_2_ + 40, p_237718_3_ + 66, 16777215);
   }
