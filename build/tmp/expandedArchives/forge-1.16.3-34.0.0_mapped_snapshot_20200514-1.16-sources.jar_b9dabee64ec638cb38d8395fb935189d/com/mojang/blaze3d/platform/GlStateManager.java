...
public class GlStateManager {
   ...
   private static GlStateManager.SupportType field_237507_w_;
   ...
   public static String init(GLCapabilities glCapabilities) {
      ...
      if (glCapabilities.OpenGL30) {
         field_237507_w_ = GlStateManager.SupportType.BASE;
      } else if (glCapabilities.GL_EXT_framebuffer_blit) {
         field_237507_w_ = GlStateManager.SupportType.EXT;
      } else {
         field_237507_w_ = GlStateManager.SupportType.NONE;
      }
   ...
   public static void func_237509_a_(int p_237509_0_, int p_237509_1_, int p_237509_2_, int p_237509_3_, int p_237509_4_, int p_237509_5_, int p_237509_6_, int p_237509_7_) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
   ...
   public static void func_237510_a_(int p_237510_0_, int p_237510_1_, int p_237510_2_, int p_237510_3_, int p_237510_4_, int p_237510_5_, int p_237510_6_, int p_237510_7_, int p_237510_8_, int p_237510_9_) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
   ...
   public static boolean func_237508_S_() {
      return field_237507_w_ != GlStateManager.SupportType.NONE;
   }
