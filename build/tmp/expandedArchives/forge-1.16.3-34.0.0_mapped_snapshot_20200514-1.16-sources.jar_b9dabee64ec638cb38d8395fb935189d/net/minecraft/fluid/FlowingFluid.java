...
public abstract class FlowingFluid extends Fluid {
   ...
   public Vector3d getFlow(IBlockReader p_215663_1_, BlockPos p_215663_2_, FluidState p_215663_3_) {
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         blockpos$mutable.func_239622_a_(p_215663_2_, direction);
         ...
         if (this.isSameOrEmpty(fluidstate)) {
            ...
            float f1 = 0.0F;
            if (f == 0.0F) {
               if (!p_215663_1_.getBlockState(blockpos$mutable).getMaterial().blocksMovement()) {
      ...
      if (p_215663_3_.get(FALLING)) {
         for(Direction direction1 : Direction.Plane.HORIZONTAL) {
            blockpos$mutable.func_239622_a_(p_215663_2_, direction1);
            if (this.causesDownwardCurrent(p_215663_1_, blockpos$mutable, direction1) || this.causesDownwardCurrent(p_215663_1_, blockpos$mutable.up(), direction1)) {
