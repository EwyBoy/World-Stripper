...
public class HusbandryAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> p_accept_1_) {
      ...
      Advancement.Builder.builder().withParent(advancement1).withDisplay(Items.field_234758_kU_, new TranslationTextComponent("advancements.husbandry.netherite_hoe.title"), new TranslationTextComponent("advancements.husbandry.netherite_hoe.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).withRewards(AdvancementRewards.Builder.experience(100)).withCriterion("netherite_hoe", InventoryChangeTrigger.Instance.forItems(Items.field_234758_kU_)).register(p_accept_1_, "husbandry/obtain_netherite_hoe");
      ...
      Advancement.Builder.builder().withParent(advancement).withCriterion("safely_harvest_honey", RightClickBlockWithItemTrigger.Instance.func_234852_a_(LocationPredicate.Builder.func_226870_a_().func_235312_a_(BlockPredicate.Builder.func_226243_a_().func_226244_a_(BlockTags.BEEHIVES).func_226245_b_()).func_235313_a_(true), ItemPredicate.Builder.create().item(Items.GLASS_BOTTLE))).withDisplay(Items.HONEY_BOTTLE, new TranslationTextComponent("advancements.husbandry.safely_harvest_honey.title"), new TranslationTextComponent("advancements.husbandry.safely_harvest_honey.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).register(p_accept_1_, "husbandry/safely_harvest_honey");
   ...
   private Advancement.Builder makeBredAllAnimals(Advancement.Builder builder) {
      ...
      builder.withCriterion(EntityType.getKey(EntityType.TURTLE).toString(), BredAnimalsTrigger.Instance.func_241332_a_(EntityPredicate.Builder.create().type(EntityType.TURTLE).build(), EntityPredicate.Builder.create().type(EntityType.TURTLE).build(), EntityPredicate.ANY));
      return builder;
   }
