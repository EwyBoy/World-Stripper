...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   protected static LootTable.Builder dropping(Block p_218494_0_, ILootCondition.IBuilder p_218494_1_, LootEntry.Builder<?> p_218494_2_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218494_0_).acceptCondition(p_218494_1_).alternatively(p_218494_2_)));
   }
   ...
   protected static <T extends Comparable<T> & IStringSerializable> LootTable.Builder droppingWhen(Block p_218562_0_, Property<T> p_218562_1_, T p_218562_2_) {
   ...
   private static LootTable.Builder func_229437_i_(Block p_229437_0_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_229437_0_).acceptCondition(SILK_TOUCH).acceptFunction(CopyNbt.builder(CopyNbt.Source.BLOCK_ENTITY).replaceOperation("Bees", "BlockEntityTag.Bees")).acceptFunction(CopyBlockState.func_227545_a_(p_229437_0_).func_227552_a_(BeehiveBlock.HONEY_LEVEL)).alternatively(ItemLootEntry.builder(p_229437_0_))));
   }
   ...
   protected static LootTable.Builder droppingAndBonusWhen(Block p_218541_0_, Item p_218541_1_, Item p_218541_2_, ILootCondition.IBuilder p_218541_3_) {
      return withExplosionDecay(p_218541_0_, LootTable.builder().addLootPool(LootPool.builder().addEntry(ItemLootEntry.builder(p_218541_1_).acceptCondition(p_218541_3_).alternatively(ItemLootEntry.builder(p_218541_2_)))).addLootPool(LootPool.builder().acceptCondition(p_218541_3_).addEntry(ItemLootEntry.builder(p_218541_2_).acceptFunction(ApplyBonus.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286F, 3)))));
   }

   private static LootTable.Builder func_241750_l_(Block p_241750_0_) {
      return LootTable.builder().addLootPool(LootPool.builder().acceptCondition(SHEARS).addEntry(ItemLootEntry.builder(p_241750_0_).acceptFunction(SetCount.builder(ConstantRange.of(2)))));
   }

   private static LootTable.Builder func_241749_b_(Block p_241749_0_, Block p_241749_1_) {
      LootEntry.Builder<?> builder = ItemLootEntry.builder(p_241749_1_).acceptFunction(SetCount.builder(ConstantRange.of(2))).acceptCondition(SHEARS).alternatively(withSurvivesExplosion(p_241749_0_, ItemLootEntry.builder(Items.WHEAT_SEEDS)).acceptCondition(RandomChance.builder(0.125F)));
      return LootTable.builder().addLootPool(LootPool.builder().addEntry(builder).acceptCondition(BlockStateProperty.builder(p_241749_0_).fromProperties(StatePropertiesPredicate.Builder.newBuilder().withProp(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER))).acceptCondition(LocationCheck.func_241547_a_(LocationPredicate.Builder.func_226870_a_().func_235312_a_(BlockPredicate.Builder.func_226243_a_().func_233458_a_(p_241749_0_).func_233459_a_(StatePropertiesPredicate.Builder.newBuilder().withProp(DoublePlantBlock.HALF, DoubleBlockHalf.UPPER).build()).func_226245_b_()), new BlockPos(0, 1, 0)))).addLootPool(LootPool.builder().addEntry(builder).acceptCondition(BlockStateProperty.builder(p_241749_0_).fromProperties(StatePropertiesPredicate.Builder.newBuilder().withProp(DoublePlantBlock.HALF, DoubleBlockHalf.UPPER))).acceptCondition(LocationCheck.func_241547_a_(LocationPredicate.Builder.func_226870_a_().func_235312_a_(BlockPredicate.Builder.func_226243_a_().func_233458_a_(p_241749_0_).func_233459_a_(StatePropertiesPredicate.Builder.newBuilder().withProp(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER).build()).func_226245_b_()), new BlockPos(0, -1, 0))));
   }
   ...
   protected void addTables() {
      ...
      this.registerDropSelfLootTable(Blocks.field_235369_mi_);
      this.registerDropSelfLootTable(Blocks.field_235378_mr_);
      ...
      this.registerDropSelfLootTable(Blocks.field_235380_mt_);
      this.registerDropSelfLootTable(Blocks.field_235371_mk_);
      ...
      this.registerDropSelfLootTable(Blocks.field_235399_ni_);
      ...
      this.registerDropSelfLootTable(Blocks.field_235336_cN_);
      this.registerDropSelfLootTable(Blocks.field_235337_cO_);
      this.registerDropSelfLootTable(Blocks.field_235338_cP_);
      this.registerDropSelfLootTable(Blocks.field_235339_cQ_);
      ...
      this.registerDropSelfLootTable(Blocks.field_235396_nb_);
      ...
      this.registerDropSelfLootTable(Blocks.field_235400_nj_);
      this.registerDropSelfLootTable(Blocks.field_235405_no_);
      this.registerDropSelfLootTable(Blocks.field_235368_mh_);
      this.registerDropSelfLootTable(Blocks.field_235370_mj_);
      this.registerDropSelfLootTable(Blocks.field_235373_mm_);
      this.registerDropSelfLootTable(Blocks.field_235374_mn_);
      this.registerDropSelfLootTable(Blocks.field_235377_mq_);
      this.registerDropSelfLootTable(Blocks.field_235379_ms_);
      this.registerDropSelfLootTable(Blocks.field_235382_mv_);
      this.registerDropSelfLootTable(Blocks.field_235383_mw_);
      this.registerDropSelfLootTable(Blocks.field_235344_mC_);
      this.registerDropSelfLootTable(Blocks.field_235345_mD_);
      this.registerDropSelfLootTable(Blocks.field_235349_mH_);
      this.registerDropSelfLootTable(Blocks.field_235351_mJ_);
      this.registerDropSelfLootTable(Blocks.field_235353_mL_);
      this.registerDropSelfLootTable(Blocks.field_235355_mN_);
      this.registerDropSelfLootTable(Blocks.field_235357_mP_);
      this.registerDropSelfLootTable(Blocks.field_235359_mR_);
      this.registerDropSelfLootTable(Blocks.field_235363_mV_);
      this.registerDropSelfLootTable(Blocks.field_235348_mG_);
      this.registerDropSelfLootTable(Blocks.field_235350_mI_);
      this.registerDropSelfLootTable(Blocks.field_235352_mK_);
      this.registerDropSelfLootTable(Blocks.field_235354_mM_);
      this.registerDropSelfLootTable(Blocks.field_235356_mO_);
      this.registerDropSelfLootTable(Blocks.field_235358_mQ_);
      this.registerDropSelfLootTable(Blocks.field_235362_mU_);
      this.registerDropSelfLootTable(Blocks.field_235397_ng_);
      this.registerDropSelfLootTable(Blocks.field_235398_nh_);
      this.registerDropSelfLootTable(Blocks.field_235406_np_);
      this.registerDropSelfLootTable(Blocks.field_235411_nu_);
      this.registerDropSelfLootTable(Blocks.field_235415_ny_);
      this.registerDropSelfLootTable(Blocks.field_235407_nq_);
      this.registerDropSelfLootTable(Blocks.field_235408_nr_);
      this.registerDropSelfLootTable(Blocks.field_235416_nz_);
      this.registerDropSelfLootTable(Blocks.field_235413_nw_);
      this.registerDropSelfLootTable(Blocks.field_235412_nv_);
      this.registerDropSelfLootTable(Blocks.field_235410_nt_);
      this.registerDropSelfLootTable(Blocks.field_235388_nB_);
      this.registerDropSelfLootTable(Blocks.field_235390_nD_);
      this.registerDropSelfLootTable(Blocks.field_235391_nE_);
      this.registerDropSelfLootTable(Blocks.field_235392_nF_);
      this.registerDropSelfLootTable(Blocks.field_235393_nG_);
      this.registerDropSelfLootTable(Blocks.field_235394_nH_);
      this.registerDropSelfLootTable(Blocks.field_235395_nI_);
      this.registerDropSelfLootTable(Blocks.field_235341_dI_);
      this.registerDropSelfLootTable(Blocks.field_235375_mo_);
      this.registerDropSelfLootTable(Blocks.field_235343_mB_);
      ...
      this.registerLootTable(Blocks.field_235381_mu_, (p_239296_0_) -> {
         return droppingWithSilkTouch(p_239296_0_, Blocks.NETHERRACK);
      });
      this.registerLootTable(Blocks.field_235372_ml_, (p_239293_0_) -> {
         return droppingWithSilkTouch(p_239293_0_, Blocks.NETHERRACK);
      });
      ...
      this.registerFlowerPot(Blocks.field_235401_nk_);
      this.registerFlowerPot(Blocks.field_235402_nl_);
      this.registerFlowerPot(Blocks.field_235403_nm_);
      this.registerFlowerPot(Blocks.field_235404_nn_);
      ...
      this.registerLootTable(Blocks.field_235346_mE_, BlockLootTables::droppingSlab);
      this.registerLootTable(Blocks.field_235347_mF_, BlockLootTables::droppingSlab);
      this.registerLootTable(Blocks.field_235409_ns_, BlockLootTables::droppingSlab);
      this.registerLootTable(Blocks.field_235414_nx_, BlockLootTables::droppingSlab);
      this.registerLootTable(Blocks.field_235389_nC_, BlockLootTables::droppingSlab);
      this.registerLootTable(Blocks.ACACIA_DOOR, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.BIRCH_DOOR, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.DARK_OAK_DOOR, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.IRON_DOOR, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.JUNGLE_DOOR, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.OAK_DOOR, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.SPRUCE_DOOR, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.field_235361_mT_, BlockLootTables::func_239829_a_);
      this.registerLootTable(Blocks.field_235360_mS_, BlockLootTables::func_239829_a_);
      ...
      this.registerLootTable(Blocks.field_235366_md_, BlockLootTables::dropping);
      ...
      this.registerLootTable(Blocks.PLAYER_HEAD, (p_218565_0_) -> {
         return LootTable.builder().addLootPool(withSurvivesExplosion(p_218565_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218565_0_).acceptFunction(CopyNbt.builder(CopyNbt.Source.BLOCK_ENTITY).replaceOperation("SkullOwner", "SkullOwner")))));
      });
      ...
      this.registerLootTable(Blocks.DARK_OAK_LEAVES, (p_241172_0_) -> {
         return droppingWithChancesSticksAndApples(p_241172_0_, Blocks.DARK_OAK_SAPLING, DEFAULT_SAPLING_DROP_RATES);
      });
      ...
      this.registerLootTable(Blocks.COAL_ORE, (p_241170_0_) -> {
         return droppingItemWithFortune(p_241170_0_, Items.COAL);
      });
      ...
      this.registerLootTable(Blocks.field_235334_I_, (p_218471_0_) -> {
         return droppingWithSilkTouch(p_218471_0_, withExplosionDecay(p_218471_0_, ItemLootEntry.builder(Items.GOLD_NUGGET).acceptFunction(SetCount.builder(RandomValueRange.of(2.0F, 6.0F))).acceptFunction(ApplyBonus.oreDrops(Enchantments.FORTUNE))));
      });
      ...
      this.registerLootTable(Blocks.field_235376_mp_, BlockLootTables::onlyWithShears);
      ...
      this.registerLootTable(Blocks.TALL_SEAGRASS, func_241750_l_(Blocks.SEAGRASS));
      this.registerLootTable(Blocks.LARGE_FERN, (p_218572_0_) -> {
         return func_241749_b_(p_218572_0_, Blocks.FERN);
      });
      this.registerLootTable(Blocks.TALL_GRASS, (p_241752_0_) -> {
         return func_241749_b_(p_241752_0_, Blocks.GRASS);
      });
      ...
      this.registerLootTable(Blocks.field_235387_nA_, (p_229432_0_) -> {
         return droppingWithSilkTouch(p_229432_0_, withSurvivesExplosion(p_229432_0_, ItemLootEntry.builder(Items.GOLD_NUGGET).acceptFunction(SetCount.builder(RandomValueRange.of(2.0F, 5.0F))).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F)).alternatively(ItemLootEntry.builder(p_229432_0_))));
      });
      this.registerLootTable(Blocks.field_235367_mf_, (p_218538_0_) -> {
         return droppingWithSilkTouch(p_218538_0_, withSurvivesExplosion(p_218538_0_, ItemLootEntry.builder(Items.field_234734_dm_).acceptFunction(SetCount.builder(ConstantRange.of(1)))));
      });
      ...
      this.func_239830_b_(Blocks.field_235384_mx_, Blocks.field_235385_my_);
      this.func_239830_b_(Blocks.field_235386_mz_, Blocks.field_235342_mA_);
      ...
      this.registerLootTable(Blocks.FIRE, func_218482_a());
      this.registerLootTable(Blocks.field_235335_bO_, func_218482_a());
      this.registerLootTable(Blocks.NETHER_PORTAL, func_218482_a());
   }
   ...
   private void func_239830_b_(Block p_239830_1_, Block p_239830_2_) {
      LootTable.Builder loottable$builder = droppingWithSilkTouchOrShears(p_239830_1_, ItemLootEntry.builder(p_239830_1_).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, 0.33F, 0.55F, 0.77F, 1.0F)));
      this.registerLootTable(p_239830_1_, loottable$builder);
      this.registerLootTable(p_239830_2_, loottable$builder);
   }

   public static LootTable.Builder func_239829_a_(Block p_239829_0_) {
      return droppingWhen(p_239829_0_, DoorBlock.HALF, DoubleBlockHalf.LOWER);
   }
   ...
   public void registerFlowerPot(Block flowerPot) {
      this.registerLootTable(flowerPot, (p_241751_0_) -> {
         return droppingAndFlowerPot(((FlowerPotBlock)p_241751_0_).func_220276_d());
      });
   }
