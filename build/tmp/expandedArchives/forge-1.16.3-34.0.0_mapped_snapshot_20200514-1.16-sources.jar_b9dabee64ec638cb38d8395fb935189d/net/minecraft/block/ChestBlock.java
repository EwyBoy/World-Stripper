...
public class ChestBlock extends AbstractChestBlock<ChestTileEntity> implements IWaterLoggable {
   ...
   public ChestBlock(AbstractBlock.Properties builder, Supplier<TileEntityType<? extends ChestTileEntity>> tileEntityTypeIn) {
   ...
   public INamedContainerProvider getContainer(BlockState state, World worldIn, BlockPos pos) {
      return this.func_225536_a_(state, worldIn, pos, false).<Optional<INamedContainerProvider>>apply(field_220110_j).orElse((INamedContainerProvider)null);
   }
