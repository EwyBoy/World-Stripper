...
public class NetherPortalBlock extends Block {
   ...
   public void randomTick(BlockState state, ServerWorld worldIn, BlockPos pos, Random random) {
      if (worldIn.func_230315_m_().func_236043_f_() && worldIn.getGameRules().getBoolean(GameRules.DO_MOB_SPAWNING) && random.nextInt(2000) < worldIn.getDifficulty().getId()) {
         ...
         if (worldIn.getBlockState(pos).canEntitySpawn(worldIn, pos, EntityType.field_233592_ba_)) {
            Entity entity = EntityType.field_233592_ba_.spawn(worldIn, (CompoundNBT)null, (ITextComponent)null, (PlayerEntity)null, pos.up(), SpawnReason.STRUCTURE, false, false);
            if (entity != null) {
