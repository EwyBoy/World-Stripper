...
public class CartographyTableBlock extends Block {
   private static final ITextComponent field_220268_a = new TranslationTextComponent("container.cartography_table");

   public CartographyTableBlock(AbstractBlock.Properties properties) {
      super(properties);
   }
