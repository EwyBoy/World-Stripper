...
public class StemBlock extends BushBlock implements IGrowable {
   ...
   public StemBlock(StemGrownBlock p_i48318_1_, AbstractBlock.Properties properties) {
      super(properties);
      ...
      if (worldIn.getLightSubtracted(pos, 0) >= 9) {
         ...
         if (net.minecraftforge.common.ForgeHooks.onCropsGrowPre(worldIn, pos, state, random.nextInt((int)(25.0F / f) + 1) == 0)) {
            ...
            if (i < 7) {
               ...
               if (worldIn.isAirBlock(blockpos) && (blockstate.canSustainPlant(worldIn, blockpos.down(), Direction.UP, this) || block == Blocks.FARMLAND || block == Blocks.DIRT || block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.GRASS_BLOCK)) {
