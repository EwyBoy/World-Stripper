...
public class BeehiveBlock extends ContainerBlock {
      ...
      if (!list.isEmpty()) {
         ...
         for(BeeEntity beeentity : list) {
            if (beeentity.getAttackTarget() == null) {
               beeentity.setAttackTarget(list1.get(p_226881_1_.rand.nextInt(i)));
            }
         }
      }
   ...
   private void func_226879_a_(World p_226879_1_, BlockPos p_226879_2_, BlockState p_226879_3_) {
      if (p_226879_3_.getFluidState().isEmpty() && !(p_226879_1_.rand.nextFloat() < 0.3F)) {
         ...
         if (d0 >= 1.0D && !p_226879_3_.func_235714_a_(BlockTags.IMPERMEABLE)) {
            ...
            if (d1 > 0.0D) {
               ...
               if ((d2 < 1.0D || !blockstate.func_235785_r_(p_226879_1_, blockpos)) && blockstate.getFluidState().isEmpty()) {
   ...
   public static Direction func_235331_a_(Random p_235331_0_) {
      return Util.func_240989_a_(GENERATE_DIRECTIONS, p_235331_0_);
   }
}