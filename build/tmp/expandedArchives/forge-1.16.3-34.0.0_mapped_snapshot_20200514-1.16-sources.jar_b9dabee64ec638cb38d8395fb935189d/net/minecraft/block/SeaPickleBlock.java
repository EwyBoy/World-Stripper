...
public class SeaPickleBlock extends BushBlock implements IGrowable, IWaterLoggable {
   ...
   public SeaPickleBlock(AbstractBlock.Properties propertiesfsp) {
      super(propertiesfsp);
   ...
   public void grow(ServerWorld worldIn, Random rand, BlockPos pos, BlockState state) {
      if (!isInBadEnvironment(state) && worldIn.getBlockState(pos.down()).func_235714_a_(BlockTags.CORAL_BLOCKS)) {
         int i = 5;
         int j = 1;
         int k = 2;
         int l = 0;
            ...
            for(int l1 = 0; l1 < j; ++l1) {
               ...
               for(int j2 = i2 - 2; j2 < i2; ++j2) {
                  ...
                  if (blockpos != pos && rand.nextInt(6) == 0 && worldIn.getBlockState(blockpos).isIn(Blocks.WATER)) {
                     ...
                     if (blockstate.func_235714_a_(BlockTags.CORAL_BLOCKS)) {
