...
public abstract class LockableLootTileEntity extends LockableTileEntity {
   ...
   public void fillWithLoot(@Nullable PlayerEntity player) {
      if (this.lootTable != null && this.world.getServer() != null) {
         ...
         this.lootTable = null;
         LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withParameter(LootParameters.field_237457_g_, Vector3d.func_237489_a_(this.pos)).withSeed(this.lootTableSeed);
         if (player != null) {
