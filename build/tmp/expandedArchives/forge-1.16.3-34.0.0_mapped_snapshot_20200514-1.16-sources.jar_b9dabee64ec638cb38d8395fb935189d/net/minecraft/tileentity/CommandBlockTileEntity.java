...
public class CommandBlockTileEntity extends TileEntity {
   ...
   private final CommandBlockLogic commandBlockLogic = new CommandBlockLogic() {
      ...
      public Vector3d getPositionVector() {
         return Vector3d.func_237489_a_(CommandBlockTileEntity.this.pos);
      }

      public CommandSource getCommandSource() {
         return new CommandSource(this, Vector3d.func_237489_a_(CommandBlockTileEntity.this.pos), Vector2f.ZERO, this.getWorld(), 2, this.getName().getString(), this.getName(), this.getWorld().getServer(), (Entity)null);
      }
   };
