      ...
      if (p_222826_1_.isRemote) {
         ...
         this.entitiesAtRing.stream().filter(this::isNearbyRaider).forEach((p_235655_4_) -> {
            ...
            for(int k = 0; k < j; ++k) {
               ...
               double d2 = (double)ColorHelper.PackedColor.func_233007_b_(l) / 255.0D;
               double d3 = (double)ColorHelper.PackedColor.func_233008_c_(l) / 255.0D;
               double d4 = (double)ColorHelper.PackedColor.func_233009_d_(l) / 255.0D;
