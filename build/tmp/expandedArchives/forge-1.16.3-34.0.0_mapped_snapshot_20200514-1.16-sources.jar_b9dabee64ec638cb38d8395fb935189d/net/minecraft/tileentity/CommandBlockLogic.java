...
public abstract class CommandBlockLogic implements ICommandSource {
   ...
   public ITextComponent getLastOutput() {
      return this.lastOutput == null ? StringTextComponent.field_240750_d_ : this.lastOutput;
   }
   ...
   public void sendMessage(ITextComponent component, UUID p_145747_2_) {
      if (this.trackOutput) {
         this.lastOutput = (new StringTextComponent("[" + TIMESTAMP_FORMAT.format(new Date()) + "] ")).func_230529_a_(component);
         this.updateCommand();
      }
