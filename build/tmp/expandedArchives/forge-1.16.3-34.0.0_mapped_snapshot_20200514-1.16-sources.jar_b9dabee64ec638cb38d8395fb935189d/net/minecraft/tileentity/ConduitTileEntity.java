...
public class ConduitTileEntity extends TileEntity implements ITickableTileEntity {
   ...
   public void func_230337_a_(BlockState p_230337_1_, CompoundNBT p_230337_2_) {
      ...
      if (p_230337_2_.hasUniqueId("Target")) {
         this.targetUuid = p_230337_2_.getUniqueId("Target");
      } else {
   ...
   private void addEffectsToPlayers() {
      ...
      if (!list.isEmpty()) {
         for(PlayerEntity playerentity : list) {
            if (this.pos.withinDistance(playerentity.func_233580_cy_(), (double)j) && playerentity.isWet()) {
   ...
   private void attackMobs() {
      ...
      } else if (!this.target.isAlive() || !this.pos.withinDistance(this.target.func_233580_cy_(), 8.0D)) {
         this.target = null;
      }
