...
public class LecternTileEntity extends TileEntity implements IClearable, INamedContainerProvider {
   ...
   private CommandSource createCommandSource(@Nullable PlayerEntity player) {
      ...
      Vector3d vector3d = Vector3d.func_237489_a_(this.pos);
   ...
   public void func_230337_a_(BlockState p_230337_1_, CompoundNBT p_230337_2_) {
      ...
      if (p_230337_2_.contains("Book", 10)) {
         this.book = this.ensureResolved(ItemStack.read(p_230337_2_.getCompound("Book")), (PlayerEntity)null);
      } else {
         this.book = ItemStack.EMPTY;
      }

      this.pages = WrittenBookItem.func_220049_j(this.book);
      this.page = MathHelper.clamp(p_230337_2_.getInt("Page"), 0, this.pages - 1);
   }
