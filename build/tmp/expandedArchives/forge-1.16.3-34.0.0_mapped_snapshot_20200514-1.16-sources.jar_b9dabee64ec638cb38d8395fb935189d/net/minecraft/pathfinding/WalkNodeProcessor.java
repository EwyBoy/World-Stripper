...
public class WalkNodeProcessor extends NodeProcessor {
   ...
   public PathPoint getStart() {
      ...
      BlockPos blockpos1 = this.entity.func_233580_cy_();
   ...
   public PathNodeType getPathNodeType(IBlockReader blockaccessIn, int x, int y, int z, MobEntity entitylivingIn, int xSize, int ySize, int zSize, boolean canBreakDoorsIn, boolean canEnterDoorsIn) {
      ...
      BlockPos blockpos = entitylivingIn.func_233580_cy_();
   ...
   protected static PathNodeType func_237238_b_(IBlockReader p_237238_0_, BlockPos p_237238_1_) {
      ...
      } else if (!blockstate.func_235714_a_(BlockTags.TRAPDOORS) && !blockstate.isIn(Blocks.LILY_PAD)) {
         if (blockstate.isIn(Blocks.CACTUS)) {
            ...
            } else if (DoorBlock.func_235492_h_(blockstate) && !blockstate.get(DoorBlock.OPEN)) {
   ...
   private static boolean func_237233_a_(BlockState p_237233_0_) {
      return p_237233_0_.func_235714_a_(BlockTags.field_232872_am_) || p_237233_0_.isIn(Blocks.LAVA) || p_237233_0_.isIn(Blocks.MAGMA_BLOCK) || CampfireBlock.func_226915_i_(p_237233_0_);
   }
}