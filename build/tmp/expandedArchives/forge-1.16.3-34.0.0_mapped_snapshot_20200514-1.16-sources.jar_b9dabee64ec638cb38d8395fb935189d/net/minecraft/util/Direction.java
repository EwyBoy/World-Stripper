...
public enum Direction implements IStringSerializable {
   ...
   public static Direction func_239631_a_(Random p_239631_0_) {
      return Util.func_240989_a_(VALUES, p_239631_0_);
   }
   ...
   public static enum Axis implements IStringSerializable, Predicate<Direction> {
      ...
      private static final Direction.Axis[] field_239633_e_ = values();
      public static final Codec<Direction.Axis> field_239632_d_ = IStringSerializable.func_233023_a_(Direction.Axis::values, Direction.Axis::byName);
      private static final Map<String, Direction.Axis> NAME_LOOKUP = Arrays.stream(field_239633_e_).collect(Collectors.toMap(Direction.Axis::getName2, (p_199785_0_) -> {
         return p_199785_0_;
      }));
      private final String name;
      ...
      public static Direction.Axis func_239634_a_(Random p_239634_0_) {
   ...
   public static enum AxisDirection {
      ...
      public Direction.AxisDirection func_239635_c_() {
   ...
   public static enum Plane implements Iterable<Direction>, Predicate<Direction> {
      ...
      public Direction random(Random rand) {
         return Util.func_240989_a_(this.facingValues, rand);
      }
