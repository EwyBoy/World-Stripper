...
public abstract class VoxelShape {
   ...
   @Nullable
   public BlockRayTraceResult rayTrace(Vector3d p_212433_1_, Vector3d p_212433_2_, BlockPos p_212433_3_) {
      if (this.isEmpty()) {
         return null;
      } else {
         ...
         if (vector3d.lengthSquared() < 1.0E-7D) {
            ...
            return this.contains(vector3d1.x - (double)p_212433_3_.getX(), vector3d1.y - (double)p_212433_3_.getY(), vector3d1.z - (double)p_212433_3_.getZ()) ? new BlockRayTraceResult(vector3d1, Direction.getFacingFromVector(vector3d.x, vector3d.y, vector3d.z).getOpposite(), p_212433_3_, true) : AxisAlignedBB.rayTrace(this.toBoundingBoxList(), p_212433_1_, p_212433_2_, p_212433_3_);
         }
      }
   }
