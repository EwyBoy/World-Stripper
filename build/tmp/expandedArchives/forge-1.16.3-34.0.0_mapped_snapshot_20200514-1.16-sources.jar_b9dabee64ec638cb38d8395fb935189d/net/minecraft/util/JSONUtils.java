...
public class JSONUtils {
   ...
   @Nullable
   @OnlyIn(Dist.CLIENT)
   public static <T> T func_233011_a_(Gson p_233011_0_, Reader p_233011_1_, TypeToken<T> p_233011_2_, boolean p_233011_3_) {
      try {
   ...
   @Nullable
   @OnlyIn(Dist.CLIENT)
   public static <T> T func_233013_a_(Gson p_233013_0_, String p_233013_1_, TypeToken<T> p_233013_2_, boolean p_233013_3_) {
      return func_233011_a_(p_233013_0_, new StringReader(p_233013_1_), p_233013_2_, p_233013_3_);
   }
   ...
   @Nullable
   @OnlyIn(Dist.CLIENT)
   public static <T> T func_233010_a_(Gson p_233010_0_, Reader p_233010_1_, TypeToken<T> p_233010_2_) {
      return func_233011_a_(p_233010_0_, p_233010_1_, p_233010_2_, false);
   }

   @Nullable
   @OnlyIn(Dist.CLIENT)
   public static <T> T func_233012_a_(Gson p_233012_0_, String p_233012_1_, TypeToken<T> p_233012_2_) {
      return func_233013_a_(p_233012_0_, p_233012_1_, p_233012_2_, false);
   }
