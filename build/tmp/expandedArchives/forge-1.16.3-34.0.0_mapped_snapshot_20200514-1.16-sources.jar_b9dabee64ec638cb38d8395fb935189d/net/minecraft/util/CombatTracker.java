...
public class CombatTracker {
   ...
   public void calculateFallSuffix() {
      ...
      if (optional.isPresent()) {
         ...
         if (!blockstate.isIn(Blocks.LADDER) && !blockstate.func_235714_a_(BlockTags.TRAPDOORS)) {
            if (blockstate.isIn(Blocks.VINE)) {
               this.fallSuffix = "vines";
            } else if (!blockstate.isIn(Blocks.field_235384_mx_) && !blockstate.isIn(Blocks.field_235385_my_)) {
               if (!blockstate.isIn(Blocks.field_235386_mz_) && !blockstate.isIn(Blocks.field_235342_mA_)) {
