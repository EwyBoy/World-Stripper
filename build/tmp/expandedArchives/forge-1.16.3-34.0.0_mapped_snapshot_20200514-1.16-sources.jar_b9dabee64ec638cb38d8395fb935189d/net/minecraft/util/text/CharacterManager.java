...
public class CharacterManager {
   ...
   public float func_238350_a_(@Nullable String p_238350_1_) {
      if (p_238350_1_ == null) {
         ...
         TextProcessing.func_238346_c_(p_238350_1_, Style.field_240709_b_, (p_238363_2_, p_238363_3_, p_238363_4_) -> {
   ...
   public float func_238356_a_(ITextProperties p_238356_1_) {
      MutableFloat mutablefloat = new MutableFloat();
      TextProcessing.func_238343_a_(p_238356_1_, Style.field_240709_b_, (p_238359_2_, p_238359_3_, p_238359_4_) -> {
   ...
   public Style func_238357_a_(ITextProperties p_238357_1_, int p_238357_2_) {
      ...
      }, Style.field_240709_b_).orElse((Style)null);
   }
   ...
   static class StyleOverridingTextComponent implements ITextProperties {
      ...
      public <T> Optional<T> func_230439_a_(ITextProperties.IStyledTextAcceptor<T> p_230439_1_, Style p_230439_2_) {
         return p_230439_1_.accept(this.field_238392_d_.func_240717_a_(p_230439_2_), this.field_238391_a_);
      }
   }
