...
public class SmithingTableContainer extends AbstractRepairContainer {
   ...
   public SmithingTableContainer(int p_i231591_1_, PlayerInventory p_i231591_2_, IWorldPosCallable p_i231591_3_) {
      super(ContainerType.field_234650_u_, p_i231591_1_, p_i231591_2_, p_i231591_3_);
      this.field_234651_g_ = p_i231591_2_.player.world;
      this.field_241443_i_ = this.field_234651_g_.getRecipeManager().func_241447_a_(IRecipeType.field_234827_g_);
   }
   ...
   public void updateRepairOutput() {
      List<SmithingRecipe> list = this.field_234651_g_.getRecipeManager().getRecipes(IRecipeType.field_234827_g_, this.field_234643_d_, this.field_234651_g_);
      if (list.isEmpty()) {
   ...
   protected boolean func_241210_a_(ItemStack p_241210_1_) {
      return this.field_241443_i_.stream().anyMatch((p_241444_1_) -> {
         return p_241444_1_.func_241456_a_(p_241210_1_);
      });
   }
