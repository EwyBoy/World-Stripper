...
public class RepairContainer extends AbstractRepairContainer {
   ...
   protected boolean func_230302_a_(BlockState p_230302_1_) {
      return p_230302_1_.func_235714_a_(BlockTags.ANVIL);
   }
   ...
   protected ItemStack func_230301_a_(PlayerEntity p_230301_1_, ItemStack p_230301_2_) {
      ...
      float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(p_230301_1_, p_230301_2_, RepairContainer.this.field_234643_d_.getStackInSlot(0), RepairContainer.this.field_234643_d_.getStackInSlot(1));
      ...
      this.field_234644_e_.consume((p_234633_1_, p_234633_2_) -> {
         ...
         if (!p_230301_1_.abilities.isCreativeMode && blockstate.func_235714_a_(BlockTags.ANVIL) && p_230301_1_.getRNG().nextFloat() < breakChance) {
   ...
   public void updateRepairOutput() {
      ...
      if (itemstack.isEmpty()) {
         ...
         if (!itemstack2.isEmpty()) {
            if (!net.minecraftforge.common.ForgeHooks.onAnvilChange(this, itemstack, itemstack2, field_234642_c_, repairedItemName, j)) return;
