...
public class LoomContainer extends Container {
   ...
   public void onCraftMatrixChanged(IInventory inventoryIn) {
      ...
      if (itemstack3.isEmpty() || !itemstack.isEmpty() && !itemstack1.isEmpty() && this.field_217034_d.get() > 0 && (this.field_217034_d.get() < BannerPattern.field_222480_O - BannerPattern.field_235646_Q_ || !itemstack2.isEmpty())) {
