...
public class ByteArrayNBT extends CollectionNBT<ByteNBT> {
   ...
   public ITextComponent toFormattedComponent(String indentation, int indentDepth) {
      ITextComponent itextcomponent = (new StringTextComponent("B")).func_240699_a_(SYNTAX_HIGHLIGHTING_NUMBER_TYPE);
      IFormattableTextComponent iformattabletextcomponent = (new StringTextComponent("[")).func_230529_a_(itextcomponent).func_240702_b_(";");

      for(int i = 0; i < this.data.length; ++i) {
         IFormattableTextComponent iformattabletextcomponent1 = (new StringTextComponent(String.valueOf((int)this.data[i]))).func_240699_a_(SYNTAX_HIGHLIGHTING_NUMBER);
         iformattabletextcomponent.func_240702_b_(" ").func_230529_a_(iformattabletextcomponent1).func_230529_a_(itextcomponent);
