...
public class IntArrayNBT extends CollectionNBT<IntNBT> {
   ...
   public ITextComponent toFormattedComponent(String indentation, int indentDepth) {
      ITextComponent itextcomponent = (new StringTextComponent("I")).func_240699_a_(SYNTAX_HIGHLIGHTING_NUMBER_TYPE);
      IFormattableTextComponent iformattabletextcomponent = (new StringTextComponent("[")).func_230529_a_(itextcomponent).func_240702_b_(";");

      for(int i = 0; i < this.intArray.length; ++i) {
         iformattabletextcomponent.func_240702_b_(" ").func_230529_a_((new StringTextComponent(String.valueOf(this.intArray[i]))).func_240699_a_(SYNTAX_HIGHLIGHTING_NUMBER));
