   ...
   public ITextComponent toFormattedComponent(String indentation, int indentDepth) {
      if (this.isEmpty()) {
         ...
         for(int j = 0; j < this.tagList.size(); ++j) {
            if (j != 0) {
               iformattabletextcomponent2.func_240702_b_(", ");
            }

            iformattabletextcomponent2.func_230529_a_(this.tagList.get(j).toFormattedComponent());
         }
         ...
         for(int i = 0; i < this.tagList.size(); ++i) {
            ...
            iformattabletextcomponent1.func_230529_a_(this.tagList.get(i).toFormattedComponent(indentation, indentDepth + 1));
            if (i != this.tagList.size() - 1) {
               iformattabletextcomponent1.func_240702_b_(s).func_240702_b_(indentation.isEmpty() ? " " : "\n");
            }

            iformattabletextcomponent.func_230529_a_(iformattabletextcomponent1);
         }
