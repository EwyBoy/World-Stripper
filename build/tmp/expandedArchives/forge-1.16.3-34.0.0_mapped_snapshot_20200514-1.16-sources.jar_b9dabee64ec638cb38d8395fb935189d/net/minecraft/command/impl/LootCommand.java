...
public class LootCommand {
   ...
   private static int func_218876_a(CommandContext<CommandSource> p_218876_0_, ResourceLocation p_218876_1_, BlockPos p_218876_2_, ItemStack p_218876_3_, LootCommand.ITargetHandler p_218876_4_) throws CommandSyntaxException {
      ...
      LootContext lootcontext = (new LootContext.Builder(commandsource.getWorld())).withParameter(LootParameters.field_237457_g_, Vector3d.func_237489_a_(p_218876_2_)).withParameter(LootParameters.TOOL, p_218876_3_).withNullableParameter(LootParameters.THIS_ENTITY, commandsource.getEntity()).build(LootParameterSets.FISHING);
