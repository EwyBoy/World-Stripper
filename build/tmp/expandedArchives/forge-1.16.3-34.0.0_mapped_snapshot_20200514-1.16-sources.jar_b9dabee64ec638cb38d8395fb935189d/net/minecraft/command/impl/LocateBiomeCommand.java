...
public class LocateBiomeCommand {
   ...
   public static void func_241046_a_(CommandDispatcher<CommandSource> p_241046_0_) {
   ...
   private static int func_241049_a_(CommandSource p_241049_0_, ResourceLocation p_241049_1_) throws CommandSyntaxException {
      Biome biome = p_241049_0_.getServer().func_244267_aX().func_243612_b(Registry.field_239720_u_).func_241873_b(p_241049_1_).orElseThrow(() -> {
