   ...
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register(Commands.literal("tellraw").requires((p_198820_0_) -> {
         ...
         for(ServerPlayerEntity serverplayerentity : EntityArgument.getPlayers(p_198819_0_, "targets")) {
            serverplayerentity.sendMessage(TextComponentUtils.func_240645_a_(p_198819_0_.getSource(), ComponentArgument.getComponent(p_198819_0_, "message"), serverplayerentity, 0), Util.field_240973_b_);
            ++i;
         }
