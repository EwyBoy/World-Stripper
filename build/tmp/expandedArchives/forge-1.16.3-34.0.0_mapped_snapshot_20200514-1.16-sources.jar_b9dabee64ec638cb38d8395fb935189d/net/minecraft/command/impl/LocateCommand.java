...
public class LocateCommand {
   ...
   public static int func_241054_a_(CommandSource p_241054_0_, String p_241054_1_, BlockPos p_241054_2_, BlockPos p_241054_3_, String p_241054_4_) {
      ...
      ITextComponent itextcomponent = TextComponentUtils.func_240647_a_(new TranslationTextComponent("chat.coordinates", p_241054_3_.getX(), "~", p_241054_3_.getZ())).func_240700_a_((p_241055_1_) -> {
         return p_241055_1_.func_240712_a_(TextFormatting.GREEN).func_240715_a_(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/tp @s " + p_241054_3_.getX() + " ~ " + p_241054_3_.getZ())).func_240716_a_(new HoverEvent(HoverEvent.Action.field_230550_a_, new TranslationTextComponent("chat.coordinates.tooltip")));
      });
