...
public class SummonCommand {
   ...
   private static int summonEntity(CommandSource source, ResourceLocation type, Vector3d pos, CompoundNBT nbt, boolean randomizeProperties) throws CommandSyntaxException {
      ...
      if (!World.func_234935_k_(blockpos)) {
         ...
         Entity entity = EntityType.func_220335_a(compoundnbt, serverworld, (p_218914_1_) -> {
         ...
         if (entity == null) {
            ...
            if (randomizeProperties && entity instanceof MobEntity) {
               ((MobEntity)entity).onInitialSpawn(source.getWorld(), source.getWorld().getDifficultyForLocation(entity.func_233580_cy_()), SpawnReason.COMMAND, (ILivingEntityData)null, (CompoundNBT)null);
            }
