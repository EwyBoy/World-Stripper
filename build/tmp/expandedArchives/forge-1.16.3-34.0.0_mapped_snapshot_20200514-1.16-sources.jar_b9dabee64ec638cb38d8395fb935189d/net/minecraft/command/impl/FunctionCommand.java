...
public class FunctionCommand {
   public static final SuggestionProvider<CommandSource> FUNCTION_SUGGESTER = (p_198477_0_, p_198477_1_) -> {
      ...
      ISuggestionProvider.suggestIterable(functionmanager.func_240950_g_(), p_198477_1_, "#");
      return ISuggestionProvider.suggestIterable(functionmanager.func_240949_f_(), p_198477_1_);
   };
