...
public class Commands {
   ...
   public Commands(Commands.EnvironmentType p_i232148_1_) {
      ...
      AttributeCommand.func_241003_a_(this.dispatcher);
      ...
      LocateBiomeCommand.func_241046_a_(this.dispatcher);
      ...
      SeedCommand.func_241067_a_(this.dispatcher, p_i232148_1_ != Commands.EnvironmentType.INTEGRATED);
   ...
   public int handleCommand(CommandSource source, String command) {
      ...
      try {
         try {
            ParseResults<CommandSource> parse = this.dispatcher.parse(stringreader, source);
            ...
            if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
               ...
               if (j < commandsyntaxexception.getInput().length()) {
                  ITextComponent itextcomponent = (new StringTextComponent(commandsyntaxexception.getInput().substring(j))).func_240701_a_(new TextFormatting[]{TextFormatting.RED, TextFormatting.UNDERLINE});
                  iformattabletextcomponent1.func_230529_a_(itextcomponent);
               }
