         ...
         if (this.selectors.length != 0 && allowSelectors) {
            ...
            for(MessageArgument.Part messageargument$part : this.selectors) {
               ...
               if (i < messageargument$part.getStart()) {
                  iformattabletextcomponent.func_240702_b_(this.text.substring(i, messageargument$part.getStart()));
               }
            ...
            if (i < this.text.length()) {
               iformattabletextcomponent.func_240702_b_(this.text.substring(i, this.text.length()));
            }
