...
public class SetAttributes extends LootFunction {
   ...
   public LootFunctionType func_230425_b_() {
      return LootFunctionManager.field_237436_i_;
   }
   ...
   public ItemStack doApply(ItemStack stack, LootContext context) {
      ...
      for(SetAttributes.Modifier setattributes$modifier : this.modifiers) {
         ...
         EquipmentSlotType equipmentslottype = Util.func_240989_a_(setattributes$modifier.slots, random);
   ...
   static class Modifier {
      ...
      public JsonObject serialize(JsonSerializationContext context) {
         ...
         jsonobject.addProperty("attribute", Registry.field_239692_aP_.getKey(this.attributeName).toString());
