...
public class ResourcePackInfo implements AutoCloseable {
   ...
   private static final PackMetadataSection BROKEN_ASSETS_FALLBACK = new PackMetadataSection((new TranslationTextComponent("resourcePack.broken_assets")).func_240701_a_(new TextFormatting[]{TextFormatting.RED, TextFormatting.ITALIC}), SharedConstants.getVersion().getPackVersion());
   ...
   public ResourcePackInfo(String p_i231421_1_, boolean p_i231421_2_, Supplier<IResourcePack> p_i231421_3_, IResourcePack p_i231421_4_, PackMetadataSection p_i231421_5_, ResourcePackInfo.Priority p_i231421_6_, IPackNameDecorator p_i231421_7_, boolean hidden) {
      this(p_i231421_1_, p_i231421_2_, p_i231421_3_, new StringTextComponent(p_i231421_4_.getName()), p_i231421_5_.getDescription(), PackCompatibility.getCompatibility(p_i231421_5_.getPackFormat()), p_i231421_6_, false, p_i231421_7_, hidden);
   }
   ...
   public ITextComponent getChatLink(boolean p_195794_1_) {
      return TextComponentUtils.func_240647_a_(this.field_232611_k_.decorate(new StringTextComponent(this.name))).func_240700_a_((p_211689_2_) -> {
         return p_211689_2_.func_240712_a_(p_195794_1_ ? TextFormatting.GREEN : TextFormatting.RED).func_240714_a_(StringArgumentType.escapeIfRequired(this.name)).func_240716_a_(new HoverEvent(HoverEvent.Action.field_230550_a_, (new StringTextComponent("")).func_230529_a_(this.title).func_240702_b_("\n").func_230529_a_(this.description)));
      });
   }
