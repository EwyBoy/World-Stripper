...
public class ParticleTypes {
   ...
   public static final BasicParticleType field_239811_B_ = register("soul_fire_flame", false);
   public static final BasicParticleType field_239812_C_ = register("soul", false);
   ...
   public static final BasicParticleType field_239813_am_ = register("ash", false);
   public static final BasicParticleType field_239814_an_ = register("crimson_spore", false);
   public static final BasicParticleType field_239815_ao_ = register("warped_spore", false);
   public static final BasicParticleType field_239816_ap_ = register("dripping_obsidian_tear", false);
   public static final BasicParticleType field_239817_aq_ = register("falling_obsidian_tear", false);
   public static final BasicParticleType field_239818_ar_ = register("landing_obsidian_tear", false);
   public static final BasicParticleType field_239819_as_ = register("reverse_portal", false);
   public static final BasicParticleType field_239820_at_ = register("white_ash", false);
   public static final Codec<IParticleData> field_239821_au_ = Registry.PARTICLE_TYPE.dispatch("type", IParticleData::getType, ParticleType::func_230522_e_);
