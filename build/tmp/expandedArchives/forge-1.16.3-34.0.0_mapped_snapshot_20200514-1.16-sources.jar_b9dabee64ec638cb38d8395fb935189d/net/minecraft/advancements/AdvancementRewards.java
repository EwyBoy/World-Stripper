...
public class AdvancementRewards {
   ...
   public void apply(ServerPlayerEntity player) {
      ...
      LootContext lootcontext = (new LootContext.Builder(player.getServerWorld())).withParameter(LootParameters.THIS_ENTITY, player).withParameter(LootParameters.field_237457_g_, player.getPositionVec()).withRandom(player.getRNG()).withLuck(player.getLuck()).build(LootParameterSets.ADVANCEMENT); // FORGE: luck to LootContext
      boolean flag = false;
   ...
   public static AdvancementRewards func_241096_a_(JsonObject p_241096_0_) throws JsonParseException {
      int i = JSONUtils.getInt(p_241096_0_, "experience", 0);
      JsonArray jsonarray = JSONUtils.getJsonArray(p_241096_0_, "loot", new JsonArray());
      ...
      JsonArray jsonarray1 = JSONUtils.getJsonArray(p_241096_0_, "recipes", new JsonArray());
      ...
      if (p_241096_0_.has("function")) {
         functionobject$cacheablefunction = new FunctionObject.CacheableFunction(new ResourceLocation(JSONUtils.getString(p_241096_0_, "function")));
      } else {
