...
public class StatePropertiesPredicate {
   ...
   public <S extends StateHolder<?, S>> boolean matchesAll(StateContainer<?, S> p_227182_1_, S p_227182_2_) {
   ...
   public static class Builder {
      ...
      public StatePropertiesPredicate.Builder withStringProp(Property<?> p_227194_1_, String p_227194_2_) {
         this.matchers.add(new StatePropertiesPredicate.ExactMatcher(p_227194_1_.getName(), p_227194_2_));
         return this;
      }

      public StatePropertiesPredicate.Builder withIntProp(Property<Integer> p_227192_1_, int p_227192_2_) {
         return this.withStringProp(p_227192_1_, Integer.toString(p_227192_2_));
      }

      public StatePropertiesPredicate.Builder withBoolProp(Property<Boolean> p_227195_1_, boolean p_227195_2_) {
         return this.withStringProp(p_227195_1_, Boolean.toString(p_227195_2_));
      }

      public <T extends Comparable<T> & IStringSerializable> StatePropertiesPredicate.Builder withProp(Property<T> p_227193_1_, T p_227193_2_) {
         return this.withStringProp(p_227193_1_, p_227193_2_.func_176610_l());
      }
   ...
   static class ExactMatcher extends StatePropertiesPredicate.Matcher {
      ...
      protected <T extends Comparable<T>> boolean func_225554_a_(StateHolder<?, ?> p_225554_1_, Property<T> p_225554_2_) {
   ...
   abstract static class Matcher {
      ...
      public <S extends StateHolder<?, S>> boolean test(StateContainer<?, S> p_227199_1_, S p_227199_2_) {
         Property<?> property = p_227199_1_.getProperty(this.propertyName);
         return property == null ? false : this.func_225554_a_(p_227199_2_, property);
      }

      protected abstract <T extends Comparable<T>> boolean func_225554_a_(StateHolder<?, ?> p_225554_1_, Property<T> p_225554_2_);
      ...
      public void runIfNotPresent(StateContainer<?, ?> p_227200_1_, Consumer<String> p_227200_2_) {
         Property<?> property = p_227200_1_.getProperty(this.propertyName);
         if (property == null) {
