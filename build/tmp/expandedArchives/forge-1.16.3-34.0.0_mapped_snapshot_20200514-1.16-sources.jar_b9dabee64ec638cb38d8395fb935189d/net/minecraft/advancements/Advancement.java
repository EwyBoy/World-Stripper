...
public class Advancement {
   ...
   public Advancement(ResourceLocation id, @Nullable Advancement parentIn, @Nullable DisplayInfo displayIn, AdvancementRewards rewardsIn, Map<String, Criterion> criteriaIn, String[][] requirementsIn) {
      ...
      if (displayIn == null) {
         ...
         ITextComponent itextcomponent1 = TextComponentUtils.func_240648_a_(itextcomponent.func_230532_e_(), Style.field_240709_b_.func_240712_a_(textformatting)).func_240702_b_("\n").func_230529_a_(displayIn.getDescription());
         ITextComponent itextcomponent2 = itextcomponent.func_230532_e_().func_240700_a_((p_211567_1_) -> {
            return p_211567_1_.func_240716_a_(new HoverEvent(HoverEvent.Action.field_230550_a_, itextcomponent1));
         });
         this.displayText = TextComponentUtils.func_240647_a_(itextcomponent2).func_240699_a_(textformatting);
      }
   ...
   public static class Builder {
      ...
      public static Advancement.Builder func_241043_a_(JsonObject p_241043_0_, ConditionArrayParser p_241043_1_) {
         ...
         ResourceLocation resourcelocation = p_241043_0_.has("parent") ? new ResourceLocation(JSONUtils.getString(p_241043_0_, "parent")) : null;
         DisplayInfo displayinfo = p_241043_0_.has("display") ? DisplayInfo.deserialize(JSONUtils.getJsonObject(p_241043_0_, "display")) : null;
         AdvancementRewards advancementrewards = p_241043_0_.has("rewards") ? AdvancementRewards.func_241096_a_(JSONUtils.getJsonObject(p_241043_0_, "rewards")) : AdvancementRewards.EMPTY;
         Map<String, Criterion> map = Criterion.func_232634_b_(JSONUtils.getJsonObject(p_241043_0_, "criteria"), p_241043_1_);
         if (map.isEmpty()) {
            throw new JsonSyntaxException("Advancement criteria cannot be empty");
         } else {
            JsonArray jsonarray = JSONUtils.getJsonArray(p_241043_0_, "requirements", new JsonArray());
