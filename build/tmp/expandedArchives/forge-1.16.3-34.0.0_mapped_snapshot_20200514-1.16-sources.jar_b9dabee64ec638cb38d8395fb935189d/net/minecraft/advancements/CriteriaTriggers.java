...
public class CriteriaTriggers {
   ...
   public static final TargetHitTrigger field_232606_L_ = register(new TargetHitTrigger());
   public static final RightClickBlockWithItemTrigger field_232607_M_ = register(new RightClickBlockWithItemTrigger());
   public static final PlayerGeneratesContainerLootTrigger field_232608_N_ = register(new PlayerGeneratesContainerLootTrigger());
   public static final ThrownItemPickedUpByEntityTrigger field_232609_O_ = register(new ThrownItemPickedUpByEntityTrigger());
   public static final PlayerEntityInteractionTrigger field_241276_P_ = register(new PlayerEntityInteractionTrigger());
