...
public class DemoPlayerInteractionManager extends PlayerInteractionManager {
      ...
      if (i % 24000L == 500L) {
         if (j <= 6L) {
            if (j == 6L) {
               ...
               this.player.sendMessage(new TranslationTextComponent("demo.day." + j), Util.field_240973_b_);
            }
         }
      } else if (j == 1L) {
         if (i == 100L) {
         ...
         this.player.sendMessage(new TranslationTextComponent("demo.day.warning"), Util.field_240973_b_);
      }
   ...
   private void sendDemoReminder() {
      if (this.demoEndedReminder > 100) {
         this.player.sendMessage(new TranslationTextComponent("demo.reminder"), Util.field_240973_b_);
