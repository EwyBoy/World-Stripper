...
public class CustomServerBossInfo extends ServerBossInfo {
   ...
   public final ITextComponent getFormattedName() {
      return TextComponentUtils.func_240647_a_(this.getName()).func_240700_a_((p_211569_1_) -> {
         return p_211569_1_.func_240712_a_(this.getColor().getFormatting()).func_240716_a_(new HoverEvent(HoverEvent.Action.field_230550_a_, new StringTextComponent(this.getId().toString()))).func_240714_a_(this.getId().toString());
      });
   }
