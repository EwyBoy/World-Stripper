...
public class Main {
   ...
   public static void main(String[] p_main_0_) {
      ...
      try {
         ...
         WorldSettingsImport<INBT> worldsettingsimport = WorldSettingsImport.func_244335_a(NBTDynamicOps.INSTANCE, datapackregistries.func_240970_h_(), dynamicregistries$impl);
