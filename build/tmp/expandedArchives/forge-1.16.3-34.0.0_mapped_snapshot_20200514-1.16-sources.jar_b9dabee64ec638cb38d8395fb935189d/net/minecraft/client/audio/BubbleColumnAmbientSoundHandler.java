...
public class BubbleColumnAmbientSoundHandler implements IAmbientSoundHandler {
   ...
   public void tick() {
      ...
      BlockState blockstate = world.func_234939_c_(this.player.getBoundingBox().grow(0.0D, (double)-0.4F, 0.0D).shrink(0.001D)).filter((p_239528_0_) -> {
         return p_239528_0_.isIn(Blocks.BUBBLE_COLUMN);
      }).findFirst().orElse((BlockState)null);
      if (blockstate != null) {
         if (!this.field_217865_b && !this.field_217866_c && blockstate.isIn(Blocks.BUBBLE_COLUMN) && !this.player.isSpectator()) {
