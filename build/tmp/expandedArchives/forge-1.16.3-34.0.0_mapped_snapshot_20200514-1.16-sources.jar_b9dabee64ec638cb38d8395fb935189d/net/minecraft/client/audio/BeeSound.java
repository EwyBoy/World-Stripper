...
public abstract class BeeSound extends TickableSound {
   ...
   public BeeSound(BeeEntity p_i226060_1_, SoundEvent p_i226060_2_, SoundCategory p_i226060_3_) {
      ...
      this.x = (double)((float)p_i226060_1_.getPosX());
      this.y = (double)((float)p_i226060_1_.getPosY());
      this.z = (double)((float)p_i226060_1_.getPosZ());
      this.repeat = true;
      this.repeatDelay = 0;
      this.volume = 0.0F;
   }
   ...
   public void tick() {
      ...
      if (!this.field_229357_o_.removed && !this.field_229358_p_) {
         this.x = (double)((float)this.field_229357_o_.getPosX());
         this.y = (double)((float)this.field_229357_o_.getPosY());
         this.z = (double)((float)this.field_229357_o_.getPosZ());
   ...
   public boolean func_230510_t_() {
      return !this.field_229357_o_.isSilent();
   }
