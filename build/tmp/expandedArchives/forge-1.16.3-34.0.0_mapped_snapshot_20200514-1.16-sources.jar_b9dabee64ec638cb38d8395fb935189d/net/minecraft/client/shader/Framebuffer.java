...
public class Framebuffer {
   ...
   public void createBuffers(int p_216492_1_, int p_216492_2_, boolean p_216492_3_) {
      ...
      if (this.useDepth) {
         ...
         GlStateManager.texImage2D(3553, 0, org.lwjgl.opengl.GL30.GL_DEPTH32F_STENCIL8, this.framebufferTextureWidth, this.framebufferTextureHeight, 0, org.lwjgl.opengl.GL30.GL_DEPTH_STENCIL, org.lwjgl.opengl.GL30.GL_FLOAT_32_UNSIGNED_INT_24_8_REV, null);
      }
      ...
      if (this.useDepth) {
         ...
         GlStateManager.framebufferTexture2D(FramebufferConstants.GL_FRAMEBUFFER, FramebufferConstants.GL_DEPTH_ATTACHMENT, 3553, this.depthBuffer, 0);
            ...
            GlStateManager.framebufferTexture2D(FramebufferConstants.GL_FRAMEBUFFER, org.lwjgl.opengl.GL30.GL_DEPTH_STENCIL_ATTACHMENT, 3553, this.depthBuffer, 0);
         } else {
            GlStateManager.framebufferTexture2D(FramebufferConstants.GL_FRAMEBUFFER, org.lwjgl.opengl.GL30.GL_DEPTH_ATTACHMENT, 3553, this.depthBuffer, 0);
            GlStateManager.framebufferTexture2D(FramebufferConstants.GL_FRAMEBUFFER, org.lwjgl.opengl.GL30.GL_STENCIL_ATTACHMENT, 3553, this.depthBuffer, 0);
         }
      }
