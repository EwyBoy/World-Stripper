...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
   ...
   public ClientPlayerEntity(Minecraft p_i232461_1_, ClientWorld p_i232461_2_, ClientPlayNetHandler p_i232461_3_, StatisticsManager p_i232461_4_, ClientRecipeBook p_i232461_5_, boolean p_i232461_6_, boolean p_i232461_7_) {
      super(p_i232461_2_, p_i232461_3_.getGameProfile());
      this.mc = p_i232461_1_;
      this.connection = p_i232461_3_;
      this.stats = p_i232461_4_;
      this.recipeBook = p_i232461_5_;
      this.field_228351_cj_ = p_i232461_6_;
      this.serverSprintState = p_i232461_7_;
      this.ambientSoundHandlers.add(new UnderwaterAmbientSoundHandler(this, p_i232461_1_.getSoundHandler()));
      this.ambientSoundHandlers.add(new BubbleColumnAmbientSoundHandler(this));
      this.ambientSoundHandlers.add(new BiomeSoundHandler(this, p_i232461_1_.getSoundHandler(), p_i232461_2_.getBiomeManager()));
   }
   ...
   public boolean func_230491_ea_() {
      return !this.abilities.isFlying && super.func_230491_ea_();
   }
   ...
   public boolean func_230490_cK_() {
      return !this.abilities.isFlying && super.func_230490_cK_();
   }
   ...
   public void removeRecipeHighlight(IRecipe<?> p_193103_1_) {
      if (this.recipeBook.isNew(p_193103_1_)) {
         ...
         this.connection.sendPacket(new CMarkRecipeSeenPacket(p_193103_1_));
      }
   ...
   private boolean shouldBlockPushPlayer(BlockPos p_205027_1_) {
      ...
      AxisAlignedBB axisalignedbb1 = (new AxisAlignedBB((double)p_205027_1_.getX(), axisalignedbb.minY, (double)p_205027_1_.getZ(), (double)p_205027_1_.getX() + 1.0D, axisalignedbb.maxY, (double)p_205027_1_.getZ() + 1.0D)).shrink(1.0E-7D);
   ...
   public void livingTick() {
      ...
      this.field_239203_ch_ = !this.abilities.isFlying && !this.isSwimming() && this.isPoseClear(Pose.CROUCHING) && (this.isSneaking() || !this.isSleeping() && !this.isPoseClear(Pose.STANDING));
   ...
   private void func_213839_ed() {
      ...
      if (this.inPortal) {
         if (this.mc.currentScreen != null && !this.mc.currentScreen.func_231177_au__()) {
         ...
         if (this.timeInPortal == 0.0F) {
            this.mc.getSoundHandler().play(SimpleSound.func_239532_b_(SoundEvents.BLOCK_PORTAL_TRIGGER, this.rand.nextFloat() * 0.4F + 0.8F, 0.25F));
         }
         ...
         if (!(f13 < -0.15F)) {
            ...
            if (blockstate.getCollisionShape(this.world, blockpos, iselectioncontext).isEmpty()) {
               ...
               if (blockstate1.getCollisionShape(this.world, blockpos, iselectioncontext).isEmpty()) {
                  ...
                  Iterator<AxisAlignedBB> iterator = this.world.func_234867_d_(this, axisalignedbb, (p_239205_0_) -> {
                     return true;
                  }).flatMap((p_212329_0_) -> {
