...
public class ParticleManager implements IFutureReloadListener {
   ...
   private void registerFactories() {
      ...
      this.registerFactory(ParticleTypes.field_239812_C_, SoulParticle.Factory::new);
      this.registerFactory(ParticleTypes.field_239811_B_, FlameParticle.Factory::new);
      ...
      this.registerFactory(ParticleTypes.field_239813_am_, AshParticle.Factory::new);
      this.registerFactory(ParticleTypes.field_239814_an_, UnderwaterParticle.CrimsonSporeFactory::new);
      this.registerFactory(ParticleTypes.field_239815_ao_, UnderwaterParticle.WarpedSporeFactory::new);
      this.registerFactory(ParticleTypes.field_239816_ap_, DripParticle.DrippingObsidianTearFactory::new);
      this.registerFactory(ParticleTypes.field_239817_aq_, DripParticle.FallingObsidianTearFactory::new);
      this.registerFactory(ParticleTypes.field_239818_ar_, DripParticle.LandingObsidianTearFactory::new);
      this.registerFactory(ParticleTypes.field_239819_as_, ReversePortalParticle.Factory::new);
      this.registerFactory(ParticleTypes.field_239820_at_, WhiteAshParticle.Factory::new);
   }
