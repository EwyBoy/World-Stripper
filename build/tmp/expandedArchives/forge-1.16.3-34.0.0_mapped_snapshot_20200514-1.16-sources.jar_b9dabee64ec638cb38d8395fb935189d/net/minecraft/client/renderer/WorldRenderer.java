...
public class WorldRenderer implements IResourceManagerReloadListener, AutoCloseable {
   ...
   public void renderSky(MatrixStack matrixStackIn, float partialTicks) {
      if (this.mc.world.func_239132_a_().func_241683_c_() == DimensionRenderInfo.FogType.END) {
         ...
         double d0 = this.mc.player.getEyePosition(partialTicks).y - this.world.getWorldInfo().func_239159_f_();
         if (d0 < 0.0D) {
            matrixStackIn.push();
   ...
   public void playEvent(PlayerEntity player, int type, BlockPos blockPosIn, int data) {
      ...
      case 1043:
         ...
         break;
      case 1044:
         this.world.playSound(blockPosIn, SoundEvents.field_232842_og_, SoundCategory.BLOCKS, 1.0F, this.world.rand.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1500:
      ...
      case 2002:
      case 2007:
         Vector3d vector3d = Vector3d.func_237492_c_(blockPosIn);
