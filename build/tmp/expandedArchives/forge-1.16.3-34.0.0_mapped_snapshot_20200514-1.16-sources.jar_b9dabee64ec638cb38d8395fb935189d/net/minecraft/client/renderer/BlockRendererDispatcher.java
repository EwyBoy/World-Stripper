...
public class BlockRendererDispatcher implements IResourceManagerReloadListener {
   ...
   public void renderBlockDamage(BlockState blockStateIn, BlockPos posIn, IBlockDisplayReader lightReaderIn, MatrixStack matrixStackIn, IVertexBuilder vertexBuilderIn) {
       renderBlockDamage(blockStateIn,posIn, lightReaderIn, matrixStackIn, vertexBuilderIn, net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }
   ...
   public void renderBlock(BlockState blockStateIn, MatrixStack matrixStackIn, IRenderTypeBuffer bufferTypeIn, int combinedLightIn, int combinedOverlayIn, net.minecraftforge.client.model.data.IModelData modelData) {
      ...
      if (blockrendertype != BlockRenderType.INVISIBLE) {
         ...
         case MODEL:
            ...
            this.blockModelRenderer.renderModel(matrixStackIn.getLast(), bufferTypeIn.getBuffer(RenderTypeLookup.func_239220_a_(blockStateIn, false)), blockStateIn, ibakedmodel, f, f1, f2, combinedLightIn, combinedOverlayIn, modelData);
            break;
         case ENTITYBLOCK_ANIMATED:
            ItemStack stack = new ItemStack(blockStateIn.getBlock());
            stack.getItem().getItemStackTileEntityRenderer().func_239207_a_(stack, ItemCameraTransforms.TransformType.NONE, matrixStackIn, bufferTypeIn, combinedLightIn, combinedOverlayIn);
         }
