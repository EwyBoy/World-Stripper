...
public class BlockModelRenderer {
   ...
   private void fillQuadBounds(IBlockDisplayReader blockReaderIn, BlockState stateIn, BlockPos posIn, int[] vertexData, Direction face, @Nullable float[] quadBounds, BitSet boundsFlags) {
      ...
      case DOWN:
         ...
         boundsFlags.set(0, f1 == f4 && (f1 < 1.0E-4F || stateIn.func_235785_r_(blockReaderIn, posIn)));
         break;
      case UP:
         boundsFlags.set(1, f >= 1.0E-4F || f2 >= 1.0E-4F || f3 <= 0.9999F || f5 <= 0.9999F);
         boundsFlags.set(0, f1 == f4 && (f4 > 0.9999F || stateIn.func_235785_r_(blockReaderIn, posIn)));
         break;
      case NORTH:
         boundsFlags.set(1, f >= 1.0E-4F || f1 >= 1.0E-4F || f3 <= 0.9999F || f4 <= 0.9999F);
         boundsFlags.set(0, f2 == f5 && (f2 < 1.0E-4F || stateIn.func_235785_r_(blockReaderIn, posIn)));
         break;
      case SOUTH:
         boundsFlags.set(1, f >= 1.0E-4F || f1 >= 1.0E-4F || f3 <= 0.9999F || f4 <= 0.9999F);
         boundsFlags.set(0, f2 == f5 && (f5 > 0.9999F || stateIn.func_235785_r_(blockReaderIn, posIn)));
         break;
      case WEST:
         boundsFlags.set(1, f1 >= 1.0E-4F || f2 >= 1.0E-4F || f4 <= 0.9999F || f5 <= 0.9999F);
         boundsFlags.set(0, f == f3 && (f < 1.0E-4F || stateIn.func_235785_r_(blockReaderIn, posIn)));
         break;
      case EAST:
         boundsFlags.set(1, f1 >= 1.0E-4F || f2 >= 1.0E-4F || f4 <= 0.9999F || f5 <= 0.9999F);
         boundsFlags.set(0, f == f3 && (f3 > 0.9999F || stateIn.func_235785_r_(blockReaderIn, posIn)));
      }
   ...
   class AmbientOcclusionFace {
      ...
      public void func_239285_a_(IBlockDisplayReader p_239285_1_, BlockState p_239285_2_, BlockPos p_239285_3_, Direction p_239285_4_, float[] p_239285_5_, BitSet p_239285_6_, boolean p_239285_7_) {
         ...
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[0]);
         ...
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[1]);
         ...
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[2]);
         ...
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[3]);
         ...
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[0]).move(p_239285_4_);
         boolean flag = p_239285_1_.getBlockState(blockpos$mutable).getOpacity(p_239285_1_, blockpos$mutable) == 0;
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[1]).move(p_239285_4_);
         boolean flag1 = p_239285_1_.getBlockState(blockpos$mutable).getOpacity(p_239285_1_, blockpos$mutable) == 0;
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[2]).move(p_239285_4_);
         boolean flag2 = p_239285_1_.getBlockState(blockpos$mutable).getOpacity(p_239285_1_, blockpos$mutable) == 0;
         blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[3]).move(p_239285_4_);
         ...
         if (!flag2 && !flag) {
            ...
            blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[0]).move(blockmodelrenderer$neighborinfo.corners[2]);
         ...
         if (!flag3 && !flag) {
            ...
            blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[0]).move(blockmodelrenderer$neighborinfo.corners[3]);
         ...
         if (!flag2 && !flag1) {
            ...
            blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[1]).move(blockmodelrenderer$neighborinfo.corners[2]);
         ...
         if (!flag3 && !flag1) {
            ...
            blockpos$mutable.func_239622_a_(blockpos, blockmodelrenderer$neighborinfo.corners[1]).move(blockmodelrenderer$neighborinfo.corners[3]);
