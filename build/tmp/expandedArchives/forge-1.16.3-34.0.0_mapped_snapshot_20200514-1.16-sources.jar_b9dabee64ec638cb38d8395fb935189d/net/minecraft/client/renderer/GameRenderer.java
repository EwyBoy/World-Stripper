...
public class GameRenderer implements IResourceManagerReloadListener, AutoCloseable {
   ...
   private double getFOVModifier(ActiveRenderInfo activeRenderInfoIn, float partialTicks, boolean useFOVSetting) {
      if (this.debugView) {
         ...
         if (activeRenderInfoIn.getRenderViewEntity() instanceof LivingEntity && ((LivingEntity)activeRenderInfoIn.getRenderViewEntity()).func_233643_dh_()) {
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (renderWorldIn && this.mc.world != null) {
            ...
            if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null) {
               ...
               this.mc.ingameGUI.func_238445_a_(matrixstack, partialTicks);
               RenderSystem.clear(256, Minecraft.IS_RUNNING_ON_MAC);
            }
         ...
         if (this.mc.loadingGui != null) {
            try {
               this.mc.loadingGui.func_230430_a_(matrixstack, i, j, this.mc.getTickLength());
