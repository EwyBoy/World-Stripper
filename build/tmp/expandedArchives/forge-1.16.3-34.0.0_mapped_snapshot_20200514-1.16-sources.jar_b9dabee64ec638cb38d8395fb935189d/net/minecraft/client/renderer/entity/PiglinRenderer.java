...
public class PiglinRenderer extends BipedRenderer<MobEntity, PiglinModel<MobEntity>> {
   private static final Map<EntityType<?>, ResourceLocation> field_243503_a = ImmutableMap.of(EntityType.field_233591_ai_, new ResourceLocation("textures/entity/piglin/piglin.png"), EntityType.field_233592_ba_, new ResourceLocation("textures/entity/piglin/zombified_piglin.png"), EntityType.field_242287_aj, new ResourceLocation("textures/entity/piglin/piglin_brute.png"));
