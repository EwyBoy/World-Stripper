...
public class Atlases {
   ...
   public static void collectAllMaterials(Consumer<RenderMaterial> p_228775_0_) {
      ...
      for(BannerPattern bannerpattern : BannerPattern.values()) {
         p_228775_0_.accept(new RenderMaterial(BANNER_ATLAS, bannerpattern.func_226957_a_(true)));
         p_228775_0_.accept(new RenderMaterial(SHIELD_ATLAS, bannerpattern.func_226957_a_(false)));
      }
