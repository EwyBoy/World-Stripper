...
public class EntityRendererManager {
   ...
   private void registerRenderers(net.minecraft.client.renderer.ItemRenderer itemRendererIn, IReloadableResourceManager resourceManagerIn) {
      ...
      this.register(EntityType.field_233588_G_, new HoglinRenderer(this));
      ...
      this.register(EntityType.field_233591_ai_, new PiglinRenderer(this, false));
      ...
      this.register(EntityType.field_233590_aW_, new ZoglinRenderer(this));
      ...
      this.register(EntityType.field_233592_ba_, new PiglinRenderer(this, true));
      this.register(EntityType.ZOMBIE_VILLAGER, new ZombieVillagerRenderer(this, resourceManagerIn));
      this.register(EntityType.field_233589_aE_, new StriderRenderer(this));
   }
