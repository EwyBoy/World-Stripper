...
public class AdvancementToast implements IToast {
   ...
   public IToast.Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_) {
      ...
      p_230444_2_.func_238474_b_(p_230444_1_, 0, 0, 0, 0, this.func_230445_a_(), this.func_238540_d_());
      if (displayinfo != null) {
         ...
         p_230444_2_.getMinecraft().getItemRenderer().func_239390_c_(displayinfo.getIcon(), 8, 8);
