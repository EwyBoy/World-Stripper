...
public class WorldLoadProgressScreen extends Screen {
   ...
   public void func_230430_a_(MatrixStack p_230430_1_, int p_230430_2_, int p_230430_3_, float p_230430_4_) {
      ...
      int j = this.field_230708_k_ / 2;
      int k = this.field_230709_l_ / 2;
      int l = 30;
      func_238625_a_(p_230430_1_, this.tracker, j, k + 30, 2, 0);
      func_238471_a_(p_230430_1_, this.field_230712_o_, s, j, k - 9 / 2 - 30, 16777215);
   }
   ...
   public static void func_238625_a_(MatrixStack p_238625_0_, TrackingChunkStatusListener p_238625_1_, int p_238625_2_, int p_238625_3_, int p_238625_4_, int p_238625_5_) {
      ...
      int i2 = -16772609;
      if (p_238625_5_ != 0) {
         func_238467_a_(p_238625_0_, p_238625_2_ - l1, p_238625_3_ - l1, p_238625_2_ - l1 + 1, p_238625_3_ + l1, -16772609);
         func_238467_a_(p_238625_0_, p_238625_2_ + l1 - 1, p_238625_3_ - l1, p_238625_2_ + l1, p_238625_3_ + l1, -16772609);
         func_238467_a_(p_238625_0_, p_238625_2_ - l1, p_238625_3_ - l1, p_238625_2_ + l1, p_238625_3_ - l1 + 1, -16772609);
         func_238467_a_(p_238625_0_, p_238625_2_ - l1, p_238625_3_ + l1 - 1, p_238625_2_ + l1, p_238625_3_ + l1, -16772609);
      }
      ...
      for(int j2 = 0; j2 < l; ++j2) {
         for(int k2 = 0; k2 < l; ++k2) {
            ...
            int l2 = j1 + j2 * i;
            int i3 = k1 + k2 * i;
            func_238467_a_(p_238625_0_, l2, i3, l2 + p_238625_4_, i3 + p_238625_4_, COLORS.getInt(chunkstatus) | -16777216);
         }
      }
