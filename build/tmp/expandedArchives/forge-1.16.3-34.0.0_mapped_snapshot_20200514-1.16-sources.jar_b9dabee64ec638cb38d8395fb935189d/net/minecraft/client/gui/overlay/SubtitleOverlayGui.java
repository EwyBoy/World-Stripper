   ...
   public void render(MatrixStack p_195620_1_) {
      ...
      if (this.enabled && !this.subtitles.isEmpty()) {
         ...
         for(SubtitleOverlayGui.Subtitle subtitleoverlaygui$subtitle1 : this.subtitles) {
            ...
            func_238467_a_(p_195620_1_, -l - 1, -j1 - 1, l + 1, j1 + 1, this.client.gameSettings.getTextBackgroundColor(0.8F));
            RenderSystem.enableBlend();
            if (!flag) {
               if (d0 > 0.0D) {
                  this.client.fontRenderer.func_238421_b_(p_195620_1_, ">", (float)(l - this.client.fontRenderer.getStringWidth(">")), (float)(-j1), i2 + -16777216);
               } else if (d0 < 0.0D) {
                  this.client.fontRenderer.func_238421_b_(p_195620_1_, "<", (float)(-l), (float)(-j1), i2 + -16777216);
               }
            }
