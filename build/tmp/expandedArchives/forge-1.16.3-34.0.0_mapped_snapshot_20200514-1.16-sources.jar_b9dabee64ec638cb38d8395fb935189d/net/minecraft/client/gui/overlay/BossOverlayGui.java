...
public class BossOverlayGui extends AbstractGui {
      ...
      if (!this.mapBossInfos.isEmpty()) {
         ...
         for(ClientBossInfo clientbossinfo : this.mapBossInfos.values()) {
            ...
            net.minecraftforge.client.event.RenderGameOverlayEvent.BossInfo event =
               net.minecraftforge.client.ForgeHooksClient.bossBarRenderPre(p_238484_1_, this.client.getMainWindow(), clientbossinfo, k, j, 10 + this.client.fontRenderer.FONT_HEIGHT);
            if (!event.isCanceled()) {
            ...
            net.minecraftforge.client.ForgeHooksClient.bossBarRenderPost(p_238484_1_, this.client.getMainWindow());
   ...
   private void func_238485_a_(MatrixStack p_238485_1_, int p_238485_2_, int p_238485_3_, BossInfo p_238485_4_) {
      this.func_238474_b_(p_238485_1_, p_238485_2_, p_238485_3_, 0, p_238485_4_.getColor().ordinal() * 5 * 2, 182, 5);
      if (p_238485_4_.getOverlay() != BossInfo.Overlay.PROGRESS) {
         this.func_238474_b_(p_238485_1_, p_238485_2_, p_238485_3_, 0, 80 + (p_238485_4_.getOverlay().ordinal() - 1) * 5 * 2, 182, 5);
      }

      int i = (int)(p_238485_4_.getPercent() * 183.0F);
      if (i > 0) {
         this.func_238474_b_(p_238485_1_, p_238485_2_, p_238485_3_, 0, p_238485_4_.getColor().ordinal() * 5 * 2 + 5, i, 5);
         if (p_238485_4_.getOverlay() != BossInfo.Overlay.PROGRESS) {
            this.func_238474_b_(p_238485_1_, p_238485_2_, p_238485_3_, 0, 80 + (p_238485_4_.getOverlay().ordinal() - 1) * 5 * 2 + 5, i, 5);
         }
      }
