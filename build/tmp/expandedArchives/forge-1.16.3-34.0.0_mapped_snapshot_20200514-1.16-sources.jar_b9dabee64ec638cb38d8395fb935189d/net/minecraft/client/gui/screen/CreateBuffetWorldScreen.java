...
public class CreateBuffetWorldScreen extends Screen {
   ...
   class BiomeList extends ExtendedList<CreateBuffetWorldScreen.BiomeList.BiomeEntry> {
      private BiomeList() {
         ...
         CreateBuffetWorldScreen.this.field_243278_p.func_239659_c_().stream().sorted(Comparator.comparing((p_238598_0_) -> {
            return p_238598_0_.getKey().func_240901_a_().toString();
         })).forEach((p_238597_1_) -> {
            this.func_230513_b_(new CreateBuffetWorldScreen.BiomeList.BiomeEntry(p_238597_1_.getValue()));
         });
      }
      ...
      public void func_241215_a_(@Nullable CreateBuffetWorldScreen.BiomeList.BiomeEntry p_241215_1_) {
         ...
         if (p_241215_1_ != null) {
            ...
            NarratorChatListener.INSTANCE.say((new TranslationTextComponent("narrator.select", CreateBuffetWorldScreen.this.field_243278_p.getKey(p_241215_1_.field_238599_b_))).getString());
         }
      ...
      class BiomeEntry extends ExtendedList.AbstractListEntry<CreateBuffetWorldScreen.BiomeList.BiomeEntry> {
         ...
         public void func_230432_a_(MatrixStack p_230432_1_, int p_230432_2_, int p_230432_3_, int p_230432_4_, int p_230432_5_, int p_230432_6_, int p_230432_7_, int p_230432_8_, boolean p_230432_9_, float p_230432_10_) {
            AbstractGui.func_238475_b_(p_230432_1_, CreateBuffetWorldScreen.this.field_230712_o_, this.field_243282_c, p_230432_4_ + 5, p_230432_3_ + 2, 16777215);
         }
