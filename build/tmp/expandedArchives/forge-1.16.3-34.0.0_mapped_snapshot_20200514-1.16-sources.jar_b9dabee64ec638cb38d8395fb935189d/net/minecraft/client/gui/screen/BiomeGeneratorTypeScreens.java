...
public abstract class BiomeGeneratorTypeScreens {
   ...
   private static final BiomeGeneratorTypeScreens field_239073_h_ = new BiomeGeneratorTypeScreens("single_biome_caves") {
      public DimensionGeneratorSettings func_241220_a_(DynamicRegistries.Impl p_241220_1_, long p_241220_2_, boolean p_241220_4_, boolean p_241220_5_) {
         Registry<Biome> registry = p_241220_1_.func_243612_b(Registry.field_239720_u_);
         Registry<DimensionType> registry1 = p_241220_1_.func_243612_b(Registry.field_239698_ad_);
   ...
   protected static final Map<Optional<BiomeGeneratorTypeScreens>, BiomeGeneratorTypeScreens.IFactory> field_239069_d_ = ImmutableMap.of(Optional.of(field_239070_e_), (p_239089_0_, p_239089_1_) -> {
      ...
      return new CreateFlatWorldScreen(p_239089_0_, (p_239083_2_) -> {
         p_239089_0_.field_238934_c_.func_239043_a_(new DimensionGeneratorSettings(p_239089_1_.func_236221_b_(), p_239089_1_.func_236222_c_(), p_239089_1_.func_236223_d_(), DimensionGeneratorSettings.func_242749_a(p_239089_0_.field_238934_c_.func_239055_b_().func_243612_b(Registry.field_239698_ad_), p_239089_1_.func_236224_e_(), new FlatChunkGenerator(p_239083_2_))));
      }, chunkgenerator instanceof FlatChunkGenerator ? ((FlatChunkGenerator)chunkgenerator).func_236073_g_() : FlatGenerationSettings.func_242869_a(p_239089_0_.field_238934_c_.func_239055_b_().func_243612_b(Registry.field_239720_u_)));
   ...
   private static DimensionGeneratorSettings func_243452_a(DynamicRegistries p_243452_0_, DimensionGeneratorSettings p_243452_1_, BiomeGeneratorTypeScreens p_243452_2_, Biome p_243452_3_) {
      ...
      Registry<DimensionType> registry = p_243452_0_.func_243612_b(Registry.field_239698_ad_);
      ...
      return new DimensionGeneratorSettings(p_243452_1_.func_236221_b_(), p_243452_1_.func_236222_c_(), p_243452_1_.func_236223_d_(), DimensionGeneratorSettings.func_242749_a(registry, p_243452_1_.func_236224_e_(), new NoiseChunkGenerator(biomeprovider, p_243452_1_.func_236221_b_(), supplier)));
   }

   private static Biome func_243451_a(DynamicRegistries p_243451_0_, DimensionGeneratorSettings p_243451_1_) {
      return p_243451_1_.func_236225_f_().getBiomeProvider().func_235203_c_().stream().findFirst().orElse(p_243451_0_.func_243612_b(Registry.field_239720_u_).func_243576_d(Biomes.PLAINS));
   }
