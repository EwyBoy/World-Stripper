...
public class NarratorChatListener implements IChatListener {
   ...
   public void say(ChatType chatTypeIn, ITextComponent message, UUID p_192576_3_) {
      if (!Minecraft.getInstance().func_238198_a_(p_192576_3_)) {
   ...
   public void announceMode(NarratorStatus p_216865_1_) {
      this.clear();
      this.narrator.say((new TranslationTextComponent("options.narrator")).func_240702_b_(" : ").func_230529_a_(p_216865_1_.func_238233_b_()).getString(), true);
      ...
      if (this.narrator.active()) {
         if (p_216865_1_ == NarratorStatus.OFF) {
            ...
            SystemToast.addOrUpdate(toastgui, SystemToast.Type.NARRATOR_TOGGLE, new TranslationTextComponent("narrator.toast.enabled"), p_216865_1_.func_238233_b_());
         }
      } else {
