...
public class TeleportToTeam implements ISpectatorMenuView, ISpectatorMenuObject {
   ...
   public void func_230485_a_(MatrixStack p_230485_1_, float p_230485_2_, int p_230485_3_) {
      ...
      AbstractGui.func_238463_a_(p_230485_1_, 0, 0, 16.0F, 0.0F, 16, 16, 256, 256);
   }
   ...
   class TeamSelectionObject implements ISpectatorMenuObject {
      ...
      public void func_230485_a_(MatrixStack p_230485_1_, float p_230485_2_, int p_230485_3_) {
         ...
         if (integer != null) {
            ...
            AbstractGui.func_238467_a_(p_230485_1_, 1, 1, 15, 15, MathHelper.rgb(f * p_230485_2_, f1 * p_230485_2_, f2 * p_230485_2_) | p_230485_3_ << 24);
         }
         ...
         AbstractGui.func_238466_a_(p_230485_1_, 2, 2, 12, 12, 8.0F, 8.0F, 8, 8, 64, 64);
         AbstractGui.func_238466_a_(p_230485_1_, 2, 2, 12, 12, 40.0F, 8.0F, 8, 8, 64, 64);
      }
