...
public class ResourcePackList extends ExtendedList<ResourcePackList.ResourcePackEntry> {
   ...
   protected void func_230448_a_(MatrixStack p_230448_1_, int p_230448_2_, int p_230448_3_, Tessellator p_230448_4_) {
      ...
      this.field_230668_b_.fontRenderer.func_243248_b(p_230448_1_, itextcomponent, (float)(p_230448_2_ + this.field_230670_d_ / 2 - this.field_230668_b_.fontRenderer.func_238414_a_(itextcomponent) / 2), (float)Math.min(this.field_230672_i_ + 3, p_230448_3_), 16777215);
   }
