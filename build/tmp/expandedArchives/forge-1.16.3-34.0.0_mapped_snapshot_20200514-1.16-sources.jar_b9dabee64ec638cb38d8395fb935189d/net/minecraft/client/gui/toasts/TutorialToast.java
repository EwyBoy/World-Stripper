...
public class TutorialToast implements IToast {
   ...
   public IToast.Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_) {
      ...
      p_230444_2_.func_238474_b_(p_230444_1_, 0, 0, 0, 96, this.func_230445_a_(), this.func_238540_d_());
      ...
      if (this.hasProgressBar) {
         AbstractGui.func_238467_a_(p_230444_1_, 3, 28, 157, 29, -1);
         ...
         AbstractGui.func_238467_a_(p_230444_1_, 3, 28, (int)(3.0F + 154.0F * f), 29, i);
   ...
   public static enum Icons {
      ...
      public void func_238543_a_(MatrixStack p_238543_1_, AbstractGui p_238543_2_, int p_238543_3_, int p_238543_4_) {
         ...
         p_238543_2_.func_238474_b_(p_238543_1_, p_238543_3_, p_238543_4_, 176 + this.column * 20, this.row * 20, 20, 20);
         RenderSystem.enableBlend();
      }
   }
}