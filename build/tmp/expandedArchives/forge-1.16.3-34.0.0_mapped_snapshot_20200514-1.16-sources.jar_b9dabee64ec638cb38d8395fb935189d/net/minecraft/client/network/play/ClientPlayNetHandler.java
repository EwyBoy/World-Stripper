...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
   ...
   public void handleEntityTeleport(SEntityTeleportPacket packetIn) {
      ...
      if (entity != null) {
         ...
         if (!entity.canPassengerSteer()) {
            ...
            entity.func_230245_c_(packetIn.isOnGround());
         }
   ...
   public void handleEntityMovement(SEntityPacket packetIn) {
      ...
      if (entity != null) {
         if (!entity.canPassengerSteer()) {
            ...
            entity.func_230245_c_(packetIn.getOnGround());
         }
   ...
   public void handleChunkData(SChunkDataPacket packetIn) {
      ...
      BiomeContainer biomecontainer = packetIn.func_244296_i() == null ? null : new BiomeContainer(this.field_239163_t_.func_243612_b(Registry.field_239720_u_), packetIn.func_244296_i());
   ...
   public void handleChat(SChatPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      net.minecraft.util.text.ITextComponent message = net.minecraftforge.event.ForgeEventFactory.onClientChat(packetIn.getType(), packetIn.getChatComponent(), packetIn.func_240810_e_());
   ...
   public void handleSpawnMob(SSpawnMobPacket packetIn) {
      ...
      if (livingentity != null) {
         ...
         if (livingentity instanceof BeeEntity) {
            ...
            this.client.getSoundHandler().func_229364_a_(beesound);
         }
      } else {
   ...
   public void handleRespawn(SRespawnPacket packetIn) {
      ...
      if (registrykey != clientplayerentity.world.func_234923_W_()) {
   ...
   public void handleUpdateTileEntity(SUpdateTileEntityPacket packetIn) {
      ...
      if (i == 1 && tileentity instanceof MobSpawnerTileEntity || flag || i == 3 && tileentity instanceof BeaconTileEntity || i == 4 && tileentity instanceof SkullTileEntity || i == 6 && tileentity instanceof BannerTileEntity || i == 7 && tileentity instanceof StructureBlockTileEntity || i == 8 && tileentity instanceof EndGatewayTileEntity || i == 9 && tileentity instanceof SignTileEntity || i == 11 && tileentity instanceof BedTileEntity || i == 5 && tileentity instanceof ConduitTileEntity || i == 12 && tileentity instanceof JigsawTileEntity || i == 13 && tileentity instanceof CampfireTileEntity || i == 14 && tileentity instanceof BeehiveTileEntity) {
         tileentity.func_230337_a_(this.client.world.getBlockState(blockpos), packetIn.getNbtCompound());
      }
   ...
   public void handleServerDifficulty(SServerDifficultyPacket packetIn) {
      PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
      this.field_239161_g_.func_239156_a_(packetIn.getDifficulty());
      this.field_239161_g_.func_239157_a_(packetIn.isDifficultyLocked());
   }
   ...
   public void handleTitle(STitlePacket packetIn) {
      ...
      ITextComponent itextcomponent2 = packetIn.getMessage() != null ? packetIn.getMessage() : StringTextComponent.field_240750_d_;
         ...
         if (s.startsWith("level://")) {
            try {
               ...
               if (file2.isFile()) {
                  ...
                  CompletableFuture<?> completablefuture = this.client.getPackFinder().setServerPack(file2, IPackNameDecorator.field_232627_c_);
   ...
   public void handleEntityProperties(SEntityPropertiesPacket packetIn) {
      ...
      if (entity != null) {
         if (!(entity instanceof LivingEntity)) {
            ...
            AttributeModifierManager attributemodifiermanager = ((LivingEntity)entity).func_233645_dx_();

            for(SEntityPropertiesPacket.Snapshot sentitypropertiespacket$snapshot : packetIn.getSnapshots()) {
               ModifiableAttributeInstance modifiableattributeinstance = attributemodifiermanager.func_233779_a_(sentitypropertiespacket$snapshot.func_240834_a_());
               if (modifiableattributeinstance == null) {
                  LOGGER.warn("Entity {} does not have attribute {}", entity, Registry.field_239692_aP_.getKey(sentitypropertiespacket$snapshot.func_240834_a_()));
               } else {
