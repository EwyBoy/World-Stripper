   ...
   public CompletableFuture<?> downloadResourcePack(String url, String hash) {
      ...
      try {
         ...
         this.currentDownload = completablefuture.thenCompose((p_217812_3_) -> {
            return !this.checkHash(s1, file1) ? Util.completedExceptionallyFuture(new RuntimeException("Hash check failure for file " + file1 + ", see log")) : this.setServerPack(file1, IPackNameDecorator.field_232628_d_);
