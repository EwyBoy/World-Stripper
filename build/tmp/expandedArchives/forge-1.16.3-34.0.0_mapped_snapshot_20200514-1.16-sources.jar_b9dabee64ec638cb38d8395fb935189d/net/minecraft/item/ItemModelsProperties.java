...
public class ItemModelsProperties {
   ...
   public static void func_239418_a_(Item p_239418_0_, ResourceLocation p_239418_1_, IItemPropertyGetter p_239418_2_) {
   ...
   static {
      ...
      func_239418_a_(Items.CLOCK, new ResourceLocation("time"), new IItemPropertyGetter() {
         ...
         public float call(ItemStack p_call_1_, @Nullable ClientWorld p_call_2_, @Nullable LivingEntity p_call_3_) {
            Entity entity = (Entity)(p_call_3_ != null ? p_call_3_ : p_call_1_.func_234694_A_());
            if (entity == null) {
               return 0.0F;
            } else {
