   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
      ...
      if (raytraceresult.getType() == RayTraceResult.Type.BLOCK && worldIn.getBlockState(((BlockRayTraceResult)raytraceresult).getPos()).isIn(Blocks.END_PORTAL_FRAME)) {
         ...
         if (worldIn instanceof ServerWorld) {
            BlockPos blockpos = ((ServerWorld)worldIn).getChunkProvider().getChunkGenerator().func_235956_a_((ServerWorld)worldIn, Structure.field_236375_k_, playerIn.func_233580_cy_(), 100, false);
            if (blockpos != null) {
               ...
               worldIn.playEvent((PlayerEntity)null, 1003, playerIn.func_233580_cy_(), 0);
