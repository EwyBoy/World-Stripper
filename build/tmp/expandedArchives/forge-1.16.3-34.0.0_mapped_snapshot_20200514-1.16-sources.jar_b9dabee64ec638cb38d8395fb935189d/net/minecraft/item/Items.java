...
public class Items {
   ...
   public static final Item field_234767_m_ = register(Blocks.field_235381_mu_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234768_n_ = register(Blocks.field_235372_ml_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234798_v_ = register(Blocks.field_235344_mC_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234799_w_ = register(Blocks.field_235345_mD_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234708_K_ = register(Blocks.field_235334_I_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234709_R_ = register(Blocks.field_235377_mq_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234710_S_ = register(Blocks.field_235368_mh_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234711_Z_ = register(Blocks.field_235378_mr_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234712_aa_ = register(Blocks.field_235369_mi_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234713_ah_ = register(Blocks.field_235380_mt_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234714_ai_ = register(Blocks.field_235371_mk_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234715_ap_ = register(Blocks.field_235379_ms_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234716_aq_ = register(Blocks.field_235370_mj_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234722_bw_ = register(Blocks.field_235382_mv_, ItemGroup.DECORATIONS);
   public static final Item field_234723_bx_ = register(Blocks.field_235373_mm_, ItemGroup.DECORATIONS);
   public static final Item field_234724_by_ = register(Blocks.field_235343_mB_, ItemGroup.DECORATIONS);
   public static final Item field_234725_bz_ = register(Blocks.field_235375_mo_, ItemGroup.DECORATIONS);
   public static final Item field_234717_bA_ = register(Blocks.field_235376_mp_, ItemGroup.DECORATIONS);
   public static final Item field_234718_bB_ = register(Blocks.field_235384_mx_, ItemGroup.DECORATIONS);
   public static final Item field_234719_bC_ = register(Blocks.field_235386_mz_, ItemGroup.DECORATIONS);
   ...
   public static final Item field_234720_bO_ = register(Blocks.field_235346_mE_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234721_bP_ = register(Blocks.field_235347_mF_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234726_cP_ = register(Blocks.field_235348_mG_, ItemGroup.REDSTONE);
   public static final Item field_234727_cQ_ = register(Blocks.field_235349_mH_, ItemGroup.REDSTONE);
   public static final Item field_234728_cR_ = register(Blocks.field_235390_nD_, ItemGroup.REDSTONE);
   ...
   public static final Item field_234732_dg_ = register(Blocks.field_235350_mI_, ItemGroup.DECORATIONS);
   public static final Item field_234733_dh_ = register(Blocks.field_235351_mJ_, ItemGroup.DECORATIONS);
   ...
   public static final Item field_234734_dm_ = register(Blocks.field_235336_cN_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234735_dn_ = register(Blocks.field_235337_cO_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234736_do_ = register(Blocks.field_235338_cP_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234737_dp_ = register(new WallOrFloorItem(Blocks.field_235339_cQ_, Blocks.field_235340_cR_, (new Item.Properties()).group(ItemGroup.DECORATIONS)));
   ...
   public static final Item field_234738_dy_ = register(Blocks.field_235352_mK_, ItemGroup.REDSTONE);
   public static final Item field_234739_dz_ = register(Blocks.field_235353_mL_, ItemGroup.REDSTONE);
   ...
   public static final Item field_234729_dO_ = register(Blocks.field_235341_dI_, ItemGroup.DECORATIONS);
   ...
   public static final Item field_234730_dY_ = register(Blocks.field_235354_mM_, ItemGroup.REDSTONE);
   public static final Item field_234731_dZ_ = register(Blocks.field_235355_mN_, ItemGroup.REDSTONE);
   ...
   public static final Item field_234744_ef_ = register(Blocks.field_235394_nH_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234745_eg_ = register(Blocks.field_235393_nG_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234746_ex_ = register(Blocks.field_235356_mO_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234747_ey_ = register(Blocks.field_235357_mP_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234740_eP_ = register(Blocks.field_235408_nr_, ItemGroup.DECORATIONS);
   public static final Item field_234741_eQ_ = register(Blocks.field_235392_nF_, ItemGroup.DECORATIONS);
   public static final Item field_234742_eR_ = register(Blocks.field_235416_nz_, ItemGroup.DECORATIONS);
   ...
   public static final Item field_234743_eZ_ = register(Blocks.field_235358_mQ_, ItemGroup.REDSTONE);
   public static final Item field_234748_fa_ = register(Blocks.field_235359_mR_, ItemGroup.REDSTONE);
   public static final Item field_234749_fb_ = register(Blocks.field_235391_nE_, ItemGroup.REDSTONE);
   ...
   public static final Item field_234750_fo_ = register(Blocks.field_235395_nI_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234751_hk_ = register(Blocks.field_235374_mn_, ItemGroup.BUILDING_BLOCKS);
   ...
   public static final Item field_234752_jS_ = register(new TallBlockItem(Blocks.field_235360_mS_, (new Item.Properties()).group(ItemGroup.REDSTONE)));
   public static final Item field_234753_jT_ = register(new TallBlockItem(Blocks.field_235361_mT_, (new Item.Properties()).group(ItemGroup.REDSTONE)));
   ...
   public static final Item field_234759_km_ = register("netherite_ingot", new Item((new Item.Properties()).group(ItemGroup.MATERIALS).func_234689_a_()));
   public static final Item field_234760_kn_ = register("netherite_scrap", new Item((new Item.Properties()).group(ItemGroup.MATERIALS).func_234689_a_()));
   ...
   public static final Item field_234754_kI_ = register("netherite_sword", new SwordItem(ItemTier.NETHERITE, 3, -2.4F, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   public static final Item field_234755_kJ_ = register("netherite_shovel", new ShovelItem(ItemTier.NETHERITE, 1.5F, -3.0F, (new Item.Properties()).group(ItemGroup.TOOLS).func_234689_a_()));
   public static final Item field_234756_kK_ = register("netherite_pickaxe", new PickaxeItem(ItemTier.NETHERITE, 1, -2.8F, (new Item.Properties()).group(ItemGroup.TOOLS).func_234689_a_()));
   public static final Item field_234757_kL_ = register("netherite_axe", new AxeItem(ItemTier.NETHERITE, 5.0F, -3.0F, (new Item.Properties()).group(ItemGroup.TOOLS).func_234689_a_()));
   public static final Item field_234758_kU_ = register("netherite_hoe", new HoeItem(ItemTier.NETHERITE, -4, 0.0F, (new Item.Properties()).group(ItemGroup.TOOLS).func_234689_a_()));
   ...
   public static final Item field_234763_ls_ = register("netherite_helmet", new ArmorItem(ArmorMaterial.NETHERITE, EquipmentSlotType.HEAD, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   public static final Item field_234764_lt_ = register("netherite_chestplate", new ArmorItem(ArmorMaterial.NETHERITE, EquipmentSlotType.CHEST, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   public static final Item field_234765_lu_ = register("netherite_leggings", new ArmorItem(ArmorMaterial.NETHERITE, EquipmentSlotType.LEGS, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   public static final Item field_234766_lv_ = register("netherite_boots", new ArmorItem(ArmorMaterial.NETHERITE, EquipmentSlotType.FEET, (new Item.Properties()).group(ItemGroup.COMBAT).func_234689_a_()));
   ...
   public static final Item field_234761_lI_ = register("crimson_sign", new SignItem((new Item.Properties()).maxStackSize(16).group(ItemGroup.DECORATIONS), Blocks.field_235362_mU_, Blocks.field_235364_mW_));
   public static final Item field_234762_lJ_ = register("warped_sign", new SignItem((new Item.Properties()).maxStackSize(16).group(ItemGroup.DECORATIONS), Blocks.field_235363_mV_, Blocks.field_235365_mX_));
   ...
   public static final Item field_234769_nY_ = register("hoglin_spawn_egg", new SpawnEggItem(EntityType.field_233588_G_, 13004373, 6251620, (new Item.Properties()).group(ItemGroup.MISC)));
   ...
   public static final Item field_234773_ok_ = register("piglin_spawn_egg", new SpawnEggItem(EntityType.field_233591_ai_, 10051392, 16380836, (new Item.Properties()).group(ItemGroup.MISC)));
   ...
   public static final Item field_234770_oA_ = register("strider_spawn_egg", new SpawnEggItem(EntityType.field_233589_aE_, 10236982, 5065037, (new Item.Properties()).group(ItemGroup.MISC)));
   ...
   public static final Item field_234771_oL_ = register("zoglin_spawn_egg", new SpawnEggItem(EntityType.field_233590_aW_, 13004373, 15132390, (new Item.Properties()).group(ItemGroup.MISC)));
   ...
   public static final Item field_234772_oO_ = register("zombified_piglin_spawn_egg", new SpawnEggItem(EntityType.field_233592_ba_, 15373203, 5009705, (new Item.Properties()).group(ItemGroup.MISC)));
   ...
   public static final Item field_234774_pk_ = register("warped_fungus_on_a_stick", new OnAStickItem<>((new Item.Properties()).maxDamage(100).group(ItemGroup.TRANSPORTATION), EntityType.field_233589_aE_, 1));
   ...
   public static final Item field_234775_qK_ = register("music_disc_pigstep", new MusicDiscItem(13, SoundEvents.field_232758_if_, (new Item.Properties()).maxStackSize(1).group(ItemGroup.MISC).rarity(Rarity.RARE)));
   ...
   public static final Item field_234776_qX_ = register("piglin_banner_pattern", new BannerPatternItem(BannerPattern.PIGLIN, (new Item.Properties()).maxStackSize(1).group(ItemGroup.MISC)));
   ...
   public static final Item field_234790_rk_ = register(Blocks.field_235366_md_, ItemGroup.DECORATIONS);
   ...
   public static final Item field_234791_rn_ = register(Blocks.field_235367_mf_, ItemGroup.DECORATIONS);
   public static final Item field_234792_ro_ = register(Blocks.field_235383_mw_, ItemGroup.DECORATIONS);
   ...
   public static final Item field_234793_rv_ = register(Blocks.field_235405_no_, ItemGroup.DECORATIONS);
   public static final Item field_234794_rw_ = register(new BlockItem(Blocks.field_235397_ng_, (new Item.Properties()).group(ItemGroup.BUILDING_BLOCKS).func_234689_a_()));
   public static final Item field_234795_rx_ = register(new BlockItem(Blocks.field_235398_nh_, (new Item.Properties()).group(ItemGroup.BUILDING_BLOCKS).func_234689_a_()));
   public static final Item field_234796_ry_ = register(Blocks.field_235396_nb_, ItemGroup.REDSTONE);
   public static final Item field_234797_rz_ = register(Blocks.field_235399_ni_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234777_rA_ = register(Blocks.field_235406_np_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234778_rB_ = register(Blocks.field_235409_ns_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234779_rC_ = register(Blocks.field_235407_nq_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234780_rD_ = register(Blocks.field_235387_nA_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234781_rE_ = register(Blocks.field_235410_nt_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234782_rF_ = register(Blocks.field_235389_nC_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234783_rG_ = register(Blocks.field_235388_nB_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234784_rH_ = register(Blocks.field_235413_nw_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234785_rI_ = register(Blocks.field_235411_nu_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234786_rJ_ = register(Blocks.field_235414_nx_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234787_rK_ = register(Blocks.field_235415_ny_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234788_rL_ = register(Blocks.field_235412_nv_, ItemGroup.BUILDING_BLOCKS);
   public static final Item field_234789_rM_ = register(Blocks.field_235400_nj_, ItemGroup.DECORATIONS);
