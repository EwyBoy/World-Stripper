...
public class WrittenBookItem extends Item {
   ...
   public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
      if (stack.hasTag()) {
         ...
         if (!StringUtils.isNullOrEmpty(s)) {
            tooltip.add((new TranslationTextComponent("book.byAuthor", s)).func_240699_a_(TextFormatting.GRAY));
         }

         tooltip.add((new TranslationTextComponent("book.generation." + compoundnbt.getInt("generation"))).func_240699_a_(TextFormatting.GRAY));
      }
