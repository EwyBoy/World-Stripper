...
public class FireworkStarItem extends Item {
   ...
   public static void func_195967_a(CompoundNBT p_195967_0_, List<ITextComponent> p_195967_1_) {
      ...
      p_195967_1_.add((new TranslationTextComponent("item.minecraft.firework_star.shape." + fireworkrocketitem$shape.getShapeName())).func_240699_a_(TextFormatting.GRAY));
      int[] aint = p_195967_0_.getIntArray("Colors");
      if (aint.length > 0) {
         p_195967_1_.add(func_200298_a_((new StringTextComponent("")).func_240699_a_(TextFormatting.GRAY), aint));
      }

      int[] aint1 = p_195967_0_.getIntArray("FadeColors");
      if (aint1.length > 0) {
         p_195967_1_.add(func_200298_a_((new TranslationTextComponent("item.minecraft.firework_star.fade_to")).func_240702_b_(" ").func_240699_a_(TextFormatting.GRAY), aint1));
      }

      if (p_195967_0_.getBoolean("Trail")) {
         p_195967_1_.add((new TranslationTextComponent("item.minecraft.firework_star.trail")).func_240699_a_(TextFormatting.GRAY));
      }

      if (p_195967_0_.getBoolean("Flicker")) {
         p_195967_1_.add((new TranslationTextComponent("item.minecraft.firework_star.flicker")).func_240699_a_(TextFormatting.GRAY));
      }
   ...
   private static ITextComponent func_200298_a_(IFormattableTextComponent p_200298_0_, int[] p_200298_1_) {
      for(int i = 0; i < p_200298_1_.length; ++i) {
         if (i > 0) {
            p_200298_0_.func_240702_b_(", ");
         }

         p_200298_0_.func_230529_a_(func_200297_a(p_200298_1_[i]));
      }
