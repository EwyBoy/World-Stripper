...
public class CompassItem extends Item implements IVanishable {
   ...
   public ActionResultType onItemUse(ItemUseContext context) {
      ...
      if (!world.getBlockState(blockpos).isIn(Blocks.field_235405_no_)) {
         return super.onItemUse(context);
      } else {
         world.playSound((PlayerEntity)null, blockpos, SoundEvents.field_232731_hu_, SoundCategory.PLAYERS, 1.0F, 1.0F);
         PlayerEntity playerentity = context.getPlayer();
         ItemStack itemstack = context.getItem();
         boolean flag = !playerentity.abilities.isCreativeMode && itemstack.getCount() == 1;
         if (flag) {
            this.func_234669_a_(world.func_234923_W_(), blockpos, itemstack.getOrCreateTag());
         } else {
            ...
            this.func_234669_a_(world.func_234923_W_(), blockpos, compoundnbt);
