...
public class EnderDragonEntity extends MobEntity implements IMob {
   ...
   public static AttributeModifierMap.MutableAttribute func_234257_m_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.field_233818_a_, 200.0D);
   }
         ...
         for(int l1 = j; l1 <= i1; ++l1) {
            for(int i2 = k; i2 <= j1; ++i2) {
               ...
               if (!blockstate.isAir(this.world, blockpos) && blockstate.getMaterial() != Material.FIRE) {
                  if (net.minecraftforge.common.ForgeHooks.canEntityDestroy(this.world, blockpos, this) && !BlockTags.DRAGON_IMMUNE.func_230235_a_(block)) {
   ...
   protected void onDeathUpdate() {
      ...
      if (!this.world.isRemote) {
         ...
         if (this.deathTicks == 1 && !this.isSilent()) {
            this.world.playBroadcastSound(1028, this.func_233580_cy_(), 0);
         }
      }
