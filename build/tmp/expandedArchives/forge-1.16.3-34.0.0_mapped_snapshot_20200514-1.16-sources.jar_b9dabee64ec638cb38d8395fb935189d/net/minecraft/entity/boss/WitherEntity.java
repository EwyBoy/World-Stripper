...
public class WitherEntity extends MonsterEntity implements IChargeableMob, IRangedAttackMob {
   ...
   protected void updateAITasks() {
      if (this.getInvulTime() > 0) {
         ...
         if (j1 <= 0) {
            ...
            if (!this.isSilent()) {
               this.world.playBroadcastSound(1023, this.func_233580_cy_(), 0);
            }
         }
         ...
         if (this.blockBreakCounter > 0) {
            ...
            if (this.blockBreakCounter == 0 && net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this)) {
               ...
               if (flag) {
                  this.world.playEvent((PlayerEntity)null, 1022, this.func_233580_cy_(), 0);
               }
            }
         }
   ...
   public static boolean canDestroyBlock(BlockState blockIn) {
      return !blockIn.isAir() && !BlockTags.WITHER_IMMUNE.func_230235_a_(blockIn.getBlock());
   }
   ...
   private void launchWitherSkullToCoords(int p_82209_1_, double x, double y, double z, boolean invulnerable) {
      if (!this.isSilent()) {
         this.world.playEvent((PlayerEntity)null, 1024, this.func_233580_cy_(), 0);
      }
   ...
   public static AttributeModifierMap.MutableAttribute func_234258_eI_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.field_233818_a_, 300.0D).func_233815_a_(Attributes.field_233821_d_, (double)0.6F).func_233815_a_(Attributes.field_233819_b_, 40.0D).func_233815_a_(Attributes.field_233826_i_, 4.0D);
   }
