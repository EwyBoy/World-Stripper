...
public class EntitySpawnPlacementRegistry {
   ...
   public static <T extends Entity> boolean func_223515_a(EntityType<T> p_223515_0_, IServerWorld p_223515_1_, SpawnReason reason, BlockPos p_223515_3_, Random p_223515_4_) {
   ...
   static {
      ...
      register(EntityType.field_233588_G_, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, HoglinEntity::func_234361_c_);
      register(EntityType.field_233591_ai_, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, PiglinEntity::func_234418_b_);
      ...
      register(EntityType.field_233589_aE_, EntitySpawnPlacementRegistry.PlacementType.IN_LAVA, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, StriderEntity::func_234314_c_);
      ...
      register(EntityType.field_233592_ba_, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ZombifiedPiglinEntity::func_234351_b_);
