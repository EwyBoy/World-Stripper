...
public class LightningBoltEntity extends Entity {
   ...
   public void func_233623_a_(boolean p_233623_1_) {
      this.effectOnly = p_233623_1_;
   }
   ...
   private void igniteBlocks(int extraIgnitions) {
      if (!this.effectOnly && !this.world.isRemote && this.world.getGameRules().getBoolean(GameRules.DO_FIRE_TICK)) {
         ...
         BlockState blockstate = AbstractFireBlock.func_235326_a_(this.world, blockpos);
         ...
         for(int i = 0; i < extraIgnitions; ++i) {
            ...
            blockstate = AbstractFireBlock.func_235326_a_(this.world, blockpos1);
