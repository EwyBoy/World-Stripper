...
public class TNTMinecartEntity extends AbstractMinecartEntity {
   ...
   public float getExplosionResistance(Explosion explosionIn, IBlockReader worldIn, BlockPos pos, BlockState blockStateIn, FluidState p_180428_5_, float p_180428_6_) {
      return !this.isIgnited() || !blockStateIn.func_235714_a_(BlockTags.RAILS) && !worldIn.getBlockState(pos.up()).func_235714_a_(BlockTags.RAILS) ? super.getExplosionResistance(explosionIn, worldIn, pos, blockStateIn, p_180428_5_, p_180428_6_) : 0.0F;
   }
   ...
   public boolean canExplosionDestroyBlock(Explosion explosionIn, IBlockReader worldIn, BlockPos pos, BlockState blockStateIn, float p_174816_5_) {
      return !this.isIgnited() || !blockStateIn.func_235714_a_(BlockTags.RAILS) && !worldIn.getBlockState(pos.up()).func_235714_a_(BlockTags.RAILS) ? super.canExplosionDestroyBlock(explosionIn, worldIn, pos, blockStateIn, p_174816_5_) : false;
   }
