...
public class MooshroomEntity extends CowEntity implements IShearable, net.minecraftforge.common.IForgeShearable {
   ...
   public ActionResultType func_230254_b_(PlayerEntity p_230254_1_, Hand p_230254_2_) {
      ...
      if (itemstack.getItem() == Items.BOWL && !this.isChild()) {
         ...
         ItemStack itemstack2 = DrinkHelper.func_241445_a_(itemstack, p_230254_1_, itemstack1, false);
      ...
      } else if (false && itemstack.getItem() == Items.SHEARS && this.func_230262_K__()) { //Forge: Moved to onSheared
