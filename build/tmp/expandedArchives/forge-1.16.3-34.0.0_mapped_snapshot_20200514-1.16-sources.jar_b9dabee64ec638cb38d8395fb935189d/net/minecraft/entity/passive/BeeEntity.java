...
public class BeeEntity extends AnimalEntity implements IAngerable, IFlyingAnimal {
   ...
   public boolean attackEntityAsMob(Entity entityIn) {
      boolean flag = entityIn.attackEntityFrom(DamageSource.func_226252_a_(this), (float)((int)this.func_233637_b_(Attributes.field_233823_f_)));
      if (flag) {
   ...
   private void startMovingTo(BlockPos pos) {
      Vector3d vector3d = Vector3d.func_237492_c_(pos);
      int i = 0;
   ...
   public static AttributeModifierMap.MutableAttribute func_234182_eX_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.field_233818_a_, 10.0D).func_233815_a_(Attributes.field_233822_e_, (double)0.6F).func_233815_a_(Attributes.field_233821_d_, (double)0.3F).func_233815_a_(Attributes.field_233823_f_, 2.0D).func_233815_a_(Attributes.field_233819_b_, 48.0D);
   }
   ...
   private boolean isWithinDistance(BlockPos pos, int distance) {
      return pos.withinDistance(this.func_233580_cy_(), (double)distance);
   }
   ...
   public class FindBeehiveGoal extends BeeEntity.PassiveGoal {
      ...
      public boolean canBeeStart() {
         return BeeEntity.this.hivePos != null && !BeeEntity.this.detachHome() && BeeEntity.this.canEnterHive() && !this.isCloseEnough(BeeEntity.this.hivePos) && BeeEntity.this.world.getBlockState(BeeEntity.this.hivePos).func_235714_a_(BlockTags.BEEHIVES);
      }
   ...
   class FindPollinationTargetGoal extends BeeEntity.PassiveGoal {
      ...
      public void tick() {
         if (BeeEntity.this.rand.nextInt(30) == 0) {
            for(int i = 1; i <= 2; ++i) {
               BlockPos blockpos = BeeEntity.this.func_233580_cy_().down(i);
   ...
   class PollinateGoal extends BeeEntity.PassiveGoal {
      private final Predicate<BlockState> flowerPredicate = (p_226499_0_) -> {
         if (p_226499_0_.func_235714_a_(BlockTags.TALL_FLOWERS)) {
            ...
            return p_226499_0_.func_235714_a_(BlockTags.SMALL_FLOWERS);
         }
      };
      ...
      public void tick() {
         ...
         if (this.ticks > 600) {
            ...
            Vector3d vector3d = Vector3d.func_237492_c_(BeeEntity.this.savedFlowerPos).add(0.0D, (double)0.6F, 0.0D);
            ...
            for(int j = 0; (double)j < distance; ++j) {
               for(int k = 0; k <= j; k = k > 0 ? -k : 1 - k) {
                  for(int l = k < j && k > -j ? j : 0; l <= j; l = l > 0 ? -l : 1 - l) {
                     blockpos$mutable.func_239621_a_(blockpos, k, i - 1, l);
   ...
   class WanderGoal extends Goal {
      ...
      private Vector3d getRandomLocation() {
         ...
         if (BeeEntity.this.isHiveValid() && !BeeEntity.this.isWithinDistance(BeeEntity.this.hivePos, 22)) {
            Vector3d vector3d1 = Vector3d.func_237489_a_(BeeEntity.this.hivePos);
