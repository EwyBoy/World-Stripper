...
public class FoxEntity extends AnimalEntity {
   ...
   public ILivingEntityData onInitialSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      Optional<RegistryKey<Biome>> optional = worldIn.func_242406_i(this.func_233580_cy_());
   ...
   class MateGoal extends BreedGoal {
      ...
      protected void spawnBaby() {
         ...
         final net.minecraftforge.event.entity.living.BabyEntitySpawnEvent event = new net.minecraftforge.event.entity.living.BabyEntitySpawnEvent(animal, targetMate, foxentity);
   ...
   public class PounceGoal extends net.minecraft.entity.ai.goal.JumpGoal {
      ...
      public void tick() {
         ...
         } else if (FoxEntity.this.rotationPitch > 0.0F && FoxEntity.this.onGround && (float)FoxEntity.this.getMotion().y != 0.0F && FoxEntity.this.world.getBlockState(FoxEntity.this.func_233580_cy_()).isIn(Blocks.SNOW)) {
