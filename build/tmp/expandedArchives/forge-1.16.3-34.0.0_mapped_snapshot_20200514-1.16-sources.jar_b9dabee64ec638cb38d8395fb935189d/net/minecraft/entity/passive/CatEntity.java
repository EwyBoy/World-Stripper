...
public class CatEntity extends TameableEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234184_eY_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.field_233818_a_, 10.0D).func_233815_a_(Attributes.field_233821_d_, (double)0.3F).func_233815_a_(Attributes.field_233823_f_, 3.0D);
   }
   ...
   public ILivingEntityData onInitialSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      ...
      if (world instanceof ServerWorld && ((ServerWorld)world).func_241112_a_().func_235010_a_(this.func_233580_cy_(), true, Structure.field_236374_j_).isValid()) {
         this.setCatType(10);
   ...
   static class MorningGiftGoal extends Goal {
      ...
      private void func_220804_h() {
         ...
         blockpos$mutable.setPos(this.cat.func_233580_cy_());
