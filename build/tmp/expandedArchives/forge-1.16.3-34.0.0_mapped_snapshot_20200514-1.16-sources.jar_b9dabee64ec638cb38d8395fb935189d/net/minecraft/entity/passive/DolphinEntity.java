...
public class DolphinEntity extends WaterMobEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234190_eK_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.field_233818_a_, 10.0D).func_233815_a_(Attributes.field_233821_d_, (double)1.2F).func_233815_a_(Attributes.field_233823_f_, 3.0D);
   }
      ...
      public void tick() {
         ...
         if (this.action == MovementController.Action.MOVE_TO && !this.dolphin.getNavigator().noPath()) {
            ...
            if (d3 < (double)2.5000003E-7F) {
               ...
               float f1 = (float)(this.speed * this.dolphin.func_233637_b_(Attributes.field_233821_d_));
               if (this.dolphin.isInWater()) {
   ...
   static class SwimToTreasureGoal extends Goal {
      ...
      public void tick() {
         ...
         if (this.dolphin.closeToTarget() || this.dolphin.getNavigator().noPath()) {
            Vector3d vector3d = Vector3d.func_237489_a_(this.dolphin.getTreasurePos());
