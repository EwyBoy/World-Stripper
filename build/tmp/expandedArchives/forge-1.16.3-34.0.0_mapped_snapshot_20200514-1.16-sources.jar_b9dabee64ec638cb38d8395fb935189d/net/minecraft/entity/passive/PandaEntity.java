...
public class PandaEntity extends AnimalEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234204_eW_() {
      return MobEntity.func_233666_p_().func_233815_a_(Attributes.field_233821_d_, (double)0.15F).func_233815_a_(Attributes.field_233823_f_, 6.0D);
   }
   ...
   public void setAttributes() {
      ...
      if (this.isLazy()) {
         this.getAttribute(Attributes.field_233821_d_).setBaseValue((double)0.07F);
      }
   ...
   class MateGoal extends BreedGoal {
      ...
      private boolean func_220691_h() {
         BlockPos blockpos = this.panda.func_233580_cy_();
            ...
            for(int j = 0; j < 8; ++j) {
               for(int k = 0; k <= j; k = k > 0 ? -k : 1 - k) {
                  for(int l = k < j && k > -j ? j : 0; l <= j; l = l > 0 ? -l : 1 - l) {
                     blockpos$mutable.func_239621_a_(blockpos, k, i, l);
      ...
      public boolean shouldExecute() {
         if ((this.panda.isChild() || this.panda.isPlayful()) && this.panda.onGround) {
            if (!this.panda.canPerformAction()) {
               ...
               if (this.panda.world.getBlockState(this.panda.func_233580_cy_().add(i, -1, j)).isAir()) {
                  return true;
