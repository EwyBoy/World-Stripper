...
public abstract class MobEntity extends LivingEntity {
   ...
   public void checkDespawn() {
      if (this.world.getDifficulty() == Difficulty.PEACEFUL && this.isDespawnPeaceful()) {
         ...
         if (entity != null) {
            ...
            int i = this.getType().getClassification().func_233671_f_();
            int j = i * i;
            if (d0 > (double)j && this.canDespawn(d0)) {
               this.remove();
            }

            int k = this.getType().getClassification().func_233672_g_();
            int l = k * k;
   ...
   public ILivingEntityData onInitialSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      this.getAttribute(Attributes.field_233819_b_).func_233769_c_(new AttributeModifier("Random spawn bonus", this.rand.nextGaussian() * 0.05D, AttributeModifier.Operation.MULTIPLY_BASE));
   ...
   private ActionResultType func_233661_c_(PlayerEntity p_233661_1_, Hand p_233661_2_) {
      ...
      if (itemstack.getItem() == Items.LEAD && this.canBeLeashedTo(p_233661_1_)) {
         ...
         if (itemstack.getItem() == Items.NAME_TAG) {
            ActionResultType actionresulttype = itemstack.func_111282_a_(p_233661_1_, this, p_233661_2_);
            if (actionresulttype.isSuccessOrConsume()) {
               return actionresulttype;
            }
         }
         ...
         if (itemstack.getItem() instanceof SpawnEggItem) {
            if (this.world instanceof ServerWorld) {
               ...
               Optional<MobEntity> optional = spawneggitem.func_234809_a_(p_233661_1_, this, (EntityType)this.getType(), (ServerWorld)this.world, this.getPositionVec(), itemstack);
   ...
   public boolean isWithinHomeDistanceCurrentPosition() {
      return this.isWithinHomeDistanceFromPosition(this.func_233580_cy_());
   }
   ...
   public boolean attackEntityAsMob(Entity entityIn) {
      ...
      if (flag) {
         if (f1 > 0.0F && entityIn instanceof LivingEntity) {
            ((LivingEntity)entityIn).func_233627_a_(f1 * 0.5F, (double)MathHelper.sin(this.rotationYaw * ((float)Math.PI / 180F)), (double)(-MathHelper.cos(this.rotationYaw * ((float)Math.PI / 180F))));
