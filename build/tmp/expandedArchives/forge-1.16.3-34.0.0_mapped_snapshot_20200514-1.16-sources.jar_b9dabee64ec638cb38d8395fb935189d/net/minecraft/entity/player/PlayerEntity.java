...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public void livingTick() {
      ...
      float f;
      if (this.onGround && !this.func_233643_dh_() && !this.isSwimming()) {
   ...
   public boolean func_234569_d_(BlockState p_234569_1_) {
      return net.minecraftforge.event.ForgeEventFactory.doPlayerHarvestCheck(this, p_234569_1_, !p_234569_1_.func_235783_q_() || this.inventory.getCurrentItem().canHarvestBlock(p_234569_1_));
   }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      this.getAttribute(Attributes.field_233821_d_).setBaseValue((double)this.abilities.getWalkSpeed());
   ...
   protected void func_230294_b_(DamageSource p_230294_1_, float p_230294_2_) {
      this.inventory.func_234563_a_(p_230294_1_, p_230294_2_);
   }
      ...
      if (this.isSpectator()) {
         ...
         if (actionresulttype.isSuccessOrConsume()) {
            ...
            if (!itemstack.isEmpty() && entityToInteractOn instanceof LivingEntity) {
               ...
               ActionResultType actionresulttype1 = itemstack.func_111282_a_(this, (LivingEntity)entityToInteractOn, hand);
   ...
   protected Vector3d maybeBackOffFromEdge(Vector3d p_225514_1_, MoverType p_225514_2_) {
      if (!this.abilities.isFlying && (p_225514_2_ == MoverType.SELF || p_225514_2_ == MoverType.PLAYER) && this.isStayingOnGroundSurface() && this.func_242375_q()) {
         ...
         if (!targetEntity.hitByEntity(this)) {
            ...
            if (f > 0.0F || f1 > 0.0F) {
               ...
               if (flag5) {
                  if (i > 0) {
                     if (targetEntity instanceof LivingEntity) {
                        ((LivingEntity)targetEntity).func_233627_a_((float)i * 0.5F, (double)MathHelper.sin(this.rotationYaw * ((float)Math.PI / 180F)), (double)(-MathHelper.cos(this.rotationYaw * ((float)Math.PI / 180F))));
                     } else {
                  ...
                  if (flag3) {
                     ...
                     for(LivingEntity livingentity : this.world.getEntitiesWithinAABB(LivingEntity.class, targetEntity.getBoundingBox().grow(1.0D, 0.25D, 1.0D))) {
                        if (livingentity != this && livingentity != targetEntity && !this.isOnSameTeam(livingentity) && (!(livingentity instanceof ArmorStandEntity) || !((ArmorStandEntity)livingentity).hasMarker()) && this.getDistanceSq(livingentity) < 9.0D) {
                           livingentity.func_233627_a_(0.4F, (double)MathHelper.sin(this.rotationYaw * ((float)Math.PI / 180F)), (double)(-MathHelper.cos(this.rotationYaw * ((float)Math.PI / 180F))));
   ...
   public static Optional<Vector3d> func_242374_a(ServerWorld p_242374_0_, BlockPos p_242374_1_, float p_242374_2_, boolean p_242374_3_, boolean p_242374_4_) {
      ...
      if (block instanceof RespawnAnchorBlock && blockstate.get(RespawnAnchorBlock.field_235559_a_) > 0 && RespawnAnchorBlock.func_235562_a_(p_242374_0_)) {
         Optional<Vector3d> optional = RespawnAnchorBlock.func_235560_a_(EntityType.PLAYER, p_242374_0_, p_242374_1_);
         if (!p_242374_4_ && optional.isPresent()) {
            p_242374_0_.setBlockState(p_242374_1_, blockstate.with(RespawnAnchorBlock.field_235559_a_, Integer.valueOf(blockstate.get(RespawnAnchorBlock.field_235559_a_) - 1)), 3);
         }

         return optional;
      } else if (blockstate.isBed(p_242374_0_, p_242374_1_, null) && BedBlock.func_235330_a_(p_242374_0_)) {
   ...
   public ITextComponent getDisplayName() {
      ...
      iformattabletextcomponent = iformattabletextcomponent.func_230529_a_(ScorePlayerTeam.func_237500_a_(this.getTeam(), this.displayname));
   ...
   private IFormattableTextComponent addTellEvent(IFormattableTextComponent p_208016_1_) {
      ...
      return p_208016_1_.func_240700_a_((p_234565_2_) -> {
         return p_234565_2_.func_240715_a_(new ClickEvent(ClickEvent.Action.SUGGEST_COMMAND, "/tell " + s + " ")).func_240716_a_(this.getHoverEvent()).func_240714_a_(s);
      });
   }
   ...
   public void func_241209_g_(int p_241209_1_) {
      super.func_241209_g_(this.abilities.disableDamage ? Math.min(p_241209_1_, 1) : p_241209_1_);
   }
