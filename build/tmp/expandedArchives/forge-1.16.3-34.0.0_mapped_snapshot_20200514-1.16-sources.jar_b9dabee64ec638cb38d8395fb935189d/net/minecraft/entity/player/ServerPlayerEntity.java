...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener {
   ...
   public ServerPlayerEntity(MinecraftServer server, ServerWorld worldIn, GameProfile profile, PlayerInteractionManager interactionManagerIn) {
      super(worldIn, worldIn.func_241135_u_(), worldIn.func_242107_v(), profile);
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("SpawnX", 99) && compound.contains("SpawnY", 99) && compound.contains("SpawnZ", 99)) {
         ...
         if (compound.contains("SpawnDimension")) {
            this.field_241137_cq_ = World.field_234917_f_.parse(NBTDynamicOps.INSTANCE, compound.get("SpawnDimension")).resultOrPartial(LOGGER::error).orElse(World.field_234918_g_);
         }
      }
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      compound.putString("Dimension", this.world.func_234923_W_().func_240901_a_().toString());
      if (this.field_241138_cr_ != null) {
         ...
         ResourceLocation.field_240908_a_.encodeStart(NBTDynamicOps.INSTANCE, this.field_241137_cq_.func_240901_a_()).resultOrPartial(LOGGER::error).ifPresent((p_241148_1_) -> {
   ...
   public void playerTick() {
      try {
         if (!this.isSpectator() || this.world.isBlockLoaded(this.func_233580_cy_())) {
            super.tick();
         }
   ...
   public void onDeath(DamageSource cause) {
      ...
      if (flag) {
         ...
         this.connection.sendPacket(new SCombatPacket(this.getCombatTracker(), SCombatPacket.Event.ENTITY_DIED, itextcomponent), (p_212356_2_) -> {
            if (!p_212356_2_.isSuccess()) {
               ...
               ITextComponent itextcomponent2 = (new TranslationTextComponent("death.attack.even_more_magic", this.getDisplayName())).func_240700_a_((p_212357_1_) -> {
         ...
         if (team != null && team.getDeathMessageVisibility() != Team.Visible.ALWAYS) {
            ...
            this.server.getPlayerList().func_232641_a_(itextcomponent, ChatType.SYSTEM, Util.field_240973_b_);
         }
      } else {
      ...
      if (this.world.getGameRules().getBoolean(GameRules.field_234895_F_)) {
   ...
   private void func_241157_eT_() {
      AxisAlignedBB axisalignedbb = (new AxisAlignedBB(this.func_233580_cy_())).grow(32.0D, 10.0D, 32.0D);
   ...
   protected PortalInfo func_241829_a(ServerWorld p_241829_1_) {
      ...
      if (portalinfo != null && this.world.func_234923_W_() == World.field_234918_g_ && p_241829_1_.func_234923_W_() == World.field_234920_i_) {
   ...
   public Entity changeDimension(ServerWorld p_241206_1_, net.minecraftforge.common.util.ITeleporter teleporter) {
      ...
      if (registrykey == World.field_234920_i_ && p_241206_1_.func_234923_W_() == World.field_234918_g_ && teleporter.isVanilla()) { //Forge: Fix non-vanilla teleporters triggering end credits
         ...
         this.connection.sendPacket(new SRespawnPacket(p_241206_1_.func_230315_m_(), p_241206_1_.func_234923_W_(), BiomeManager.func_235200_a_(p_241206_1_.getSeed()), this.interactionManager.getGameType(), this.interactionManager.func_241815_c_(), p_241206_1_.func_234925_Z_(), p_241206_1_.func_241109_A_(), true));
         ...
         if (portalinfo != null || !teleporter.isVanilla()) {
            Entity e = teleporter.placeEntity(this, serverworld, p_241206_1_, this.rotationYaw, spawnPortal -> {//Forge: Start vanilla logic
            ...
            if (registrykey == World.field_234918_g_ && p_241206_1_.func_234923_W_() == World.field_234919_h_) {
               ...
               this.func_242110_a(p_241206_1_, new BlockPos(portalinfo.pos));
            }

            serverworld.getProfiler().endSection();
            serverworld.getProfiler().startSection("placing");
            this.setWorld(p_241206_1_);
            ...
            this.interactionManager.setWorld(p_241206_1_);
            this.connection.sendPacket(new SPlayerAbilitiesPacket(this.abilities));
            playerlist.sendWorldInfo(this, p_241206_1_);
   ...
   private void func_213846_b(ServerWorld p_213846_1_) {
      ...
      CriteriaTriggers.CHANGED_DIMENSION.func_233551_a_(this, registrykey, registrykey1);
   ...
   public Either<PlayerEntity.SleepResult, Unit> trySleep(BlockPos at) {
      ...
      if (!this.isSleeping() && this.isAlive()) {
         if (!this.world.func_230315_m_().func_236043_f_()) {
            ...
            this.func_242111_a(this.world.func_234923_W_(), at, this.rotationYaw, false, true);
   ...
   public OptionalInt openContainer(@Nullable INamedContainerProvider p_213829_1_) {
      if (p_213829_1_ == null) {
         ...
         if (container == null) {
            if (this.isSpectator()) {
               this.sendStatusMessage((new TranslationTextComponent("container.spectatorCantOpen")).func_240699_a_(TextFormatting.RED), true);
            }
   ...
   public void sendSlotContents(Container containerToSend, int slotInd, ItemStack stack) {
      if (!(containerToSend.getSlot(slotInd) instanceof CraftingResultSlot)) {
         if (containerToSend == this.container) {
            CriteriaTriggers.INVENTORY_CHANGED.func_234803_a_(this, this.inventory, stack);
         }
   ...
   public void sendStatusMessage(ITextComponent chatComponent, boolean actionBar) {
      this.connection.sendPacket(new SChatPacket(chatComponent, actionBar ? ChatType.GAME_INFO : ChatType.CHAT, Util.field_240973_b_));
   }
   ...
   public void moveForced(double p_225653_1_, double p_225653_3_, double p_225653_5_) {
      this.setPositionAndUpdate(p_225653_1_, p_225653_3_, p_225653_5_);
   ...
   public void sendMessage(ITextComponent component, UUID p_145747_2_) {
      this.func_241151_a_(component, ChatType.SYSTEM, p_145747_2_);
   }
   ...
   public void func_241151_a_(ITextComponent p_241151_1_, ChatType p_241151_2_, UUID p_241151_3_) {
      this.connection.sendPacket(new SChatPacket(p_241151_1_, p_241151_2_, p_241151_3_), (p_241149_4_) -> {
         if (!p_241149_4_.isSuccess() && (p_241151_2_ == ChatType.GAME_INFO || p_241151_2_ == ChatType.SYSTEM)) {
            ...
            this.connection.sendPacket(new SChatPacket((new TranslationTextComponent("multiplayer.message_not_delivered", itextcomponent)).func_240699_a_(TextFormatting.RED), ChatType.SYSTEM, p_241151_3_));
         }
   ...
   public void teleport(ServerWorld newWorld, double x, double y, double z, float yaw, float pitch) {
      ...
      if (newWorld == this.world) {
         ...
         this.connection.sendPacket(new SRespawnPacket(newWorld.func_230315_m_(), newWorld.func_234923_W_(), BiomeManager.func_235200_a_(newWorld.getSeed()), this.interactionManager.getGameType(), this.interactionManager.func_241815_c_(), newWorld.func_234925_Z_(), newWorld.func_241109_A_(), true));
         this.connection.sendPacket(new SServerDifficultyPacket(iworldinfo.getDifficulty(), iworldinfo.isDifficultyLocked()));
   ...
   public void func_242111_a(RegistryKey<World> p_242111_1_, @Nullable BlockPos p_242111_2_, float p_242111_3_, boolean p_242111_4_, boolean p_242111_5_) {
      ...
      if (p_242111_2_ != null) {
         ...
         if (p_242111_5_ && !flag) {
            this.sendMessage(new TranslationTextComponent("block.minecraft.set_spawn"), Util.field_240973_b_);
         }
