...
public class MoveToSkylightTask extends Task<LivingEntity> {
   ...
   protected void startExecuting(ServerWorld worldIn, LivingEntity entityIn, long gameTimeIn) {
      Optional<Vector3d> optional = Optional.ofNullable(this.func_220493_b(worldIn, entityIn));
   ...
   protected boolean shouldExecute(ServerWorld worldIn, LivingEntity owner) {
      return !worldIn.canSeeSky(owner.func_233580_cy_());
   }

   @Nullable
   private Vector3d func_220493_b(ServerWorld p_220493_1_, LivingEntity p_220493_2_) {
      Random random = p_220493_2_.getRNG();
      BlockPos blockpos = p_220493_2_.func_233580_cy_();
