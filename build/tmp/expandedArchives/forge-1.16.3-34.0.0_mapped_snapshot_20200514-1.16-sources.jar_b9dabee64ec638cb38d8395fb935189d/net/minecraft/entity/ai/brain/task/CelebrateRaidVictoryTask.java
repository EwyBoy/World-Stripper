...
public class CelebrateRaidVictoryTask extends Task<VillagerEntity> {
   ...
   protected void updateTask(ServerWorld worldIn, VillagerEntity owner, long gameTime) {
      ...
      if (random.nextInt(200) == 0 && MoveToSkylightTask.func_226306_a_(worldIn, owner, owner.func_233580_cy_())) {
         DyeColor dyecolor = Util.func_240989_a_(DyeColor.values(), random);
