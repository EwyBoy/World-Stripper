...
public class WorkTask extends Task<CreatureEntity> {
   ...
   protected boolean shouldExecute(ServerWorld worldIn, CreatureEntity owner) {
      ...
      return optional.isPresent() && worldIn.func_234923_W_() == optional.get().func_239646_a_() && optional.get().getPos().withinDistance(owner.getPositionVec(), (double)this.field_220567_c);
   }
