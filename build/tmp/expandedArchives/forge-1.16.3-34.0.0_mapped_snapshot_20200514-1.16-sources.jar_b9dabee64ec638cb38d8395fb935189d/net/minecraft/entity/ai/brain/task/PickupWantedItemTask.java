...
public class PickupWantedItemTask<E extends LivingEntity> extends Task<E> {
   ...
   public PickupWantedItemTask(Predicate<E> p_i231521_1_, float p_i231521_2_, boolean p_i231521_3_, int p_i231521_4_) {
      super(ImmutableMap.of(MemoryModuleType.LOOK_TARGET, MemoryModuleStatus.REGISTERED, MemoryModuleType.WALK_TARGET, p_i231521_3_ ? MemoryModuleStatus.REGISTERED : MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.field_234076_J_, MemoryModuleStatus.VALUE_PRESENT));
   ...
   protected boolean shouldExecute(ServerWorld worldIn, E owner) {
      return this.field_233906_b_.test(owner) && this.func_233909_a_(owner).func_233562_a_(owner, (double)this.field_233907_c_);
   }
   ...
   private ItemEntity func_233909_a_(E p_233909_1_) {
      return p_233909_1_.getBrain().getMemory(MemoryModuleType.field_234076_J_).get();
   }
}