...
public class FindHidingPlaceTask extends Task<LivingEntity> {
   ...
   protected boolean shouldExecute(ServerWorld worldIn, LivingEntity owner) {
      Optional<BlockPos> optional = worldIn.getPointOfInterestManager().find((p_220454_0_) -> {
         ...
         return true;
      }, owner.func_233580_cy_(), this.field_220459_c + 1, PointOfInterestManager.Status.ANY);
   ...
   protected void startExecuting(ServerWorld worldIn, LivingEntity entityIn, long gameTimeIn) {
      ...
      if (!optional.isPresent()) {
         optional = worldIn.getPointOfInterestManager().getRandom((p_220453_0_) -> {
            ...
            return true;
         }, PointOfInterestManager.Status.ANY, entityIn.func_233580_cy_(), this.field_220458_b, entityIn.getRNG());
         if (!optional.isPresent()) {
      ...
      if (optional.isPresent()) {
         ...
         brain.setMemory(MemoryModuleType.HIDING_PLACE, GlobalPos.func_239648_a_(worldIn.func_234923_W_(), optional.get()));
