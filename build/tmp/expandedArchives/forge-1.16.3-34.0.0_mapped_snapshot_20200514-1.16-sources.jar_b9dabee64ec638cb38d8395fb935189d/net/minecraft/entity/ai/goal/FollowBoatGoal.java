...
public class FollowBoatGoal extends Goal {
   ...
   public void startExecuting() {
      for(BoatEntity boatentity : this.field_205144_b.world.getEntitiesWithinAABB(BoatEntity.class, this.field_205144_b.getBoundingBox().grow(5.0D))) {
         if (boatentity.getControllingPassenger() != null && boatentity.getControllingPassenger() instanceof PlayerEntity) {
            this.field_205145_c = (PlayerEntity)boatentity.getControllingPassenger();
            break;
         }
      }
   ...
   public void tick() {
      ...
      this.field_205144_b.moveRelative(f, new Vector3d((double)this.field_205144_b.moveStrafing, (double)this.field_205144_b.moveVertical, (double)this.field_205144_b.moveForward));
      ...
      if (--this.field_205143_a <= 0) {
         ...
         if (this.field_205146_d == BoatGoals.GO_TO_BOAT) {
            BlockPos blockpos = this.field_205145_c.func_233580_cy_().offset(this.field_205145_c.getHorizontalFacing().getOpposite());
            ...
            BlockPos blockpos1 = this.field_205145_c.func_233580_cy_().offset(direction, 10);
