...
public class PatrolVillageGoal extends RandomWalkingGoal {
   ...
   private Vector3d func_234032_k_() {
      ...
      List<VillagerEntity> list = serverworld.getEntitiesWithinAABB(EntityType.VILLAGER, this.creature.getBoundingBox().grow(32.0D), this::func_234028_a_);
      if (list.isEmpty()) {
         return null;
      } else {
   ...
   private Vector3d func_234033_l_() {
      ...
      if (sectionpos == null) {
         ...
         return blockpos == null ? null : RandomPositionGenerator.func_234133_a_(this.creature, 10, 7, Vector3d.func_237492_c_(blockpos));
      }
   }
   ...
   private boolean func_234028_a_(VillagerEntity p_234028_1_) {
      return p_234028_1_.canSpawnGolems(this.creature.world.getGameTime());
   }
}