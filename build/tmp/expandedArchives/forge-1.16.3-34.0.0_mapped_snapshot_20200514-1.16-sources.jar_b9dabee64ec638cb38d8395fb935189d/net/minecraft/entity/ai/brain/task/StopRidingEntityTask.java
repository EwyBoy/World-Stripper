...
public class StopRidingEntityTask<E extends LivingEntity, T extends Entity> extends Task<E> {
   ...
   protected boolean shouldExecute(ServerWorld worldIn, E owner) {
      ...
      Entity entity1 = owner.getBrain().getMemory(MemoryModuleType.field_234105_s_).orElse((Entity)null);
   ...
   private boolean func_233892_a_(E p_233892_1_, Entity p_233892_2_) {
      return p_233892_2_.isAlive() && p_233892_2_.func_233562_a_(p_233892_1_, (double)this.field_233890_b_) && p_233892_2_.world == p_233892_1_.world;
   }

   protected void startExecuting(ServerWorld worldIn, E entityIn, long gameTimeIn) {
      entityIn.stopRiding();
      entityIn.getBrain().removeMemory(MemoryModuleType.field_234105_s_);
   }
}