...
public class HuntCelebrationTask<E extends MobEntity> extends Task<E> {
   ...
   public HuntCelebrationTask(int p_i231518_1_, float p_i231518_2_) {
      super(ImmutableMap.of(MemoryModuleType.field_234083_Q_, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.field_234103_o_, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.WALK_TARGET, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.LOOK_TARGET, MemoryModuleStatus.REGISTERED));
   ...
   protected void startExecuting(ServerWorld worldIn, MobEntity entityIn, long gameTimeIn) {
      ...
      boolean flag = blockpos.withinDistance(entityIn.func_233580_cy_(), (double)this.field_233897_b_);
      if (!flag) {
   ...
   private static BlockPos func_233899_a_(MobEntity p_233899_0_) {
      return p_233899_0_.getBrain().getMemory(MemoryModuleType.field_234083_Q_).get();
   }
}