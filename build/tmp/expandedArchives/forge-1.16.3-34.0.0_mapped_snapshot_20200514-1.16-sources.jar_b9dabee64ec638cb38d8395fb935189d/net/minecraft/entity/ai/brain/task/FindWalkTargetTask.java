...
public class FindWalkTargetTask extends Task<CreatureEntity> {
   ...
   private void func_220594_a(CreatureEntity p_220594_1_, SectionPos p_220594_2_) {
      Optional<Vector3d> optional = Optional.ofNullable(RandomPositionGenerator.findRandomTargetBlockTowards(p_220594_1_, this.maxXZ, this.maxY, Vector3d.func_237492_c_(p_220594_2_.getCenter())));
