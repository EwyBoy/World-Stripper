...
public class MoveThroughVillageGoal extends Goal {
   ...
   public MoveThroughVillageGoal(CreatureEntity p_i50324_1_, double speedIn, boolean nocturnal, int maxDistanceIn, BooleanSupplier booleanSupplierIn) {
      ...
      if (!GroundPathHelper.func_242319_a(p_i50324_1_)) {
            ...
            if (!serverworld.func_241119_a_(blockpos, 6)) {
               ...
               if (vector3d == null) {
                  ...
                  if (!optional.isPresent()) {
                     ...
                     if (this.path == null) {
                        Vector3d vector3d1 = RandomPositionGenerator.findRandomTargetBlockTowards(this.entity, 10, 7, Vector3d.func_237492_c_(this.field_220735_d));
                        if (vector3d1 == null) {
                           return false;
                        }
                     ...
                     for(int i = 0; i < this.path.getCurrentPathLength(); ++i) {
                        ...
                        if (DoorBlock.func_235491_a_(this.entity.world, blockpos1)) {
