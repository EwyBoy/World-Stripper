...
public class GatherPOITask extends Task<CreatureEntity> {
   ...
   protected void startExecuting(ServerWorld worldIn, CreatureEntity entityIn, long gameTimeIn) {
      ...
      Set<BlockPos> set = pointofinterestmanager.func_242324_b(this.field_220604_a.getPredicate(), predicate, entityIn.func_233580_cy_(), 48, PointOfInterestManager.Status.HAS_SPACE).limit(5L).collect(Collectors.toSet());
