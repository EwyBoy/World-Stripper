...
public class InteractWithDoorTask extends Task<LivingEntity> {
   ...
   public InteractWithDoorTask() {
      super(ImmutableMap.of(MemoryModuleType.PATH, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.field_225462_q, MemoryModuleStatus.REGISTERED));
   }
   ...
   protected void startExecuting(ServerWorld worldIn, LivingEntity entityIn, long gameTimeIn) {
      ...
      if (blockstate.func_235714_a_(BlockTags.WOODEN_DOORS)) {
      ...
      if (blockstate1.func_235714_a_(BlockTags.WOODEN_DOORS)) {
   ...
   public static void func_242294_a(ServerWorld p_242294_0_, LivingEntity p_242294_1_, @Nullable PathPoint p_242294_2_, @Nullable PathPoint p_242294_3_) {
      ...
      if (brain.hasMemory(MemoryModuleType.field_225462_q)) {
         Iterator<GlobalPos> iterator = brain.getMemory(MemoryModuleType.field_225462_q).get().iterator();
   ...
   private static boolean func_242296_a(ServerWorld p_242296_0_, LivingEntity p_242296_1_, GlobalPos p_242296_2_) {
      return p_242296_2_.func_239646_a_() != p_242296_0_.func_234923_W_() || !p_242296_2_.getPos().withinDistance(p_242296_1_.getPositionVec(), 2.0D);
   }
   ...
   private void func_242301_c(ServerWorld p_242301_1_, LivingEntity p_242301_2_, BlockPos p_242301_3_) {
      ...
      GlobalPos globalpos = GlobalPos.func_239648_a_(p_242301_1_.func_234923_W_(), p_242301_3_);
      if (brain.getMemory(MemoryModuleType.field_225462_q).isPresent()) {
         brain.getMemory(MemoryModuleType.field_225462_q).get().add(globalpos);
      } else {
