...
public class FindNewAttackTargetTask<E extends MobEntity> extends Task<E> {
   ...
   public FindNewAttackTargetTask(Predicate<LivingEntity> p_i231539_1_) {
      super(ImmutableMap.of(MemoryModuleType.field_234103_o_, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleStatus.REGISTERED));
   ...
   protected void startExecuting(ServerWorld worldIn, E entityIn, long gameTimeIn) {
      if (func_233982_a_(entityIn)) {
         ...
         this.func_233987_d_(entityIn);
      } else if (!EntityPredicates.field_233583_f_.test(this.func_233985_b_(entityIn))) {
         this.func_233987_d_(entityIn);
   ...
   private LivingEntity func_233985_b_(E p_233985_1_) {
      return p_233985_1_.getBrain().getMemory(MemoryModuleType.field_234103_o_).get();
   }
   ...
   private boolean func_233986_c_(E p_233986_1_) {
      Optional<LivingEntity> optional = p_233986_1_.getBrain().getMemory(MemoryModuleType.field_234103_o_);
      return optional.isPresent() && !optional.get().isAlive();
   }

   private void func_233987_d_(E p_233987_1_) {
      p_233987_1_.getBrain().removeMemory(MemoryModuleType.field_234103_o_);
   }
}