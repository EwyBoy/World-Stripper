...
public class CongregateTask extends Task<LivingEntity> {
   ...
   protected boolean shouldExecute(ServerWorld worldIn, LivingEntity owner) {
      ...
      return worldIn.getRandom().nextInt(100) == 0 && optional.isPresent() && worldIn.func_234923_W_() == optional.get().func_239646_a_() && optional.get().getPos().withinDistance(owner.getPositionVec(), 4.0D) && brain.getMemory(MemoryModuleType.VISIBLE_MOBS).get().stream().anyMatch((p_220570_0_) -> {
