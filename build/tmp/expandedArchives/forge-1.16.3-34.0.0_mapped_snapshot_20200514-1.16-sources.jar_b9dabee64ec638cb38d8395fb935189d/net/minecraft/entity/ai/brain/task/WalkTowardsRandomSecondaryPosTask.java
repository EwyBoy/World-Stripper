   ...
   protected boolean shouldExecute(ServerWorld worldIn, VillagerEntity owner) {
      ...
      if (optional.isPresent() && optional1.isPresent()) {
         ...
         if (!list.isEmpty()) {
            ...
            return this.field_220579_g != null && worldIn.func_234923_W_() == this.field_220579_g.func_239646_a_() && optional1.get().getPos().withinDistance(owner.getPositionVec(), (double)this.field_220577_e);
         }
      }
