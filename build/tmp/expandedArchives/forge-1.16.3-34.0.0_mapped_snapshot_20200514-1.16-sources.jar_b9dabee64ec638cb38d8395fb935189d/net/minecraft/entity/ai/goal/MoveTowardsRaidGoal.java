...
public class MoveTowardsRaidGoal<T extends AbstractRaiderEntity> extends Goal {
   ...
   public boolean shouldExecute() {
      return this.field_220744_a.getAttackTarget() == null && !this.field_220744_a.isBeingRidden() && this.field_220744_a.isRaidActive() && !this.field_220744_a.getRaid().isOver() && !((ServerWorld)this.field_220744_a.world).isVillage(this.field_220744_a.func_233580_cy_());
   }
   ...
   public boolean shouldContinueExecuting() {
      return this.field_220744_a.isRaidActive() && !this.field_220744_a.getRaid().isOver() && this.field_220744_a.world instanceof ServerWorld && !((ServerWorld)this.field_220744_a.world).isVillage(this.field_220744_a.func_233580_cy_());
   }
   ...
   public void tick() {
      if (this.field_220744_a.isRaidActive()) {
         ...
         if (!this.field_220744_a.hasPath()) {
            Vector3d vector3d = RandomPositionGenerator.findRandomTargetBlockTowards(this.field_220744_a, 15, 4, Vector3d.func_237492_c_(raid.getCenter()));
            if (vector3d != null) {
               this.field_220744_a.getNavigator().tryMoveToXYZ(vector3d.x, vector3d.y, vector3d.z, 1.0D);
            }
         }
      }
