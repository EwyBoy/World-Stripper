...
public class DolphinJumpGoal extends JumpGoal {
   ...
   public boolean shouldExecute() {
      if (this.field_220711_b.getRNG().nextInt(this.field_220712_c) != 0) {
         ...
         BlockPos blockpos = this.field_220711_b.func_233580_cy_();
   ...
   public boolean shouldContinueExecuting() {
      ...
      return (!(d0 * d0 < (double)0.03F) || this.field_220711_b.rotationPitch == 0.0F || !(Math.abs(this.field_220711_b.rotationPitch) < 10.0F) || !this.field_220711_b.isInWater()) && !this.field_220711_b.func_233570_aj_();
   }
   ...
   public void tick() {
      ...
      if (!flag) {
         FluidState fluidstate = this.field_220711_b.world.getFluidState(this.field_220711_b.func_233580_cy_());
         this.field_220713_d = fluidstate.isTagged(FluidTags.WATER);
      }
      ...
      Vector3d vector3d = this.field_220711_b.getMotion();
      if (vector3d.y * vector3d.y < (double)0.03F && this.field_220711_b.rotationPitch != 0.0F) {
