...
public abstract class LivingEntity extends Entity {
   ...
   protected LivingEntity(EntityType<? extends LivingEntity> type, World worldIn) {
      super(type, worldIn);
      this.attributes = new AttributeModifierManager(GlobalEntityTypeAttributes.func_233835_a_(type));
   ...
   public void baseTick() {
      ...
      if (this.func_230279_az_() || this.world.isRemote) {
         this.extinguish();
      }
   ...
   public boolean func_230490_cK_() {
      return this.ticksExisted % 5 == 0 && this.getMotion().x != 0.0D && this.getMotion().z != 0.0D && !this.isSpectator() && EnchantmentHelper.func_234846_j_(this) && this.func_230296_cM_();
   }

   protected void func_233640_cL_() {
      Vector3d vector3d = this.getMotion();
      this.world.addParticle(ParticleTypes.field_239812_C_, this.getPosX() + (this.rand.nextDouble() - 0.5D) * (double)this.getWidth(), this.getPosY() + 0.1D, this.getPosZ() + (this.rand.nextDouble() - 0.5D) * (double)this.getWidth(), vector3d.x * -0.2D, 0.1D, vector3d.z * -0.2D);
      float f = this.rand.nextFloat() * 0.4F + this.rand.nextFloat() > 0.9F ? 0.6F : 0.0F;
      this.playSound(SoundEvents.field_232831_nS_, f, 0.6F + this.rand.nextFloat() * 0.4F);
   }

   protected boolean func_230296_cM_() {
      return this.world.getBlockState(this.getPositionUnderneath()).func_235714_a_(BlockTags.field_232876_aq_);
   }

   protected float getSpeedFactor() {
      return this.func_230296_cM_() && EnchantmentHelper.getMaxEnchantmentLevel(Enchantments.field_234847_l_, this) > 0 ? 1.0F : super.getSpeedFactor();
   }
   ...
   protected void func_233641_cN_() {
      ...
      if (modifiableattributeinstance != null) {
         if (modifiableattributeinstance.getModifier(field_233625_c_) != null) {
            modifiableattributeinstance.removeModifier(field_233625_c_);
         }
   ...
   protected void func_233642_cO_() {
      if (!this.func_233568_aJ_().isAir()) {
         int i = EnchantmentHelper.getMaxEnchantmentLevel(Enchantments.field_234847_l_, this);
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      compound.put("Attributes", this.func_233645_dx_().func_233794_c_());
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("Attributes", 9) && this.world != null && !this.world.isRemote) {
         this.func_233645_dx_().func_233788_a_(compound.getList("Attributes", 10));
      }
   ...
   protected void onNewPotionEffect(EffectInstance id) {
      ...
      if (!this.world.isRemote) {
         id.getPotion().applyAttributesModifiersToEntity(this, this.func_233645_dx_(), id.getAmplifier());
      }
   ...
   protected void onChangedPotionEffect(EffectInstance id, boolean reapply) {
      ...
      if (reapply && !this.world.isRemote) {
         ...
         effect.removeAttributesModifiersFromEntity(this, this.func_233645_dx_(), id.getAmplifier());
         effect.applyAttributesModifiersToEntity(this, this.func_233645_dx_(), id.getAmplifier());
      }
   ...
   protected void onFinishedPotionEffect(EffectInstance effect) {
      this.potionsNeedUpdate = true;
      if (!this.world.isRemote) {
         effect.getPotion().removeAttributesModifiersFromEntity(this, this.func_233645_dx_(), effect.getAmplifier());
      }
   ...
   protected void constructKnockBackVector(LivingEntity entityIn) {
      entityIn.func_233627_a_(0.5F, entityIn.getPosX() - this.getPosX(), entityIn.getPosZ() - this.getPosZ());
   }
   ...
   public void func_233627_a_(float p_233627_1_, double p_233627_2_, double p_233627_4_) {
      ...
      if (!(p_233627_1_ <= 0.0F)) {
         ...
         this.setMotion(vector3d.x / 2.0D - vector3d1.x, this.onGround ? Math.min(0.4D, vector3d.y / 2.0D + (double)p_233627_1_) : vector3d.y, vector3d.z / 2.0D - vector3d1.z);
      }
   }
   ...
   public BlockState getBlockState() {
      return this.world.getBlockState(this.func_233580_cy_());
   }
   ...
   public int getTotalArmorValue() {
      return MathHelper.floor(this.func_233637_b_(Attributes.field_233826_i_));
   }
   ...
   protected float applyArmorCalculations(DamageSource source, float damage) {
      if (!source.isUnblockable()) {
         ...
         damage = CombatRules.getDamageAfterAbsorb(damage, (float)this.getTotalArmorValue(), (float)this.func_233637_b_(Attributes.field_233827_j_));
      }
   ...
   public void setSprinting(boolean sprinting) {
      ...
      if (sprinting) {
         modifiableattributeinstance.func_233767_b_(SPRINTING_SPEED_BOOST);
      }
   ...
   private void func_233628_a_(Entity p_233628_1_) {
      Vector3d vector3d;
      if (!p_233628_1_.removed && !this.world.getBlockState(p_233628_1_.func_233580_cy_()).getBlock().isIn(BlockTags.PORTALS)) {
   ...
   public void travel(Vector3d p_213352_1_) {
      if (this.isServerWorld() || this.canPassengerSteer()) {
         ...
         if (flag && this.isPotionActive(Effects.SLOW_FALLING)) {
            if (!gravity.hasModifier(SLOW_FALLING)) gravity.func_233767_b_(SLOW_FALLING);
   ...
   private Vector3d handleOnClimbable(Vector3d p_213362_1_) {
      if (this.isOnLadder()) {
         ...
         if (d2 < 0.0D && !this.getBlockState().isScaffolding(this) && this.func_230491_ea_() && this instanceof PlayerEntity) {
            d2 = 0.0D;
         }
   ...
   private Map<EquipmentSlotType, ItemStack> func_241354_r_() {
      ...
      for(EquipmentSlotType equipmentslottype : EquipmentSlotType.values()) {
         ...
         if (!ItemStack.areItemStacksEqual(itemstack1, itemstack)) {
            ...
            if (!itemstack.isEmpty()) {
               this.func_233645_dx_().func_233785_a_(itemstack.getAttributeModifiers(equipmentslottype));
            }

            if (!itemstack1.isEmpty()) {
               this.func_233645_dx_().func_233793_b_(itemstack1.getAttributeModifiers(equipmentslottype));
            }
         }
      }
   ...
   private void func_241342_a_(Map<EquipmentSlotType, ItemStack> p_241342_1_) {
      ...
      if (itemstack != null && itemstack1 != null && ItemStack.areItemStacksEqual(itemstack, this.func_241347_e_(EquipmentSlotType.OFFHAND)) && ItemStack.areItemStacksEqual(itemstack1, this.func_241347_e_(EquipmentSlotType.MAINHAND))) {
         ...
         this.func_241345_c_(EquipmentSlotType.MAINHAND, itemstack.copy());
         this.func_241345_c_(EquipmentSlotType.OFFHAND, itemstack1.copy());
      }
   ...
   public void livingTick() {
      ...
      this.world.getProfiler().endSection();
      if (!this.world.isRemote && this.func_230270_dK_() && this.isInWaterRainOrBubbleColumn()) {
   ...
   public void func_233630_a_(ItemEntity p_233630_1_) {
      PlayerEntity playerentity = p_233630_1_.getThrowerId() != null ? this.world.getPlayerByUuid(p_233630_1_.getThrowerId()) : null;
      if (playerentity instanceof ServerPlayerEntity) {
         CriteriaTriggers.field_232609_O_.func_234830_a_((ServerPlayerEntity)playerentity, p_233630_1_.getItem(), this);
      }
   ...
   protected void markVelocityChanged() {
      this.velocityChanged = this.rand.nextDouble() >= this.func_233637_b_(Attributes.field_233820_c_);
   }
   ...
   public AxisAlignedBB func_233648_f_(Pose p_233648_1_) {
      EntitySize entitysize = this.getSize(p_233648_1_);
   ...
   public void wakeUp() {
      this.getBedPosition().filter(this.world::isBlockLoaded).ifPresent((p_241348_1_) -> {
         ...
         if (blockstate.isBed(world, p_241348_1_, this)) {
            ...
            Vector3d vector3d2 = Vector3d.func_237492_c_(p_241348_1_).subtract(vector3d1).normalize();
