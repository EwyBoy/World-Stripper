...
public class ZombieEntity extends MonsterEntity {
   ...
   protected void func_234341_c_(EntityType<? extends ZombieEntity> p_234341_1_) {
      ...
      if (zombieentity != null) {
         zombieentity.applyAttributeBonuses(zombieentity.world.getDifficultyForLocation(zombieentity.func_233580_cy_()).getClampedAdditionalDifficulty());
   ...
   public boolean attackEntityFrom(DamageSource source, float amount) {
      if (!super.attackEntityFrom(source, amount)) {
         ...
         net.minecraftforge.event.entity.living.ZombieEvent.SummonAidEvent event = net.minecraftforge.event.ForgeEventFactory.fireZombieSummonAid(this, world, i, j, k, livingentity, this.getAttribute(Attributes.field_233829_l_).getValue());
            ...
            for(int l = 0; l < 50; ++l) {
               ...
               if (WorldEntitySpawner.canCreatureTypeSpawnAtLocation(entityspawnplacementregistry$placementtype, this.world, blockpos, entitytype) && EntitySpawnPlacementRegistry.func_223515_a(entitytype, serverworld, SpawnReason.REINFORCEMENT, blockpos, this.world.rand)) {
                  ...
                  if (!this.world.isPlayerWithin((double)i1, (double)j1, (double)k1, 7.0D) && this.world.checkNoEntityCollision(zombieentity) && this.world.hasNoCollisions(zombieentity) && !this.world.containsAnyLiquid(zombieentity.getBoundingBox())) {
                     ...
                     zombieentity.onInitialSpawn(serverworld, this.world.getDifficultyForLocation(zombieentity.func_233580_cy_()), SpawnReason.REINFORCEMENT, (ILivingEntityData)null, (CompoundNBT)null);
                     ...
                     zombieentity.getAttribute(Attributes.field_233829_l_).func_233769_c_(new AttributeModifier("Zombie reinforcement callee charge", (double)-0.05F, AttributeModifier.Operation.ADDITION));
                     break;
                  }
               }
            }
   ...
   public void func_241847_a(ServerWorld p_241847_1_, LivingEntity p_241847_2_) {
      ...
      if ((p_241847_1_.getDifficulty() == Difficulty.NORMAL || p_241847_1_.getDifficulty() == Difficulty.HARD) && p_241847_2_ instanceof VillagerEntity) {
         ...
         zombievillagerentity.onInitialSpawn(p_241847_1_, p_241847_1_.getDifficultyForLocation(zombievillagerentity.func_233580_cy_()), SpawnReason.CONVERSION, new ZombieEntity.GroupData(false, true), (CompoundNBT)null);
         ...
         if (!this.isSilent()) {
            p_241847_1_.playEvent((PlayerEntity)null, 1026, this.func_233580_cy_(), 0);
         }
      }
