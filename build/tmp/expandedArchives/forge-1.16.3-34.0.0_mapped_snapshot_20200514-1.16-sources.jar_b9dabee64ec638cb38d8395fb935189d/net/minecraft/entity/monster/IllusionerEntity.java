...
public class IllusionerEntity extends SpellcastingIllagerEntity implements IRangedAttackMob {
   ...
   public static AttributeModifierMap.MutableAttribute func_234293_eI_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.field_233821_d_, 0.5D).func_233815_a_(Attributes.field_233819_b_, 18.0D).func_233815_a_(Attributes.field_233818_a_, 32.0D);
   }
   ...
   class BlindnessSpellGoal extends SpellcastingIllagerEntity.UseSpellGoal {
      ...
      public boolean shouldExecute() {
         if (!super.shouldExecute()) {
            ...
            return IllusionerEntity.this.world.getDifficultyForLocation(IllusionerEntity.this.func_233580_cy_()).isHarderThan((float)Difficulty.NORMAL.ordinal());
         }
      }
