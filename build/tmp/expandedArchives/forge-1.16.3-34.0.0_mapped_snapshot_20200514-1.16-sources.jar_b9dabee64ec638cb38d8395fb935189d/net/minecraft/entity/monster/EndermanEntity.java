...
public class EndermanEntity extends MonsterEntity implements IAngerable {
   ...
   public void func_230258_H__() {
      this.func_230260_a__(field_234286_bz_.func_233018_a_(this.rand));
   }
   ...
   static class PlaceBlockGoal extends Goal {
      ...
      public void tick() {
         ...
         if (blockstate2 != null) {
            ...
            if (this.func_220836_a(world, blockpos, blockstate2, blockstate, blockstate1, blockpos1) && !net.minecraftforge.event.ForgeEventFactory.onBlockPlace(enderman, net.minecraftforge.common.util.BlockSnapshot.create(world.func_234923_W_(), world, blockpos1), net.minecraft.util.Direction.UP)) {
      ...
      private boolean func_220836_a(World p_220836_1_, BlockPos p_220836_2_, BlockState p_220836_3_, BlockState p_220836_4_, BlockState p_220836_5_, BlockPos p_220836_6_) {
         return p_220836_4_.isAir(p_220836_1_, p_220836_2_) && !p_220836_5_.isAir(p_220836_1_, p_220836_6_) && !p_220836_5_.isIn(Blocks.BEDROCK) && p_220836_5_.func_235785_r_(p_220836_1_, p_220836_6_) && p_220836_3_.isValidPosition(p_220836_1_, p_220836_2_) && p_220836_1_.getEntitiesWithinAABBExcludingEntity(this.enderman, AxisAlignedBB.func_241549_a_(Vector3d.func_237491_b_(p_220836_2_))).isEmpty();
      }
   }
