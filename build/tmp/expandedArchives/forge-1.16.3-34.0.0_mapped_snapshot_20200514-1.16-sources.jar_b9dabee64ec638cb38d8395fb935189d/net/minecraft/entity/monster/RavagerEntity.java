...
public class RavagerEntity extends AbstractRaiderEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234297_m_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.field_233818_a_, 100.0D).func_233815_a_(Attributes.field_233821_d_, 0.3D).func_233815_a_(Attributes.field_233820_c_, 0.75D).func_233815_a_(Attributes.field_233823_f_, 12.0D).func_233815_a_(Attributes.field_233824_g_, 1.5D).func_233815_a_(Attributes.field_233819_b_, 32.0D);
   }
