...
public class ShulkerEntity extends GolemEntity implements IMob {
   ...
   private boolean func_234298_a_(BlockPos p_234298_1_, Direction p_234298_2_) {
      return this.world.func_234929_a_(p_234298_1_.offset(p_234298_2_), this, p_234298_2_.getOpposite()) && this.world.hasNoCollisions(this, ShulkerAABBHelper.func_233539_a_(p_234298_1_, p_234298_2_.getOpposite()));
   }
   ...
   public void updateArmorModifier(int p_184691_1_) {
      if (!this.world.isRemote) {
         this.getAttribute(Attributes.field_233826_i_).removeModifier(COVERED_ARMOR_BONUS_MODIFIER);
         if (p_184691_1_ == 0) {
            this.getAttribute(Attributes.field_233826_i_).func_233769_c_(COVERED_ARMOR_BONUS_MODIFIER);
