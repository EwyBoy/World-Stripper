...
public abstract class PatrollerEntity extends MonsterEntity {
   ...
   public void resetPatrolTarget() {
      this.patrolTarget = this.func_233580_cy_().add(-500 + this.rand.nextInt(1000), 0, -500 + this.rand.nextInt(1000));
      this.patrolling = true;
   }
   ...
   public static class PatrolGoal<T extends PatrollerEntity> extends Goal {
      ...
      public void tick() {
         ...
         if (pathnavigator.noPath()) {
            ...
            if (this.owner.isPatrolling() && list.isEmpty()) {
               ...
               Vector3d vector3d = Vector3d.func_237492_c_(this.owner.getPatrolTarget());
      ...
      private boolean func_226545_h_() {
         ...
         BlockPos blockpos = this.owner.world.getHeight(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, this.owner.func_233580_cy_().add(-8 + random.nextInt(16), 0, -8 + random.nextInt(16)));
