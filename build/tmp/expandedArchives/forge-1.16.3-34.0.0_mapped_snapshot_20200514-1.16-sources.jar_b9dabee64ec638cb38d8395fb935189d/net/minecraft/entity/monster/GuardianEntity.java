...
public class GuardianEntity extends MonsterEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234292_eK_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.field_233823_f_, 6.0D).func_233815_a_(Attributes.field_233821_d_, 0.5D).func_233815_a_(Attributes.field_233819_b_, 16.0D).func_233815_a_(Attributes.field_233818_a_, 30.0D);
   }
      ...
      if (this.isAlive()) {
         if (this.world.isRemote) {
            ...
            if (!this.isInWater()) {
               ...
               this.clientSideTouchedGround = vector3d.y < 0.0D && this.world.isTopSolid(this.func_233580_cy_().down(), this);
      ...
      public void tick() {
         ...
         if (!this.guardian.canEntityBeSeen(livingentity)) {
            ...
            if (this.tickCounter == 0) {
               ...
               livingentity.attackEntityFrom(DamageSource.causeMobDamage(this.guardian), (float)this.guardian.func_233637_b_(Attributes.field_233823_f_));
               this.guardian.setAttackTarget((LivingEntity)null);
            }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         if (this.action == MovementController.Action.MOVE_TO && !this.entityGuardian.getNavigator().noPath()) {
            ...
            float f1 = (float)(this.speed * this.entityGuardian.func_233637_b_(Attributes.field_233821_d_));
