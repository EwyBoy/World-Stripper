...
public interface IFlinging {
   ...
   static boolean func_234403_a_(LivingEntity p_234403_0_, LivingEntity p_234403_1_) {
      float f1 = (float)p_234403_0_.func_233637_b_(Attributes.field_233823_f_);
      float f;
   ...
   static void func_234404_b_(LivingEntity p_234404_0_, LivingEntity p_234404_1_) {
      double d0 = p_234404_0_.func_233637_b_(Attributes.field_233824_g_);
      double d1 = p_234404_1_.func_233637_b_(Attributes.field_233820_c_);
      double d2 = d0 - d1;
      if (!(d2 <= 0.0D)) {
