...
public class PillagerEntity extends AbstractIllagerEntity implements ICrossbowUser {
   ...
   public static AttributeModifierMap.MutableAttribute func_234296_eI_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.field_233821_d_, (double)0.35F).func_233815_a_(Attributes.field_233818_a_, 24.0D).func_233815_a_(Attributes.field_233823_f_, 5.0D).func_233815_a_(Attributes.field_233819_b_, 32.0D);
   }
   ...
   public AbstractIllagerEntity.ArmPose getArmPose() {
      ...
      } else if (this.func_233631_a_(Items.CROSSBOW)) {
