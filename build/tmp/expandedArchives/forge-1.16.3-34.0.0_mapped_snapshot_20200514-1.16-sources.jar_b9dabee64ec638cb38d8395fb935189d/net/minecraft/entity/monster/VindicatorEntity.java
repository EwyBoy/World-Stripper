...
public class VindicatorEntity extends AbstractIllagerEntity {
   ...
   protected void updateAITasks() {
      if (!this.isAIDisabled() && GroundPathHelper.func_242319_a(this)) {
         boolean flag = ((ServerWorld)this.world).hasRaid(this.func_233580_cy_());
   ...
   public static AttributeModifierMap.MutableAttribute func_234322_eI_() {
      return MonsterEntity.func_234295_eP_().func_233815_a_(Attributes.field_233821_d_, (double)0.35F).func_233815_a_(Attributes.field_233819_b_, 12.0D).func_233815_a_(Attributes.field_233818_a_, 24.0D).func_233815_a_(Attributes.field_233823_f_, 5.0D);
   }
