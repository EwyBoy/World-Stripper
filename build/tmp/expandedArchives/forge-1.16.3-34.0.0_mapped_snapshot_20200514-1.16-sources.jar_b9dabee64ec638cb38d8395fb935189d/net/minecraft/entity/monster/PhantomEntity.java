...
public class PhantomEntity extends FlyingEntity implements IMob {
   ...
   class OrbitPointGoal extends PhantomEntity.MoveGoal {
      ...
      public void tick() {
         ...
         if (PhantomEntity.this.orbitOffset.y < PhantomEntity.this.getPosY() && !PhantomEntity.this.world.isAirBlock(PhantomEntity.this.func_233580_cy_().down(1))) {
            this.field_203152_e = Math.max(1.0F, this.field_203152_e);
            this.func_203148_i();
         }

         if (PhantomEntity.this.orbitOffset.y > PhantomEntity.this.getPosY() && !PhantomEntity.this.world.isAirBlock(PhantomEntity.this.func_233580_cy_().up(1))) {
      ...
      private void func_203148_i() {
         if (BlockPos.ZERO.equals(PhantomEntity.this.orbitPosition)) {
            PhantomEntity.this.orbitPosition = PhantomEntity.this.func_233580_cy_();
         }

         this.field_203150_c += this.field_203153_f * 15.0F * ((float)Math.PI / 180F);
         PhantomEntity.this.orbitOffset = Vector3d.func_237491_b_(PhantomEntity.this.orbitPosition).add((double)(this.field_203151_d * MathHelper.cos(this.field_203150_c)), (double)(-4.0F + this.field_203152_e), (double)(this.field_203151_d * MathHelper.sin(this.field_203150_c)));
      }
   }
   ...
   class PickAttackGoal extends Goal {
      ...
      private void func_203143_f() {
         PhantomEntity.this.orbitPosition = PhantomEntity.this.getAttackTarget().func_233580_cy_().up(20 + PhantomEntity.this.rand.nextInt(20));
      ...
      public void tick() {
         ...
         if (PhantomEntity.this.getBoundingBox().grow((double)0.2F).intersects(livingentity.getBoundingBox())) {
            ...
            if (!PhantomEntity.this.isSilent()) {
               PhantomEntity.this.world.playEvent(1039, PhantomEntity.this.func_233580_cy_(), 0);
            }
