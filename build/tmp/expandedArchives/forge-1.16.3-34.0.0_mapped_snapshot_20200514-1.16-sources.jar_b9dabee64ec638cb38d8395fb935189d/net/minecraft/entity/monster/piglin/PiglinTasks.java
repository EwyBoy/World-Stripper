...
public class PiglinTasks {
   ...
   protected static void func_234466_a_(PiglinEntity p_234466_0_) {
      ...
      p_234466_0_.getBrain().func_233696_a_(MemoryModuleType.field_234082_P_, true, (long)i);
   }
   ...
   private static void func_234488_b_(PiglinEntity p_234488_0_, Brain<PiglinEntity> p_234488_1_) {
      p_234488_1_.func_233699_a_(Activity.field_234621_k_, 10, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(new FindNewAttackTargetTask<>((p_234523_1_) -> {
   ...
   private static void func_234495_c_(Brain<PiglinEntity> p_234495_0_) {
      p_234495_0_.func_233699_a_(Activity.field_234622_l_, 10, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(func_234493_c_(), new LookAtEntityTask(PiglinTasks::func_234482_b_, 14.0F), new ForgetAttackTargetTask<PiglinEntity>(AbstractPiglinEntity::func_242337_eM, PiglinTasks::func_234526_m_), new SupplementedTask<PiglinEntity>((p_234457_0_) -> {
   ...
   private static void func_234502_d_(Brain<PiglinEntity> p_234502_0_) {
      p_234502_0_.func_233699_a_(Activity.field_234623_m_, 10, ImmutableList.<net.minecraft.entity.ai.brain.task.Task<? super PiglinEntity>>of(new PickupWantedItemTask<>(PiglinTasks::func_234455_E_, 1.0F, true, 9), new ForgetAdmiredItemTask(9), new StopReachingItemTask(200, 200)), MemoryModuleType.field_234080_N_);
   }

   private static void func_234507_e_(Brain<PiglinEntity> p_234507_0_) {
      p_234507_0_.func_233699_a_(Activity.field_234624_n_, 10, ImmutableList.of(RunAwayTask.func_233965_b_(MemoryModuleType.field_234106_z_, 1.0F, 12, true), func_234458_a_(), func_234481_b_(), new PredicateTask<PiglinEntity>(PiglinTasks::func_234533_t_, MemoryModuleType.field_234106_z_)), MemoryModuleType.field_234106_z_);
   }

   private static void func_234511_f_(Brain<PiglinEntity> p_234511_0_) {
      p_234511_0_.func_233699_a_(Activity.field_234625_o_, 10, ImmutableList.of(new RideEntityTask<>(0.8F), new LookAtEntityTask(PiglinTasks::func_234482_b_, 8.0F), new SupplementedTask<>(Entity::isPassenger, func_234458_a_()), new StopRidingEntityTask<>(8, PiglinTasks::func_234467_a_)), MemoryModuleType.field_234105_s_);
   }

   private static FirstShuffledTask<PiglinEntity> func_234458_a_() {
      return new FirstShuffledTask<>(ImmutableList.of(Pair.of(new LookAtEntityTask(EntityType.PLAYER, 8.0F), 1), Pair.of(new LookAtEntityTask(EntityType.field_233591_ai_, 8.0F), 1), Pair.of(new LookAtEntityTask(8.0F), 1), Pair.of(new DummyTask(30, 60), 1)));
   }

   private static FirstShuffledTask<PiglinEntity> func_234481_b_() {
      return new FirstShuffledTask<>(ImmutableList.of(Pair.of(new WalkRandomlyTask(0.6F), 2), Pair.of(InteractWithEntityTask.func_220445_a(EntityType.field_233591_ai_, 8, MemoryModuleType.INTERACTION_TARGET, 0.6F, 2), 2), Pair.of(new SupplementedTask<>(PiglinTasks::func_234514_g_, new WalkTowardsLookTargetTask(0.6F, 3)), 2), Pair.of(new DummyTask(30, 60), 1)));
   }
   ...
   private static PiglinIdleActivityTask<PiglinEntity, LivingEntity> func_241428_d_() {
      return new PiglinIdleActivityTask<>(PiglinEntity::isChild, MemoryModuleType.field_234077_K_, MemoryModuleType.field_234106_z_, field_241418_g_);
   }
   ...
   protected static void func_234486_b_(PiglinEntity p_234486_0_) {
      ...
      brain.func_233706_a_(ImmutableList.of(Activity.field_234623_m_, Activity.field_234621_k_, Activity.field_234624_n_, Activity.field_234622_l_, Activity.field_234625_o_, Activity.IDLE));
      ...
      p_234486_0_.setAggroed(brain.hasMemory(MemoryModuleType.field_234103_o_));
      if (!brain.hasMemory(MemoryModuleType.field_234105_s_) && func_234522_j_(p_234486_0_)) {
         p_234486_0_.stopRiding();
      }

      if (!brain.hasMemory(MemoryModuleType.field_234083_Q_)) {
         brain.removeMemory(MemoryModuleType.field_234084_R_);
      }

      p_234486_0_.func_234442_u_(brain.hasMemory(MemoryModuleType.field_234084_R_));
   }
   ...
   private static boolean func_234461_a_(LivingEntity p_234461_0_, LivingEntity p_234461_1_) {
      if (p_234461_1_.getType() != EntityType.field_233588_G_) {
         return false;
      } else {
   ...
   protected static boolean func_234474_a_(PiglinEntity p_234474_0_, ItemStack p_234474_1_) {
      ...
      if (item.isIn(ItemTags.field_232902_M_)) {
         return false;
      } else if (func_234453_C_(p_234474_0_) && p_234474_0_.getBrain().hasMemory(MemoryModuleType.field_234103_o_)) {
         return false;
   ...
   private static boolean func_234525_l_(PiglinEntity p_234525_0_) {
      ...
      if (brain.hasMemory(MemoryModuleType.field_234093_aa_)) {
         LivingEntity livingentity = brain.getMemory(MemoryModuleType.field_234093_aa_).get();
         return p_234525_0_.func_233562_a_(livingentity, 6.0D);
      } else {
         return false;
      }
   }
   ...
   private static Optional<? extends LivingEntity> func_234526_m_(PiglinEntity p_234526_0_) {
      ...
      if (func_234525_l_(p_234526_0_)) {
         ...
         Optional<LivingEntity> optional = BrainUtil.func_233864_a_(p_234526_0_, MemoryModuleType.field_234078_L_);
         if (optional.isPresent() && func_234506_e_(optional.get())) {
            return optional;
         } else {
            if (brain.hasMemory(MemoryModuleType.field_234079_M_)) {
               Optional<PlayerEntity> optional1 = brain.getMemory(MemoryModuleType.field_234102_l_);
               if (optional1.isPresent()) {
                  return optional1;
               }
            }

            Optional<MobEntity> optional3 = brain.getMemory(MemoryModuleType.field_234077_K_);
            if (optional3.isPresent()) {
               return optional3;
            } else {
               Optional<PlayerEntity> optional2 = brain.getMemory(MemoryModuleType.field_234088_V_);
   ...
   public static void func_234478_a_(PlayerEntity p_234478_0_, boolean p_234478_1_) {
      ...
      list.stream().filter(PiglinTasks::func_234520_i_).filter((p_234491_2_) -> {
         ...
         if (p_234479_1_.world.getGameRules().getBoolean(GameRules.field_234896_G_)) {
   ...
   protected static void func_234468_a_(PiglinEntity p_234468_0_, LivingEntity p_234468_1_) {
      if (!(p_234468_1_ instanceof PiglinEntity)) {
         ...
         brain.removeMemory(MemoryModuleType.field_234083_Q_);
         brain.removeMemory(MemoryModuleType.field_234084_R_);
         ...
         func_234515_g_(p_234468_0_).ifPresent((p_234462_2_) -> {
            if (p_234462_2_.getType() != p_234468_1_.getType()) {
               brain.removeMemory(MemoryModuleType.field_234106_z_);
            }

         });
         if (p_234468_0_.isChild()) {
            brain.func_233696_a_(MemoryModuleType.field_234106_z_, p_234468_1_, 100L);
            if (func_234506_e_(p_234468_1_)) {
               func_234487_b_(p_234468_0_, p_234468_1_);
            }

         } else if (p_234468_1_.getType() == EntityType.field_233588_G_ && func_234535_v_(p_234468_0_)) {
   ...
   protected static void func_234509_e_(AbstractPiglinEntity p_234509_0_, LivingEntity p_234509_1_) {
      if (!p_234509_0_.getBrain().hasActivity(Activity.field_234624_n_)) {
         if (func_234506_e_(p_234509_1_)) {
            if (!BrainUtil.func_233861_a_(p_234509_0_, p_234509_1_, 4.0D)) {
               if (p_234509_1_.getType() == EntityType.PLAYER && p_234509_0_.world.getGameRules().getBoolean(GameRules.field_234896_G_)) {
   ...
   private static SoundEvent func_241422_a_(PiglinEntity p_241422_0_, Activity p_241422_1_) {
      ...
      } else if (p_241422_1_ == Activity.field_234624_n_ && func_234528_o_(p_241422_0_)) {
         return SoundEvents.field_232794_kY_;
      } else if (p_241422_1_ == Activity.field_234623_m_) {
         return SoundEvents.field_232787_kR_;
      } else if (p_241422_1_ == Activity.field_234622_l_) {
         return SoundEvents.field_232790_kU_;
      } else if (func_234510_f_(p_241422_0_)) {
         return SoundEvents.field_232792_kW_;
      } else {
         return func_234452_B_(p_241422_0_) ? SoundEvents.field_232794_kY_ : SoundEvents.field_232788_kS_;
      }
   }

   private static boolean func_234528_o_(PiglinEntity p_234528_0_) {
      Brain<PiglinEntity> brain = p_234528_0_.getBrain();
      return !brain.hasMemory(MemoryModuleType.field_234106_z_) ? false : brain.getMemory(MemoryModuleType.field_234106_z_).get().func_233562_a_(p_234528_0_, 12.0D);
   }

   protected static boolean func_234508_e_(PiglinEntity p_234508_0_) {
      return p_234508_0_.getBrain().hasMemory(MemoryModuleType.field_234082_P_) || func_234529_p_(p_234508_0_).stream().anyMatch((p_234456_0_) -> {
         return p_234456_0_.getBrain().hasMemory(MemoryModuleType.field_234082_P_);
      });
   }

   private static List<AbstractPiglinEntity> func_234529_p_(PiglinEntity p_234529_0_) {
      return p_234529_0_.getBrain().getMemory(MemoryModuleType.field_234090_X_).orElse(ImmutableList.of());
   }

   private static List<AbstractPiglinEntity> func_234530_q_(AbstractPiglinEntity p_234530_0_) {
      return p_234530_0_.getBrain().getMemory(MemoryModuleType.field_234089_W_).orElse(ImmutableList.of());
   }
   ...
   private static RunSometimesTask<PiglinEntity> func_234505_e_() {
      return new RunSometimesTask<>(new PiglinIdleActivityTask<>(PiglinEntity::isChild, MemoryModuleType.field_234086_T_, MemoryModuleType.field_234105_s_, field_234447_d_), field_234446_c_);
   }
   ...
   protected static void func_234487_b_(AbstractPiglinEntity p_234487_0_, LivingEntity p_234487_1_) {
      func_234530_q_(p_234487_0_).forEach((p_234484_1_) -> {
         if (p_234487_1_.getType() != EntityType.field_233588_G_ || p_234484_1_.func_234422_eK_() && ((HoglinEntity)p_234487_1_).func_234365_eM_()) {
   ...
   protected static void func_234497_c_(AbstractPiglinEntity p_234497_0_, LivingEntity p_234497_1_) {
      if (func_234506_e_(p_234497_1_)) {
         ...
         p_234497_0_.getBrain().func_233696_a_(MemoryModuleType.field_234078_L_, p_234497_1_.getUniqueID(), 600L);
         if (p_234497_1_.getType() == EntityType.field_233588_G_ && p_234497_0_.func_234422_eK_()) {
            func_234518_h_(p_234497_0_);
         }

         if (p_234497_1_.getType() == EntityType.PLAYER && p_234497_0_.world.getGameRules().getBoolean(GameRules.field_234896_G_)) {
            p_234497_0_.getBrain().func_233696_a_(MemoryModuleType.field_234079_M_, true, 600L);
         }
   ...
   private static Optional<LivingEntity> func_234532_s_(AbstractPiglinEntity p_234532_0_) {
      return BrainUtil.func_233864_a_(p_234532_0_, MemoryModuleType.field_234078_L_);
   }

   public static Optional<LivingEntity> func_234515_g_(PiglinEntity p_234515_0_) {
      return p_234515_0_.getBrain().hasMemory(MemoryModuleType.field_234106_z_) ? p_234515_0_.getBrain().getMemory(MemoryModuleType.field_234106_z_) : Optional.empty();
   }

   public static Optional<PlayerEntity> func_241432_i_(AbstractPiglinEntity p_241432_0_) {
      return p_241432_0_.getBrain().hasMemory(MemoryModuleType.field_234102_l_) ? p_241432_0_.getBrain().getMemory(MemoryModuleType.field_234102_l_) : Optional.empty();
   }
   ...
   private static void func_234519_h_(PiglinEntity p_234519_0_, LivingEntity p_234519_1_) {
      ...
      LivingEntity lvt_3_1_ = BrainUtil.func_233867_a_(p_234519_0_, brain.getMemory(MemoryModuleType.field_234106_z_), p_234519_1_);
      lvt_3_1_ = BrainUtil.func_233867_a_(p_234519_0_, brain.getMemory(MemoryModuleType.field_234103_o_), lvt_3_1_);
   ...
   private static boolean func_234533_t_(PiglinEntity p_234533_0_) {
      ...
      if (!brain.hasMemory(MemoryModuleType.field_234106_z_)) {
         return true;
      } else {
         LivingEntity livingentity = brain.getMemory(MemoryModuleType.field_234106_z_).get();
         EntityType<?> entitytype = livingentity.getType();
         if (entitytype == EntityType.field_233588_G_) {
            return func_234534_u_(p_234533_0_);
         } else if (func_234459_a_(entitytype)) {
            return !brain.func_233708_b_(MemoryModuleType.field_234093_aa_, livingentity);
         } else {
            return false;
         }
      }
   ...
   private static boolean func_234535_v_(PiglinEntity p_234535_0_) {
      int i = p_234535_0_.getBrain().getMemory(MemoryModuleType.field_234094_ab_).orElse(0) + 1;
      int j = p_234535_0_.getBrain().getMemory(MemoryModuleType.field_234095_ac_).orElse(0);
      return j > i;
   }

   private static void func_234521_i_(PiglinEntity p_234521_0_, LivingEntity p_234521_1_) {
      p_234521_0_.getBrain().removeMemory(MemoryModuleType.field_234078_L_);
      p_234521_0_.getBrain().removeMemory(MemoryModuleType.field_234103_o_);
      p_234521_0_.getBrain().removeMemory(MemoryModuleType.WALK_TARGET);
      p_234521_0_.getBrain().func_233696_a_(MemoryModuleType.field_234106_z_, p_234521_1_, (long)field_234448_e_.func_233018_a_(p_234521_0_.world.rand));
      func_234518_h_(p_234521_0_);
   }

   protected static void func_234518_h_(AbstractPiglinEntity p_234518_0_) {
      p_234518_0_.getBrain().func_233696_a_(MemoryModuleType.field_234082_P_, true, (long)field_234445_b_.func_233018_a_(p_234518_0_.world.rand));
   }

   private static void func_234536_x_(PiglinEntity p_234536_0_) {
      p_234536_0_.getBrain().func_233696_a_(MemoryModuleType.field_234097_ae_, true, 200L);
   }
   ...
   private static boolean func_234538_z_(PiglinEntity p_234538_0_) {
      return p_234538_0_.getBrain().hasMemory(MemoryModuleType.field_234097_ae_);
   }
   ...
   private static boolean func_234494_c_(LivingEntity p_234494_0_) {
      return p_234494_0_.func_233631_a_(Items.CROSSBOW);
   }

   private static void func_234501_d_(LivingEntity p_234501_0_) {
      p_234501_0_.getBrain().func_233696_a_(MemoryModuleType.field_234080_N_, true, 120L);
   }

   private static boolean func_234451_A_(PiglinEntity p_234451_0_) {
      return p_234451_0_.getBrain().hasMemory(MemoryModuleType.field_234080_N_);
   }
   ...
   private static boolean func_234452_B_(PiglinEntity p_234452_0_) {
      return p_234452_0_.getBrain().hasMemory(MemoryModuleType.field_234098_af_);
   }

   private static boolean func_234510_f_(LivingEntity p_234510_0_) {
      return p_234510_0_.getBrain().hasMemory(MemoryModuleType.field_234096_ad_);
   }
   ...
   private static boolean func_234453_C_(PiglinEntity p_234453_0_) {
      return p_234453_0_.getBrain().hasMemory(MemoryModuleType.field_234081_O_);
   }
