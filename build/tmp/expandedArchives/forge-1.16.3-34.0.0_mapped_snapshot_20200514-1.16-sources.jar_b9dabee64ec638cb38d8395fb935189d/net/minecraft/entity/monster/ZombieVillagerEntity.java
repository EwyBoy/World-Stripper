...
public class ZombieVillagerEntity extends ZombieEntity implements IVillagerDataHolder {
   ...
   public void writeAdditional(CompoundNBT compound) {
      ...
      VillagerData.field_234554_a_.encodeStart(NBTDynamicOps.INSTANCE, this.getVillagerData()).resultOrPartial(LOGGER::error).ifPresent((p_234343_1_) -> {
   ...
   private void cureZombie(ServerWorld p_213791_1_) {
      ...
      villagerentity.onInitialSpawn(p_213791_1_, p_213791_1_.getDifficultyForLocation(villagerentity.func_233580_cy_()), SpawnReason.CONVERSION, (ILivingEntityData)null, (CompoundNBT)null);
      if (this.converstionStarter != null) {
      ...
      if (!this.isSilent()) {
         p_213791_1_.playEvent((PlayerEntity)null, 1027, this.func_233580_cy_(), 0);
      }
