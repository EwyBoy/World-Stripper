...
public class DrownedEntity extends ZombieEntity implements IRangedAttackMob {
   ...
   static class GoToBeachGoal extends MoveToBlockGoal {
      ...
      protected boolean shouldMoveTo(IWorldReader worldIn, BlockPos pos) {
         ...
         return worldIn.isAirBlock(blockpos) && worldIn.isAirBlock(blockpos.up()) ? worldIn.getBlockState(pos).func_235719_a_(worldIn, pos, this.drowned) : false;
      }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         ...
         if (this.drowned.func_204715_dF() && this.drowned.isInWater()) {
            ...
            float f1 = (float)(this.speed * this.drowned.func_233637_b_(Attributes.field_233821_d_));
