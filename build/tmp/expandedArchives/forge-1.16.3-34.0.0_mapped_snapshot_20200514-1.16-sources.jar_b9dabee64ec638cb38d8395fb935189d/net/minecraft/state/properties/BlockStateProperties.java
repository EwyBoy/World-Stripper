...
public class BlockStateProperties {
   ...
   public static final EnumProperty<JigsawOrientation> field_235907_P_ = EnumProperty.create("orientation", JigsawOrientation.class);
   ...
   public static final EnumProperty<WallHeight> field_235908_S_ = EnumProperty.create("east", WallHeight.class);
   public static final EnumProperty<WallHeight> field_235909_T_ = EnumProperty.create("north", WallHeight.class);
   public static final EnumProperty<WallHeight> field_235910_U_ = EnumProperty.create("south", WallHeight.class);
   public static final EnumProperty<WallHeight> field_235911_V_ = EnumProperty.create("west", WallHeight.class);
   ...
   public static final IntegerProperty field_235912_aC_ = IntegerProperty.create("charges", 0, 4);
