         ...
         try {
            ...
            if (compoundnbt != null) {
               ...
               if (flag) {
                  ...
                  this.func_241088_a_(p_223172_1_, ichunk.getStatus().getType());
   ...
   class EntityTracker {
      ...
      public void updateTrackingState(ServerPlayerEntity p_219400_1_) {
         if (p_219400_1_ != this.entity) {
            Vector3d vector3d = p_219400_1_.getPositionVec().subtract(this.entry.func_219456_b());
            int i = Math.min(this.func_229843_b_(), (ChunkManager.this.viewDistance - 1) * 16);
            boolean flag = vector3d.x >= (double)(-i) && vector3d.x <= (double)i && vector3d.z >= (double)(-i) && vector3d.z <= (double)i && this.entity.isSpectatedByPlayer(p_219400_1_);
            if (flag) {
