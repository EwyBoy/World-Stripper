...
public class PatrolSpawner implements ISpecialSpawner {
   ...
   public int func_230253_a_(ServerWorld p_230253_1_, boolean p_230253_2_, boolean p_230253_3_) {
      if (!p_230253_2_) {
         return 0;
      } else if (!p_230253_1_.getGameRules().getBoolean(GameRules.field_230127_D_)) {
         return 0;
      } else {
               ...
               if (random.nextInt(5) != 0) {
                  ...
                  if (j < 1) {
                     ...
                     if (playerentity.isSpectator()) {
                        return 0;
                     } else if (p_230253_1_.func_241119_a_(playerentity.func_233580_cy_(), 2)) {
                        return 0;
                     } else {
                        int k = (24 + random.nextInt(24)) * (random.nextBoolean() ? -1 : 1);
                        int l = (24 + random.nextInt(24)) * (random.nextBoolean() ? -1 : 1);
                        BlockPos.Mutable blockpos$mutable = playerentity.func_233580_cy_().func_239590_i_().move(k, 0, l);
