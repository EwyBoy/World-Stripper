               ...
               if (world.hasNoCollisions(optional.get().func_220328_a(d0, d1, d2))) {
                  ...
                  if (EntitySpawnPlacementRegistry.func_223515_a(optional.get(), serverworld, SpawnReason.SPAWNER, new BlockPos(d0, d1, d2), world.getRandom())) {
                     ...
                     if (entity instanceof MobEntity) {
                        ...
                        if (!net.minecraftforge.event.ForgeEventFactory.doSpecialSpawn(mobentity, world, (float)entity.getPosX(), (float)entity.getPosY(), (float)entity.getPosZ(), this, SpawnReason.SPAWNER))
                           ((MobEntity)entity).onInitialSpawn(serverworld, world.getDifficultyForLocation(entity.func_233580_cy_()), SpawnReason.SPAWNER, (ILivingEntityData)null, (CompoundNBT)null);
                        }
                     }
