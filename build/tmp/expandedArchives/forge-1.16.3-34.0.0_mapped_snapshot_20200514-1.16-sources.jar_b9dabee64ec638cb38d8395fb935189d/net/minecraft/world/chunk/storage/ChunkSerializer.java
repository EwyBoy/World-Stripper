...
public class ChunkSerializer {
   ...
   public static ChunkPrimer read(ServerWorld worldIn, TemplateManager templateManagerIn, PointOfInterestManager poiManager, ChunkPos pos, CompoundNBT compound) {
      ...
      BiomeContainer biomecontainer = new BiomeContainer(worldIn.func_241828_r().func_243612_b(Registry.field_239720_u_), pos, biomeprovider, compoundnbt.contains("Biomes", 11) ? compoundnbt.getIntArray("Biomes") : null);
   ...
   private static void readEntities(CompoundNBT compound, Chunk chunkIn) {
      ...
      for(int j = 0; j < listnbt1.size(); ++j) {
         ...
         if (flag) {
            ...
            TileEntity tileentity = TileEntity.func_235657_b_(chunkIn.getBlockState(blockpos), compoundnbt1);
            if (tileentity != null) {
