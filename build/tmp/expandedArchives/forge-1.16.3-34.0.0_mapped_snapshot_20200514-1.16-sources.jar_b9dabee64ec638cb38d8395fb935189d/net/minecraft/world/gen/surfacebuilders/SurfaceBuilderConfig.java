...
public class SurfaceBuilderConfig implements ISurfaceBuilderConfig {
   public static final Codec<SurfaceBuilderConfig> field_237203_a_ = RecordCodecBuilder.create((p_237204_0_) -> {
      return p_237204_0_.group(BlockState.field_235877_b_.fieldOf("top_material").forGetter((p_237207_0_) -> {
         return p_237207_0_.topMaterial;
      }), BlockState.field_235877_b_.fieldOf("under_material").forGetter((p_237206_0_) -> {
         return p_237206_0_.underMaterial;
      }), BlockState.field_235877_b_.fieldOf("underwater_material").forGetter((p_237205_0_) -> {
