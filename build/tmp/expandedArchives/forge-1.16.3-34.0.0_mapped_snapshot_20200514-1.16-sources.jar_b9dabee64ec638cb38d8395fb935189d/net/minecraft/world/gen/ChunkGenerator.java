...
public abstract class ChunkGenerator {
   ...
   private void func_235958_g_() {
      if (this.field_235951_f_.isEmpty()) {
         ...
         if (structurespreadsettings != null && structurespreadsettings.func_236663_c_() != 0) {
            ...
            for(Biome biome : this.biomeProvider.func_235203_c_()) {
            ...
            for(int l = 0; l < l1; ++l) {
               ...
               BlockPos blockpos = this.biomeProvider.func_225531_a_((i1 << 4) + 8, 0, (j1 << 4) + 8, 112, list::contains, random);
               if (blockpos != null) {
                  i1 = blockpos.getX() >> 4;
                  j1 = blockpos.getZ() >> 4;
               }
         ...
         for(int i1 = k - 8; i1 <= k + 8; ++i1) {
            ...
            while(listiterator.hasNext()) {
               ...
               if (configuredcarver.shouldCarve(sharedseedrandom, l, i1)) {
                  configuredcarver.func_227207_a_(p_230350_4_, biomemanager::getBiome, sharedseedrandom, this.func_230356_f_(), l, i1, j, k, bitset);
               }
            }
         }
      }
   ...
   static {
      Registry.register(Registry.field_239690_aB_, "noise", NoiseChunkGenerator.field_236079_d_);
      Registry.register(Registry.field_239690_aB_, "flat", FlatChunkGenerator.field_236069_d_);
      Registry.register(Registry.field_239690_aB_, "debug", DebugChunkGenerator.field_236066_e_);
   }
}