...
public class Template {
   ...
   private static void func_237149_a_(Template.BlockInfo p_237149_0_, List<Template.BlockInfo> p_237149_1_, List<Template.BlockInfo> p_237149_2_, List<Template.BlockInfo> p_237149_3_) {
      ...
      } else if (!p_237149_0_.state.getBlock().isVariableOpacity() && p_237149_0_.state.func_235785_r_(EmptyBlockReader.INSTANCE, BlockPos.ZERO)) {
   ...
   public static List<Template.EntityInfo> processEntityInfos(@Nullable Template template, IWorld worldIn, BlockPos offsetPos, PlacementSettings placementSettingsIn, List<Template.EntityInfo> blockInfos) {
      ...
      for(Template.EntityInfo entityInfo : blockInfos) {
         Vector3d pos = transformedVec3d(placementSettingsIn, entityInfo.pos).add(Vector3d.func_237491_b_(offsetPos));
   ...
   private void addEntitiesToWorld(IServerWorld p_237143_1_, BlockPos p_237143_2_, PlacementSettings placementIn) {
      for(Template.EntityInfo template$entityinfo : processEntityInfos(this, p_237143_1_, p_237143_2_, placementIn, this.entities)) {
         BlockPos blockpos = getTransformedPos(template$entityinfo.blockPos, placementIn.getMirror(), placementIn.getRotation(), placementIn.getCenterOffset()).add(p_237143_2_);
