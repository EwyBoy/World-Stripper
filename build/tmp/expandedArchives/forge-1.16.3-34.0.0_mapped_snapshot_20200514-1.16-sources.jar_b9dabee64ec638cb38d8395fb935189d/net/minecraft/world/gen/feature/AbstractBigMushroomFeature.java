            ...
            for(int j = 0; j <= p_227209_3_; ++j) {
               ...
               for(int l = -k; l <= k; ++l) {
                  for(int i1 = -k; i1 <= k; ++i1) {
                     BlockState blockstate = p_227209_1_.getBlockState(p_227209_4_.func_239621_a_(p_227209_2_, l, j, i1));
                     if (!blockstate.isAir(p_227209_1_, p_227209_4_.func_239621_a_(p_227209_2_, l, j, i1)) && !blockstate.func_235714_a_(BlockTags.LEAVES)) {
                        return false;
                     }
                  }
               }
