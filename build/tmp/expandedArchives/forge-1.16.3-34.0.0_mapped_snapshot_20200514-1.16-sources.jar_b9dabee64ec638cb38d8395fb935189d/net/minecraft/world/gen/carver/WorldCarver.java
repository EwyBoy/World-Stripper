                  ...
                  if (!(d2 * d2 + d3 * d3 >= 1.0D)) {
                     ...
                     for(int k2 = l; k2 > k; --k2) {
                        ...
                        if (!this.func_222708_a(d2, d4, d3, k2)) {
                           flag |= this.func_230358_a_(p_227208_1_, p_227208_2_, p_227208_18_, random, blockpos$mutable, blockpos$mutable1, blockpos$mutable2, p_227208_5_, p_227208_6_, p_227208_7_, l1, j2, k1, k2, i2, mutableboolean);
                        }
                     }
                  }
               }
