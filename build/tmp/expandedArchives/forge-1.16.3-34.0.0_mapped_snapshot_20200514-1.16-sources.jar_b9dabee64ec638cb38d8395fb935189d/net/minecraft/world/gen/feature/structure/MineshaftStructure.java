...
public class MineshaftStructure extends Structure<MineshaftConfig> {
   ...
   public static enum Type implements IStringSerializable {
      ...
      public static final Codec<MineshaftStructure.Type> field_236324_c_ = IStringSerializable.func_233023_a_(MineshaftStructure.Type::values, MineshaftStructure.Type::byName);
