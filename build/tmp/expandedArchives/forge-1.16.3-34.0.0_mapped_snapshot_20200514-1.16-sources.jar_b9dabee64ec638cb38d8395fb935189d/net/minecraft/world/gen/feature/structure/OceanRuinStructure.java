...
public class OceanRuinStructure extends Structure<OceanRuinConfig> {
   ...
   public static enum Type implements IStringSerializable {
      ...
      public static final Codec<OceanRuinStructure.Type> field_236998_c_ = IStringSerializable.func_233023_a_(OceanRuinStructure.Type::values, OceanRuinStructure.Type::getType);
