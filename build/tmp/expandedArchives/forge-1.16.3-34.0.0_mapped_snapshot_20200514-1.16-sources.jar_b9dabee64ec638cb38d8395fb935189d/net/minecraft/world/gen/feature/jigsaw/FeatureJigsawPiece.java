...
public class FeatureJigsawPiece extends JigsawPiece {
   ...
   private CompoundNBT writeNBT() {
      ...
      compoundnbt.putString("joint", JigsawTileEntity.OrientationType.ROLLABLE.func_176610_l());
      return compoundnbt;
   }
   ...
   public List<Template.BlockInfo> getJigsawBlocks(TemplateManager templateManagerIn, BlockPos pos, Rotation rotationIn, Random rand) {
      ...
      list.add(new Template.BlockInfo(pos, Blocks.JIGSAW.getDefaultState().with(JigsawBlock.field_235506_a_, JigsawOrientation.func_239641_a_(Direction.DOWN, Direction.SOUTH)), this.nbt));
      return list;
   }
