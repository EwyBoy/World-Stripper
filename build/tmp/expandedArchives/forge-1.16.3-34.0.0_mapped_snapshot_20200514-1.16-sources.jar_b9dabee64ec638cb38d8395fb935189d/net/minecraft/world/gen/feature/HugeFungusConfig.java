...
public class HugeFungusConfig implements IFeatureConfig {
   public static final Codec<HugeFungusConfig> field_236298_a_ = RecordCodecBuilder.create((p_236309_0_) -> {
      return p_236309_0_.group(BlockState.field_235877_b_.fieldOf("valid_base_block").forGetter((p_236313_0_) -> {
         return p_236313_0_.field_236303_f_;
      }), BlockState.field_235877_b_.fieldOf("stem_state").forGetter((p_236312_0_) -> {
         return p_236312_0_.field_236304_g_;
      }), BlockState.field_235877_b_.fieldOf("hat_state").forGetter((p_236311_0_) -> {
         return p_236311_0_.field_236305_h_;
      }), BlockState.field_235877_b_.fieldOf("decor_state").forGetter((p_236310_0_) -> {
   ...
   public static final HugeFungusConfig field_236299_b_ = new HugeFungusConfig(Blocks.field_235381_mu_.getDefaultState(), Blocks.field_235377_mq_.getDefaultState(), Blocks.NETHER_WART_BLOCK.getDefaultState(), Blocks.field_235383_mw_.getDefaultState(), true);
   public static final HugeFungusConfig field_236300_c_;
   public static final HugeFungusConfig field_236301_d_ = new HugeFungusConfig(Blocks.field_235372_ml_.getDefaultState(), Blocks.field_235368_mh_.getDefaultState(), Blocks.field_235374_mn_.getDefaultState(), Blocks.field_235383_mw_.getDefaultState(), true);
