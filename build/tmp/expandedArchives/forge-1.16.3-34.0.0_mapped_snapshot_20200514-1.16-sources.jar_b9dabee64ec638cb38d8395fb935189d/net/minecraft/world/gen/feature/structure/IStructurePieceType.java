...
public interface IStructurePieceType {
   ...
   IStructurePieceType field_236399_L_ = register(RuinedPortalPiece::new, "RUPO");
   ...
   IStructurePieceType field_236400_ae_ = register(NetherFossilStructures.Piece::new, "NeFos");
