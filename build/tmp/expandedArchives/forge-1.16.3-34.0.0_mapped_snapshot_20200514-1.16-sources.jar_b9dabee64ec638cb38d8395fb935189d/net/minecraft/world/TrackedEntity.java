...
public class TrackedEntity {
   ...
   public TrackedEntity(ServerWorld p_i50704_1_, Entity p_i50704_2_, int p_i50704_3_, boolean p_i50704_4_, Consumer<IPacket<?>> p_i50704_5_) {
      ...
      this.onGround = p_i50704_2_.func_233570_aj_();
   }
   ...
   public void tick() {
      ...
      if (this.updateCounter % this.updateFrequency == 0 || this.trackedEntity.isAirBorne || this.trackedEntity.getDataManager().isDirty()) {
         if (this.trackedEntity.isPassenger()) {
            ...
            if (flag2) {
               this.packetConsumer.accept(new SEntityPacket.LookPacket(this.trackedEntity.getEntityId(), (byte)i1, (byte)l1, this.trackedEntity.func_233570_aj_()));
            ...
            if (this.updateCounter > 0 || this.trackedEntity instanceof AbstractArrowEntity) {
               ...
               if (!flag1 && this.ticksSinceAbsoluteTeleport <= 400 && !this.riding && this.onGround == this.trackedEntity.func_233570_aj_()) {
                  if ((!flag4 || !flag) && !(this.trackedEntity instanceof AbstractArrowEntity)) {
                     if (flag4) {
                        ipacket1 = new SEntityPacket.RelativeMovePacket(this.trackedEntity.getEntityId(), (short)((int)i), (short)((int)j), (short)((int)k), this.trackedEntity.func_233570_aj_());
                     } else if (flag) {
                        ipacket1 = new SEntityPacket.LookPacket(this.trackedEntity.getEntityId(), (byte)l, (byte)k1, this.trackedEntity.func_233570_aj_());
                     }
                  } else {
                     ipacket1 = new SEntityPacket.MovePacket(this.trackedEntity.getEntityId(), (short)((int)i), (short)((int)j), (short)((int)k), (byte)l, (byte)k1, this.trackedEntity.func_233570_aj_());
                  }
               } else {
                  this.onGround = this.trackedEntity.func_233570_aj_();
   ...
   public void sendSpawnPackets(Consumer<IPacket<?>> p_219452_1_) {
      ...
      if (this.trackedEntity instanceof LivingEntity) {
         Collection<ModifiableAttributeInstance> collection = ((LivingEntity)this.trackedEntity).func_233645_dx_().func_233789_b_();
      ...
      if (this.trackedEntity instanceof LivingEntity) {
         ...
         if (!list.isEmpty()) {
            p_219452_1_.accept(new SEntityEquipmentPacket(this.trackedEntity.getEntityId(), list));
         }
      }
   ...
   private void sendMetadata() {
      ...
      if (this.trackedEntity instanceof LivingEntity) {
         Set<ModifiableAttributeInstance> set = ((LivingEntity)this.trackedEntity).func_233645_dx_().func_233778_a_();
         if (!set.isEmpty()) {
