...
public class BlockUpdater {
    ...
    private static int notifyNeighbors() {
        return Settings.BlockUpdateSettings.notifyNeighbors ? BlockFlags.NOTIFY_NEIGHBORS : 0;
    }

    private static int blockUpdate() {
        return Settings.BlockUpdateSettings.blockUpdate ? BlockFlags.BLOCK_UPDATE : 0;
    }

    private static int noRender() {
        return Settings.BlockUpdateSettings.noRender ? BlockFlags.NO_RERENDER : 0;
    }

    private static int renderMainThread() {
        return Settings.BlockUpdateSettings.renderMainThread ? BlockFlags.RERENDER_MAIN_THREAD : 0;
    }

    private static int updateNeighbors() {
        return Settings.BlockUpdateSettings.updateNeighbors ? BlockFlags.UPDATE_NEIGHBORS : 0;
    }
